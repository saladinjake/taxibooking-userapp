                         ...
                         <div className="row">
                            ...
                            <div className="col-lg-12" id="hide-on-click">
                                ...
                                <div className="row m-t-40 m-b-40 align-items-center justify-content-center">
                                    ...
                                    <button id="get-location-btn" type="submit" className="btn btn-danger btn-block btn-lg w-sm waves-effect waves-light">
                                        Yes
                                    </button> 
  ...
  <div className="col-md-11 col-sm-11 col-xs-11">
    <div className="panel panel-default">
      ...
      <div className="panel-body">
        <p style={{display:"none"}}>Lat/Long: <span id="location-lat-long"  className="form-control"></span></p>
        <p style={{display:"none"}}>Address: <span id="location-address" type="text" className="form-control"> </span></p>
