  ...
  render() {
        ...
        <div className="col-lg-4 col-md-6 col-sm-12 col-xs-12 pull-right">
          <div className="card-box animated animatedFadeInUp fadeInUp ">
            <div className="panel-heading">
              ...
              <a
                href="https://goomtaxiuser.herokuapp.com/signup"
                className="btn-link"
    ...
    Login with Facebook
            ...
            <div className="panel-body">
              ...
              <form
                className="form-horizontal m-t-20 animated animatedFadeInUp fadeInUp "
                method="POST"
              >
                ...
                <div className="form-group m-t-20 m-b-0">
                  <div className="col-sm-12">
                    <a href="./recovery" className="text-dark">
            ...
            <div className="row m-t-20">
              <div className="col-sm-12 text-center">
                <p>
                  ...
                  <a href="./signup" className="text-primary m-l-5">
                    <b>Sign Up</b>
                  </a>
                </p>
              </div>
