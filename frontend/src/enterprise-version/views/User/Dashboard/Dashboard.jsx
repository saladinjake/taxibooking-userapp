          ...
          <div className="container animated animatedFadeInUp fadeInUp">
            ...
            <div className="row animated animatedFadeInUp fadeInUp">
              <a
                ...
                data-tooltip="lets you view the all planned itineraries and planned trips"
              >
                <div
                  data-id="plan-detail"
                  data-href="./plan-detail"
                  ...
                  <div className="widget-bg-color-icon card-box p-t-10 p-b-10">
                    ...
                    <div className="">
                      <h5 className="text-dark">
                        <b style={{ fontSize: '14px' }} className="" id="plan-id">
                          No Plan
                        </b>
                      </h5>
                      <p className="text-muted" id="idvalue">
                        No plan{' '}
                      </p>
                    </div>
                  ...
                  <div className="widget-bg-color-icon card-box">
                    ...
                    <div className="col-lg-6 pull-right text-right">
                      <h3 className="text-dark" style={{ fontSize: '14px' }}>
                        <b className="">
                          Create
                          <span style={style1}> Create </span> <span>new plan</span>
                        </b>
                      </h3>
                      <p className="text-muted"></p>
                    </div>
              ...
              <a id="request-car-repair" href="./request-car-repair">
                <div className="col-sm-6  col-md-6 col-lg-3">
                  <div className="widget-bg-color-icon card-box">
                    <div className="bg-icon bg-icon-custom pull-left">
                    ...
                    <div className="col-lg-6 pull-right text-right">
                      <h3 className="text-dark" style={{ fontSize: '14px' }}>
                        <b className="">
                          Request car <span style={style1}></span> repair
                        </b>
                      </h3>
                      <p className="text-muted"></p>
                    </div>
              ...
              <div className="col-lg-12">
                <div className="card-box">
                  <a
                    ...
                    className="pull-right btn btn-default btn-sm waves-effect waves-light footable-page "
                  >
                    View all
                  </a>
                  ...
                  <div className="table-responsive card-box">
                    ...
                    <div className="col-sm-6 text-lg-center text-right pull-right">
                      <div className="form-group">
                        <input
                          ...
                          className="product-search form-control input-sm"
                          autoComplete="on"
                        />
                      </div>
                    </div>
                    <div className="clearfix"></div>
                    <div
                      className="m-t-10 animated animatedFadeInUp fadeInUp"
                      style={{ border: '1px solid #4c3392' }}
                    ></div>
                    ...
                    <div
                      id="svgItins"
                      style={{ margin: '0px auto', width: '400px', height: '200px' }}
                    >
                      <svg
                      ...
                      >
                        ...
                        >
                          Blank record!!! All itineraries created would be listed here.
                        </text>
                  ...
                  >
                    ...
                    >
                      <text
                        ...
                        font-family="sans-serif"
                      >
                        Blank Record!!!. Plan packages created would be listed here.
                      </text>
                      <g transform="translate(0,-52.362161)">
                        <g transform="translate(-1155.6145,248.49753)">
                          <path d="M 1634.663,87.035654 C 1617.9639,69.655578 1597.4593,60.461778 1574.5615,59.941382 L 1431.794,58.752658" />
