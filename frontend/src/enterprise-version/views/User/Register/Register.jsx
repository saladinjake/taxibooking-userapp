...
export class Register extends Component {
  ...
  render() {
    const styleM = {
      background:
        '#fff url("https://goomtaxiuser.herokuapp.com/public/assets/images/banner-home.jpg") no-repeat fixed left',
          ...
          <div className="card-box p-l-0 p-r-0 animated animatedFadeInUp fadeInUp ">
            <div className="panel-heading p-b-0">
              <a href="index.html" class="logo pull-right">
                <i class="icon-c-logo">
                  {' '}
                  <img src="https://goomtaxiuser.herokuapp.com/public/assets/images/goomlogo.png" />{' '}
                </i>
                <span>
                  <img src="https://goomtaxiuser.herokuapp.com/public/assets/images/goomlogo.png" />
                </span>
              ...
              <h1
                className="text-custom m-t-40 m-b-20 text-left pull-left"
            ...
            <div className="panel-body p-t-0" style={{ height: '100%', background: '#fff' }}>
              ...
              <form
                id="sign-form"
                className="form m-t-10 animated animatedFadeInUp fadeInUp fade-in"
                method="POST"
              >
