            ...
            <div className="container" style={{ backgroundColor: '#fff' }}>
              <div className="react-home react-checkout" style={{ backgroundColor: '#fff' }}>
                <div className="react-input-box" style={{ backgroundColor: '#fff' }}>
                  <div className="container" style={{ backgroundColor: '#fff' }}>
                    <div
                      className="stepwizard col-md-offset-3 col-sm-offset-1 col-xs-offset-1"
                  ...
                  <div className="container">
                    <form role="form" action="#" method="post">
                          ...
                          <div className="col-md-9">
                            ...
                            <div className="col-md-6">
                              <div className="section form-group">
                                <label for="timeframe" className="field-label control-label">
                                  Payment Method *
                                </label>
                                  ...
                                  <table className="table table-striped">
                                    <tbody>
                                      <tr>
                                        <td>Amount</td>
                                        <td>
                                          NGN<strong id="amount2"></strong>
                                        </td>
                                      </tr>
                                      <tr>
                                        <td>Reference</td>
                                        <td>
                                          <strong id="reference2"></strong>
                                        </td>
                                      </tr>
                                    </tbody>
                                  </table>
                      ...
                      <div className="row setup-content well card" id="step-3">
                        <div className="row">
                                    ...
                                    <table className="table table-striped">
                                      <tbody>
                                        <tr>
                                          <td>TOTAL</td>
                                          <td>
                                            NGN <strong id="mainBalance"></strong>
                                          </td>
                                        </tr>
                                      </tbody>
                                    </table>
                                    ...
                                    <table className="table table-striped">
                                      <tbody>
                                        <tr>
                                          ...
                                          <td>
                                            NGN<strong id="deduction">0</strong>
                                          </td>
                                        </tr>
                                      </tbody>
                                    </table>
                                  ...
                                  <table className="table table-striped">
                                    <tbody>
                                      <tr>
                                        <td>New balance</td>
                                        <td>
                                          NGN<strong id="newbalance">0</strong>
                                        </td>
                                      </tr>
                                    </tbody>
                                  </table>
                          ...
                          <div className="col-md-6">
                            <div className="col-md-6">
                              ...
                              <p>
                                <b>
                                  You Are about to make payments
                                  <br />
                                  from your wallet.
                                  <br />
                                  Your wallet account would be deducted
                                  <br />
                        ...
                        <div className="row">
                          <div className="col-md-12">
                            <div className="safe-purchase"></div>
                          </div>
                        </div>

                        <button
                          id="deduction-action"
                          data-url="/drop-wallet-balance"
                          className="pull-right btn btn-submit next"
                          type="submit"
                        >
                          Process <span className="glyphicon glyphicon-ok"></span>
                        </button>
                        <button
                          className="pull-right btn prevBtn prev"
                          aria-label="Left Align"
