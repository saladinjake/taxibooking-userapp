              ...
              <div className="row">
                <div className="col-lg-12 card-box">
                  <div className="col-lg-2 pull-left">
                    ...
                    >
                      <i
                        className="md  md-add hover-target"
                        data-toggle="modal"
                        data-target="#con-close-modal"
                      ></i>{' '}
                      Top up Wallet
                  ...
                  <div className="col-lg-8">
                    <h4 className="m-b-10 header-title">
                      Wallet balance
                      <span className="m-l-10 text-purple ">
                        <b id="new-balance"></b>
                      </span>
                    </h4>
                  </div>
                  <div className="col-lg-2 pull-right">
                    <div className="btn-group pull-right m-t-0">
                      <button
                        type="button"
                        className="btn btn-inverse dropdown-toggle waves-effect waves-light"
                        data-toggle="dropdown"
                        aria-expanded="false"
                      >
                        Options{' '}
                        <span className="m-l-5">
                          <i className="md md-expand-more"></i>
                        </span>
                      </button>
                      <ul className="dropdown-menu drop-menu-right" role="menu">
                        <li>
                          <a href="./paid-history">Payment History</a>
                        </li>
                        <li>
                          <a href="./quote-subscription-history">Quotation History</a>
                        </li>
                        <li>
                          <a href="./wallet">Wallet History</a>
                        </li>
            ...
            <div className="modal-content">
              ...
              <div className="modal-footer">
                ...
                <button
                  id="tou_up"
                  type="button"
                  className="btn btn-default waves-effect waves-light topup"
                  style={{ width: '120px', height: '40px', fontSize: '12px' }}
                >
                  Topup
                </button>
