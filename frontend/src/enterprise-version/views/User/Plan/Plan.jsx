              ...
              <div className="row">
                <div className="col-sm-12">
                  ...
                  <ol className="breadcrumb">
                    ...
                    <li className="active">Form Wizard</li>
                  </ol>
                </div>
              </div>
                ...
                <div className="col-md-12">
                  <div className="card-box">
                    ...
                    <div className="slideshow-container">
                      <section className="mySlides fade " id="choose-plan">
                        ...
                        <div className="row pricing-plan p-b-0">
                          <div className="col-md-12">
                            <div className="row deck" id="plan-section"></div>
                          </div>
                        </div>
                      </section>

                      <section className="mySlides fade" id="choose-cars">
                        <h3 className="m-t-0 header-title" id="searchResult">
                          Select 3 Cars for this plan
                        </h3>
                          ...
                          <div className="col-sm-4 pull-right">
                            <div className="form-group contact-search m-b-0">
                              <input
                                type="text"
                                id="search"
                                className="form-control searchme"
                        ...
                        <div className="MultiCarousel" data-items="1,3,5,6" data-slide="1" id="MultiCarousel"  data-interval="1000">
                          ...
                          <div className="car-carousel" id="car-carousel">
                            ...
                            <div className="slide-container">
                              <ul className="slidesx" id="travelcars"></ul>
                            </div>
                            {/* <a className="next">❯</a>*/}
                          </div>
                        </div>
                          ...
                          <div className="col-sm-5 pull-left column-itinerary1">
                            <div className="card-box">
                              <div className="row p-l-0 p-r-0">
                                <div className="col-md-12">
                                  <h4 className="m-t-0 header-title text-custom ">
                                    <b>Add Itinerary</b>
                                  </h4>

                                  <p className="text-muted m-b-30 font-18"></p>
                                  ...
                                  <form role="form">
                                    <div className="form-group">
                                      ...
                                      <input
                                        ...
                                        data-toggle="popover"
                                        data-placement="top"
                                        data-content="Please note that a car will be available 24 to 48 hours after itinerary is saved."
                                        data-original-title=""
                                      />
                                    </div>
                                    <div className="form-group">
                                    ...
                                    <div id="self-driven-fields">
                                      <div className="form-group">
                                        <label htmlFor="inputDestination">
                                          Drive Test Certificate ID
                                        </label>
                                        <input
                                          type="text"
                                          value=""
                                          className="form-control"
                                          id="drive-test-certificate"
                                          placeholder="Drive Test Certificate ID"
                                          readOnly
                                        />
                                      </div>
                                      ...
                                      <div
                                        className="col-md-12 col-lg-12 p-l-0 p-r-0 "
                                        id="drive-test-fields"
                                      >
                                        <div className="">
                                        ...
                                        <div className="">
                                          <div className="form-group col-xs-12 col-md-6 col-sm-6 p-l-0">
                                            ...
                                            <select
                                              ...
                                              data-style="btn-white"
                                              id="traveloption"
                                              defaultValue={'Select City Option'}
                                            >
                                    ...
                                    <button
                                      id="submitItinerary"
                                      type="submit"
                                      className="btn btn-purple btn-block btn-lg waves-effect waves-light"
                                    >
                                      Add Itinerary
                                    </button>
                                  </form>
                            ...
                            <div className="">
                              ...
                              <div className="table-responsive">
                                <table
                                  ...
                                  data-page-size="5"
                                  data-search="true"
                                  className="table table-actions-bar"
                                >
                                  <thead>
                                    <tr>
                                      <th>Date</th>
                    ...
                    <div style={{ marginBottom: '140px' }}>
                      <button
                        style={{ width: '80px', marginRight: '12px', fontSize: '12px' }}
                        id="previous"
                        type="submit"
                        className="btn btn-primary waves-effect waves-light w-md cd-add-to-cart js-cd-add-to-cart"
                      >
                        Previous
                      </button>
                      ...
                      <button
                        ...
                        id="requestQuote"
                        type="submit"
                        className="pull-right btn btn-primary waves-effect waves-light w-md cd-add-to-cart js-cd-add-to-cart"
                      >
                        Request Quote
                      </button>
          ...
          <div className="modal-dialog">
            <div className="modal-content">
                ...
                <div className="row">
                  <div className="col-md-6">
                    <div className="form-group">
                      ...
                      <input
                        type="text"
                        className="form-control pac-container"
                        id="field-1"
                        placeholder=""
                      />
                    </div>
              ...
              <div className="modal-footer">
                <button
                  type="button"
                  className="btn btn-warning waves-effect waves-light delete_content"
                >
                  Delete
                </button>
                ...
                <button
                  type="button"
                  className="btn btn-info waves-effect waves-light edit_content"
                >
                  Save changes
                </button>
              </div>
