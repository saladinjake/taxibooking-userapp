    ...
    return (
      <React.Fragment>
        <div className="content-page" id="spread-out">
          <div className="content" id="plan-detail">
            <div className="container">
              <div id="note">
                Sorry. You cannot start this trip . If quotation details has been sent to you please
                endeavour to make payments.
              </div>

              <div className="row card-box">
                <div className="m-b-20">
                  <h4 className="page-title" id="plan_id">
                    PLANID2304758{' '}
                  </h4>
                </div>
                    ...
                    >
                      <div className="">
                        ...
                        >
                          ...
                          <tbody id="tablebodyDetail"></tbody>
                        </table>
                      </div>
                      ...
                      <div className="col-lg-12">
                        ...
                        <div className="row" id="car-chosen"></div>
                      </div>
                    </div>
                    ...
                    <div className="tab-pane" id="profile-2" style={{ backgroundColor: '#fff' }}>
                      <div className="table-responsive table-hover">
                        <table className="table table-actions-bar">
                          <thead>
                            <tr>
                              <th className="col-lg-2" data-sortable="true">
                                Date Time
                              </th>
                          ...
                          <tbody id="planned-itineraries"></tbody>
                        </table>
                      </div>
                    </div>
                    ...
                    <div className="tab-pane" id="messages-2" style={{ backgroundColor: '#fff' }}>
                      <div className="table-responsive table-hover">
                        <table className="table table-actions-bar">
                          ...
                          <tbody id="planned-quotation"></tbody>
                        </table>
                      </div>
                    </div>
                  </div>
        ...
        >
          <a
            href="#"
            className="btn btn-default btn-md pull-left right-bar-toggle"
            style={{ fontSize: '18px' }}
          >
            <i className="md md-close hidden text-white waves-effect waves-light p-r-20 p-l-20"></i>
            Close
          </a>
          <h4 className="text-center">Itinerary Detail</h4>
          <div
            className="contact-list m-t-30 nicescroll"
            tabindex="5001"
            style={{ overflow: 'hidden', outline: 'none' }}
          >
            <form className="form m-t-0" action="index.html">
              ...
              <div className="row col-md-12 col-lg-12 m-t-30 ">
                <div className="col-xs-12 col-md-6 col-sm-6">
                  <div className="form-group">
                    <button
                      className="start-itinerary btn btn-purple btn-block text-uppercase waves-effect waves-light m-b-30"
                      type="submit"
                      id="start"
                    >
                      Start Trip
                ...
                <div className="col-xs-12 col-md-6 col-sm-6">
                  <div className="form-group">
                    <button
                      className="btn btn-purple btn-custom btn-block text-uppercase waves-effect waves-light m-b-30"
                      type="submit"
                      id="cancel"
                    >
                      Cancel Trip
                  ...
                  <div className="row">
                    <div className="col-sm-12">
                      <div className="btn-group pull-right m-t-15">
                        ...
                        <ul className="dropdown-menu drop-menu-right" role="menu"></ul>
                      </div>
