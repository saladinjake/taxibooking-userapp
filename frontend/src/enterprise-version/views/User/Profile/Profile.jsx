            ...
            <div className="row" style={{ marginTop: '30px' }}>
              <div className="col-lg-6">
                <div className="card-box">
                  ...
                  <form
                    action="#"
                    className="form-horizontal animated animatedFadeInUp fadeInUp"
                    role="form"
              ...
              <div className="col-md-12 col-lg-6" style={{ float: 'right' }} id="content-download">
                <div className="panel panel-default">
                  <div className="panel-body">
                    <div className="clearfix">
                      <div className="pull-left">
                        <h4 className="text-right">
                          <img
                            src="public/assets/images/Goom LogisticsLogos-02.png"
                            alt="velonic"
                          />
                        </h4>
                      </div>
                    ...
                    <div className="row">
                      <div className="col-md-12">
                        <div className="pull-left m-t-30">
                          <address>
                            <strong>Goom Logistics Ltd.</strong>
                            <br />
                            TS30, Road 9B, Unit 3, <br />
                            Lekki Gardens, Lekki - Epe Expy,
                            <br />
                            Lagos Nigeria
                            <br />
                      ...
                      <div className="col-md-12 animated animatedFadeInUp fadeInUp">
                        <div className="table-responsive">
                          <p>
                            ...
                            eleifend justo. Donec efficitur vestibulum quam, a iaculis erat
                            pellentesque et. Morbi est odio, pulvinar id sem non, cursus varius
                            tortor. Proin tortor nisi, volutpat posuere ex ac, sagittis elementum
                            dolor. Etiam tellus neque, sollicitudin vel ante id, ullamcorper
                            imperdiet turpis. In dignissim tellus id sodales pharetra. Curabitur
                            convallis orci mauris, lacinia adipiscing elit.sollicitudin vel ante id,
                            ullamcorper imperdiet turpis. In dignissim tellus id sodales pharetra.
                            Curabitur convallis orci mauris, lacinia adipiscing elit.sollicitudin
                            vel ante id, ullamcorper imperdiet turpis. In dignissim tellus id
                            sodales pharetra. Curabitur convallis orci mauris, lacinia adipiscing
                            elit.sollicitudin vel ante id, ullamcorper imperdiet turpis. In
                            dignissim tellus id sodales pharetra. Curabitur convallis orci mauris,
                            lacinia adipiscing elit.sollicitudin vel ante id, ullamcorper imperdiet
                            turpis. In dignissim tellus id sodales pharetra. Curabitur convallis
                            orci mauris, lacinia adipiscing elit.sollicitudin vel ante id,
                            ullamcorper imperdiet turpis. In dignissim tellus id sodales pharetra.
                            Curabitur convallis orci mauris, lacinia adipiscing elit.{' '}
                          </p>
                        </div>
                      </div>
                    </div>
                    <div style={{ paddingTop: '15px' }}></div>
                    <div
                      className="row animated animatedFadeInUp fadeInUp"
                    ...
                    <div className="hidden-print animated animatedFadeInUp fadeInUp">
                      <div className="pull-right">
                        <a
                          id="download-pdf"
                          href="#"
                          style={{ width: '100px', fontSize: '14px', marginRight: '4px' }}
