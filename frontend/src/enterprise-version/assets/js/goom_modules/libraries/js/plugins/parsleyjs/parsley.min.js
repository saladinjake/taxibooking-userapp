...
!(function(e, t) {
  ...
  f.prototype = {
    validate: function(t, i) {
      if (this.fn)
        return (
          arguments.length > 3 && (i = [].slice.call(arguments, 1, -1)), this.fn.call(this, t, i)
        );
      if (e.isArray(t)) {
  ...
  (y.Form = {
    _actualizeTriggers: function() {
      ...
      this.$element.on('submit.Parsley', function(t) {
        ...
        this.$element.on('click.Parsley', 'input[type="submit"], button[type="submit"]', function(
          t,
        ) {
          e.onSubmitButton(t);
        }),
    ...
    (y.Field = {
      ...
      _eventValidate: function(e) {
        (!(!/key|input/.test(e.type) || (this._ui && this._ui.validationInformationVisible)) &&
          ...
          t.$element
            ...
            .each(function(e, i) {
              ...
              ('ParsleyField' !== n.__class__ && 'ParsleyFieldMultiple' !== n.__class__) ||
                ...
                ('undefined' == typeof t.fieldsMappedById[n.__class__ + '-' + n.__id__] &&
                  ((t.fieldsMappedById[n.__class__ + '-' + n.__id__] = n), t.fields.push(n)));
            }),
    ...
    _bindHtml5Constraints: function() {
      (this.$element.hasClass('required') || this.$element.attr('required')) &&
        ...
        'undefined' != typeof this.$element.attr('maxlength')
          ...
          : 'undefined' != typeof this.$element.attr('maxlength') &&
            this.addConstraint('maxlength', this.$element.attr('maxlength'), void 0, !0);
  ...
  V.prototype = {
    ...
    bind: function(t, i) {
      ...
      return (
        this.options.multiple &&
          o.setAttr(this.$element, this.options.namespace, 'multiple', this.options.multiple),
        'undefined' != typeof i
