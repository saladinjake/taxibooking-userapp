  ...
  var S = function(g) {
    function X(a) {
      ...
      g.each(a, function(d) {
        if (
          ...
          (c = d.replace(b[0], b[2].toLowerCase())), (e[c] = d), 'o' === b[1] && X(a[d]);
      });
      a._hungarianMap = e;
    }
    function I(a, b, c) {
      ...
      g.each(b, function(d) {
        ...
        if (e !== k && (c || b[e] === k))
          'o' === e.charAt(0)
            ? (b[e] || (b[e] = {}), g.extend(!0, b[e], b[d]), I(a[e], b[e], c))
            : (b[e] = b[d]);
      });
    }
    function S(a) {
    ...
    function L(a, b, c, e) {
      var d = a.aoData.length,
        f = g.extend(!0, {}, m.models.oRow, { src: c ? 'dom' : 'data', idx: d });
      f._aData = b;
      a.aoData.push(f);
        ...
        jb = function(a) {
          if (c === k || c === j)
            (i = l[j]),
              ...
              i && i._bAttrSrc
                ? (Q(i.mData._)(e, n), q(i.mData.sort, a), q(i.mData.type, a), q(i.mData.filter, a))
                : r
                ? (i._setter || (i._setter = Q(i.mData)), i._setter(e, n))
                : (e[j] = n);
          j++;
        };
      if (f)
      ...
      for (c = l.length; b < c; b++)
        (f = l[b]),
          ...
          a.oFeatures.bSort &&
            ...
            !1 !== f.bSortable &&
              (e.attr('tabindex', a.iTabIndex).attr('aria-controls', a.sTableId), Pa(a, f.nTh, b))),
        ...
        if (0 !== j.length) {
          ...
          (c = f.sZeroRecords),
            ...
            (b[0] = g('<tr/>', { class: d ? e[0] : '' }).append(
              g('<td />', { valign: 'top', colSpan: ba(a), class: a.oClasses.sRowEmpty }).html(c),
            )[0]);
      ...
      for (var f = a.sDom.split(''), h, i, j, n, l, r, q = 0; q < f.length; q++) {
        ...
        if ('<' == i) {
          ...
          if ("'" == n || '"' == n) {
            ...
            -1 != l.indexOf('.')
              ? ((n = l.split('.')), (j.id = n[0].substr(1, n[0].length - 1)), (j.className = n[1]))
              : '#' == l.charAt(0)
      ...
      for (j = c.length; f < j; f++) {
        ...
        for (d = e.firstChild; d; ) {
          if ('TD' == d.nodeName.toUpperCase() || 'TH' == d.nodeName.toUpperCase()) {
            ...
            for (i = 0; i < l; i++)
              for (h = 0; h < r; h++)
                (a[f + h][n + i] = { cell: d, unique: q }), (a[f + h].nTr = e);
          }
          d = d.nextSibling;
        }
      }
    ...
    function pb(a) {
      var b = a.oClasses,
        ...
        b = g('<div/>', { id: !f.f ? c + '_filter' : null, class: b.sFilter }).append(
          g('<label/>').append(i),
        ),
        f = function() {
      ...
      j = g('<div/>', { class: f.sScrollWrapper })
        ...
        .append(
          g('<div/>', { class: f.sScrollBody })
            .css({ position: 'relative', overflow: 'auto', width: !e ? null : u(e) })
            .append(b),
        );
      l &&
        j.append(
          g('<div/>', { class: f.sScrollFoot })
            .css({ overflow: 'hidden', border: 0, width: e ? (!e ? null : u(e)) : '100%' })
            .append(
    ...
    function Z(a) {
      ...
      H(function(a, b) {
        a.innerHTML =
          '<div class="dataTables_sizing" style="height:0;overflow:hidden;">' + A[b] + '</div>';
        a.style.width = y[b];
      }, v);
      N &&
        H(function(a, b) {
    ...
    function Ha(a) {
      ...
      if (e || (!q && !f && !d && i == ba(a) && i == n.length))
        ...
        for (m = 0; m < j.length; m++)
          (o = c[j[m]]),
            (n[m].style.width =
              null !== o.sWidthOrig && '' !== o.sWidthOrig ? u(o.sWidthOrig) : '');
        if (a.aoData.length)
          for (m = 0; m < j.length; m++)
            (q = j[m]),
              (o = c[q]),
        ...
        f && h
          ? i.width(h)
          : f
          ? (i.css('width', 'auto'), i.width() < k.clientWidth && i.width(k.clientWidth))
          : d
          ...
          : g.sort(function(a, b) {
              ...
              for (i = 0; i < j; i++)
                if (
                  ...
                  (c = k[g.col]),
                  (h = m[g.col]),
                  (g = d[g.type + '-' + g.dir] || d['string-' + g.dir]),
                  (c = g(c, h)),
                  0 !== c)
                )
                  return c;
    ...
    function Kb(a) {
      for (
        var b, c, e = a.aoColumns, d = V(a), a = a.oLanguage.oAria, f = 0, h = e.length;
        f < h;
        f++
      ) {
        c = e[f];
        ...
        c.bSortable &&
          (0 < d.length && d[0].col == f
            ? (g.setAttribute('aria-sort', 'asc' == d[0].dir ? 'ascending' : 'descending'),
              (c = i[d[0].index + 1] || i[0]))
            : (c = i[0]),
    ...
    function xa(a) {
      ...
      if (d.bSort && d.bSortClasses) {
        d = 0;
        for (f = b.length; d < f; d++)
          (h = b[d].src), g(D(a.aoData, 'anCells', h)).removeClass(c + (2 > d ? d + 1 : 3));
        d = 0;
        for (f = e.length; d < f; d++)
          (h = e[d].src), g(D(a.aoData, 'anCells', h)).addClass(c + (2 > d ? d + 1 : 3));
      }
      a.aLastSort = e;
    }
    function Jb(a, b) {
      ...
      for (var f, h = m.ext.type.order[c.sType + '-pre'], i = 0, g = a.aoData.length; i < g; i++)
        if (((c = a.aoData[i]), c._aSortData || (c._aSortData = []), !c._aSortData[b] || e))
          (f = e ? d[i] : y(a, i, b, 'sort')), (c._aSortData[b] = h ? h(f) : f);
    }
    function ya(a) {
    ...
    function Lb(a) {
      ...
      if (a.oFeatures.bStateSave) {
        ...
        if (
          ...
          -1 === g.inArray(!1, b) &&
            ((b = a.iStateDuration),
            !(0 < b && d.time < +new Date() - 1e3 * b) && e.length === d.columns.length))
        ) {
    ...
    function J(a, b, c, e) {
      ...
      e &&
        (c += '. For more information about this error, please see http://datatables.net/tn/' + e);
      ...
      for (d in b)
        b.hasOwnProperty(d) &&
          ...
          g.isPlainObject(e)
            ...
            : (a[d] = c && 'data' !== d && 'aaData' !== d && g.isArray(e) ? e.slice() : e));
      return a;
    }
    function Wa(a, b, c) {
      g(a)
    ...
    function Aa(a, b) {
      ...
      b <= c
        ...
        : (a >= b - 1 - e
            ? (c = W(b - (c - 2), b))
            : ((c = W(a - e + 2, a + e - 1)), c.push('ellipsis'), c.push(b - 1)),
        ...
        if ('table' != this.nodeName.toLowerCase())
          ...
          d.bJQueryUI
            ? (g.extend(j, m.ext.oJUIClasses, d.oClasses),
              d.sDom === l.sDom && 'lfrtip' === l.sDom && (o.sDom = '<"H"lfr>t<"F"ip>'),
              o.renderer)
          ...
          o.iInitDisplayStart === k &&
            ((o.iInitDisplayStart = d.iDisplayStart), (o._iDisplayStart = d.iDisplayStart));
          null !== d.iDeferLoading &&
            ((o.bDeferLoading = !0),
            (h = g.isArray(d.iDeferLoading)),
            (o._iRecordsDisplay = h ? d.iDeferLoading[0] : d.iDeferLoading),
            (o._iRecordsTotal = h ? d.iDeferLoading[1] : d.iDeferLoading));
          var t = o.oLanguage;
    ...
    t.extend = function(a, b, c) {
      if (c.length && b && (b instanceof t || b.__dt_wrapper)) {
        ...
        for (d = c.length; e < d; e++)
          (f = c[e]),
            (b[f.name] =
              'function' === typeof f.val ? h(a, f.val, f) : g.isPlainObject(f.val) ? {} : f.val),
            (b[f.name].__dt_wrapper = !0),
            t.extend(a, b[f.name], f.propExt);
      }
    };
    t.register = p = function(a, b) {
      if (g.isArray(a)) for (var c = 0, e = a.length; c < e; c++) t.register(a[c], b);
      else
    ...
    p('draw()', function(a) {
      return this.iterator('table', function(b) {
        'page' === a
          ? M(b)
          : ('string' === typeof a && (a = 'full-hold' === a ? !1 : !0), R(b, !1 === a));
      });
    });
    p('page()', function(a) {
      return a === k
    ...
    var $a = function(a, b, c, e, d) {
      ...
      bb = function(a) {
        for (var b = 0, c = a.length; b < c; b++)
          if (0 < a[b].length)
            return (
              (a[0] = a[b]), (a[0].length = 1), (a.length = 1), (a.context = [a.context[b]]), a
            );
        a.length = 0;
        return a;
      },
        ...
        if (a !== k && f.bVisible !== a) {
          if (a) {
            ...
            for (j = h.length; i < j; i++)
              (n = h[i].nTr), (d = h[i].anCells), n && n.insertBefore(d[e], d[l] || null);
      ...
      header: {
        _: function(a, b, c, e) {
          g(a.nTable).on('order.dt.DT', function(d, f, h, g) {
            if (a === f) {
              d = c.idx;
              b.removeClass(c.sSortingClass + ' ' + e.sSortAsc + ' ' + e.sSortDesc).addClass(
                g[d] == 'asc' ? e.sSortAsc : g[d] == 'desc' ? e.sSortDesc : c.sSortingClass,
              );
            }
          });
        },
