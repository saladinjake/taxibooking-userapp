...
(function(c) {
  ...
  var n = c.fn.dataTable,
    j = function(a, b) {
      ...
      this.s.dt.settings()[0].responsive ||
        (b && 'string' === typeof b.details && (b.details = { type: b.details }),
  ...
  c.extend(j.prototype, {
      ...
      var a = this,
        ...
        e = d
          ...
          .map(function(a) {
            ...
            a === p &&
              (a = c(b.header).data('priority') !== p ? 1 * c(b.header).data('priority') : 1e4);
            return {
              className: e,
              includeIn: [],
              auto: !1,
    ...
    _detailsDisplay: function(a, b) {
      ...
      (!0 === f || !1 === f) &&
        c(e.table().node()).triggerHandler('responsive-display.dt', [e, a, f, b]);
    },
