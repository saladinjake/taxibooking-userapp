!(function(t) {
  ...
  function h(t, n, e, a, o, r, l) {
    ...
    var s,
      ...
      v = 0.1875 * o;
    for (
      t.strokeStyle = l, t.lineWidth = 0.5 * r, t.lineCap = 'round', t.lineJoin = 'round', s = 4;
      s--;
  ...
  function f(t, n, i, e, a, o, r, l, s) {
    ...
    var h,
      ...
      M = (n + r) % l;
    if (
      ((t.strokeStyle = s), (t.lineWidth = o), (t.lineCap = 'round'), (t.lineJoin = 'round'), 1 > m)
    ) {
      if (
        (t.beginPath(),
        (m *= d.length / 2 - 1),
  ...
  (b.CLEAR_DAY = function(t, n, i) {
    ...
    (b.RAIN = function(t, n, i) {
      var e = t.canvas.width,
        a = t.canvas.height,
        r = Math.min(e, a);
      s(t, n, 0.5 * e, 0.37 * a, 0.9 * r, r * M, i), o(t, n, 0.5 * e, 0.37 * a, 0.9 * r, r * M, i);
    }),
    (b.SLEET = function(t, n, i) {
      var e = t.canvas.width,
        a = t.canvas.height,
        r = Math.min(e, a);
      h(t, n, 0.5 * e, 0.37 * a, 0.9 * r, r * M, i), o(t, n, 0.5 * e, 0.37 * a, 0.9 * r, r * M, i);
    }),
    (b.SNOW = function(t, n, i) {
      var e = t.canvas.width,
        a = t.canvas.height,
        r = Math.min(e, a);
      c(t, n, 0.5 * e, 0.37 * a, 0.9 * r, r * M, i), o(t, n, 0.5 * e, 0.37 * a, 0.9 * r, r * M, i);
    }),
    (b.WIND = function(t, n, i) {
      var e = t.canvas.width,
        a = t.canvas.height,
        o = Math.min(e, a);
      f(t, n, 0.5 * e, 0.5 * a, o, o * M, 0, 2, i), f(t, n, 0.5 * e, 0.5 * a, o, o * M, 1, 2, i);
    }),
    ...
    (b.prototype = {
      ...
      draw: function(t, n) {
        ...
        this.resizeClear ? (i.width = i.width) : t.context.clearRect(0, 0, i.width, i.height),
