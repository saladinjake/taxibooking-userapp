                ...
                var g = this.className || '',
                  ...
                  o =
                    'undefined' != typeof c.data('icon')
                      ? '<span class="' + d.options.iconBase + ' ' + c.data('icon') + '"></span> '
                      : '',
        ...
        render: function(b) {
          ...
          b !== !1 &&
            this.$element.find('option').each(function(a) {
              ...
              d.setDisabled(
                a,
                this.disabled ||
                  ('OPTGROUP' === this.parentNode.tagName && this.parentNode.disabled),
                b,
              ),
          ...
          if (this.multiple && this.options.selectedTextFormat.indexOf('count') > -1) {
            ...
            if ((g.length > 1 && e.length > g[1]) || (1 == g.length && e.length >= 2)) {
              ...
              var h = this.$element
                  .find('option')
                  .not('[data-divider="true"], [data-hidden="true"]' + c).length,
                i =
            ...
            if ((t(), 'auto' === this.options.size)) {
              var u = function() {
                ...
                t(),
                  (b = e - r),
                  f.options.container
                    ? (g.data('height') || g.data('height', g.height()), (c = g.data('height')))
                    : (c = g.height()),
        ...
        checkDisabled: function() {
          ...
          this.isDisabled()
            ...
            : (this.$button.hasClass('disabled') &&
                (this.$newElement.removeClass('disabled'), this.$button.removeClass('disabled')),
          ...
          this.$newElement.on('touchstart.dropdown', '.dropdown-menu', function(a) {
            ...
            this.$menuInner.on('click', 'li a', function(c) {
              ...
              if (
                ...
                if (b.multiple) {
                  if (
                    (i.prop('selected', !j), b.setSelected(e, !j), d.blur(), l !== !1 || m !== !1)
                  ) {
          ...
          if (
            ...
            if (
              (/(13|32)/.test(c.keyCode.toString(10)) ||
                (/(^9$)/.test(c.keyCode.toString(10)) && o.options.selectOnTab)) &&
              l
            ) {
