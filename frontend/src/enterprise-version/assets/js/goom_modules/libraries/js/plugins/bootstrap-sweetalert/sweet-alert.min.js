  ...
  function c(b) {
    ...
    if (b.imageUrl) {
      ...
      if (b.imageSize) {
        ...
        o && q
          ? ((l = o), (m = q), k.css({ width: o + 'px', height: q + 'px' }))
          : a.console.error(
              'Parameter imageSize expects value with format WIDTHxHEIGHT, got ' + b.imageSize,
            );
      }
  ...
  var h,
    ...
    E = function(b) {
      'function' == typeof b.stopPropagation
        ...
        : a.event && a.event.hasOwnProperty('cancelBubble') && (a.event.cancelBubble = !0);
    };
  (a.sweetAlertInitialize = function() {
    ...
    (a.sweetAlert = a.swal = function() {
            ...
            : ((c =
                13 === b || 32 === b
                  ? -1 === d
                    ? u
                    : void 0
                  : 27 !== b || v.hidden || 'none' === v.style.display
                  ? void 0
                  : v),
              void 0 !== c && D(c, a));
        }
      ...
      if (void 0 === arguments[0])
        return a.console.error('sweetAlert expects at least 1 attribute!'), !1;
      var m = d({}, o);
          ...
          (m.title = arguments[0].title),
            ...
            (m.closeOnConfirm =
              void 0 !== arguments[0].closeOnConfirm
                ...
                : o.closeOnConfirm),
            (m.closeOnCancel =
              void 0 !== arguments[0].closeOnCancel ? arguments[0].closeOnCancel : o.closeOnCancel),
        ...
        : b.attachEvent &&
          b.attachEvent('onreadystatechange', function c() {
            'complete' === b.readyState &&
              (b.detachEvent('onreadystatechange', c), sweetAlertInitialize());
          });
    })();
})(window, document);
