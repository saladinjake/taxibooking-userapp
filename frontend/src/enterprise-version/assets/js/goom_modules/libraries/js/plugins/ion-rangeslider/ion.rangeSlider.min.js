  ...
  var r = function(a, b, d) {
    ...
    a &&
      ...
      b && b.values && b.values.length
        ? ((d.from = a[0] && b.values.indexOf(a[0])), (d.to = a[1] && b.values.indexOf(a[1])))
  ...
  r.prototype = {
    ...
    chooseHandle: function(a) {
      return 'single' === this.options.type
        ? 'single'
        : a >= this.coords.p_from_real + (this.coords.p_to_real - this.coords.p_from_real) / 2
          ...
          if ('single' === this.options.type)
            (a = a
              ...
              (this.$cache.min[0].style.visibility =
                this.labels.p_single_left < this.labels.p_min + 1 ? 'hidden' : 'visible'),
            ...
            a
              ? (this.options.decorate_both
                  ...
                  : (a = this.decorate(
                      b[this.result.from] + this.options.values_separator + b[this.result.to],
                    )),
                (d = this.decorate(b[this.result.from])),
                (b = this.decorate(b[this.result.to])))
              : (this.options.decorate_both
                  ? ((a = this.decorate(this._prettify(this.result.from), this.result.from)),
                    (a += this.options.values_separator),
                    (a += this.decorate(this._prettify(this.result.to), this.result.to)))
                  : (a = this.decorate(
