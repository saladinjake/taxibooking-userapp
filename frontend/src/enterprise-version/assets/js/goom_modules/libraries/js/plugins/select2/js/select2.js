...
(function(factory) {
  ...
  var S2 = (function() {
    ...
    S2.define('select2/selection/base', ['jquery', '../utils', '../keys'], function(
      $,
      Utils,
      KEYS,
    ) {
    ...
    S2.define('select2/selection/multiple', ['jquery', './base', '../utils'], function(
      $,
      BaseSelection,
      Utils,
    ) {
    ...
    S2.define('select2/selection/search', ['jquery', '../utils', '../keys'], function(
      $,
      Utils,
      KEYS,
    ) {
    ...
    S2.define('select2/data/array', ['./select', '../utils', 'jquery'], function(
      SelectAdapter,
      Utils,
      $,
    ) {
