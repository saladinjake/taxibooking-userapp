(function() {
  ...
  function bh(a, b) {
    function f() {
      ...
      var b = this.className,
        ...
        e = d ? b.baseVal : b;
      (c.lastIndex = 0),
        c.test(e) || ((e = m(e + ' ' + a)), d ? (b.baseVal = e) : (this.className = e));
    }
    function g() {
  ...
  function bR(a, b) {
    return d3.format(
      ',.' + Math.max(0, -Math.floor(Math.log(bP(a, b)[2]) / Math.LN10 + 0.01)) + 'f',
    );
  }
  function bS(a, b, c, d) {
    var e = c(a[0], a[1]),
  ...
  function cu(a, b) {
    return a.length < 3
      ? cq(a)
      : a[0] + cw((a.push(a[0]), a), cx([a[a.length - 2]].concat(a, [a[1]]), b));
  }
  function cv(a, b, c) {
  ...
  function cX(a, b) {
    ...
    return (
      cW ? ((c.x = b.pageX), (c.y = b.pageY)) : ((c.x = b.clientX), (c.y = b.clientY)),
  ...
  function dt() {
    if (dn) {
      ...
      dk ||
        (d3.event.altKey
          ? (dm || (dm = [(dj[0][0] + dj[1][0]) / 2, (dj[0][1] + dj[1][1]) / 2]),
            (dn[0] = dj[+(a[0] < dm[0])][0]),
            (dn[1] = dj[+(a[1] < dm[1])][1]))
          : (dm = null)),
  ...
  function ea() {
    dV &&
      dR === d3.event.target &&
      (d3.event.stopPropagation(), d3.event.preventDefault(), (dV = !1), (dR = null));
  }
  function eb(a, b, c) {
    function l(a, b, c) {
      a.domain(
  ...
  (d3.functor = function(a) {
    ...
    (d3.mean = function(a, b) {
      var c = a.length,
        ...
        f = -1,
        g = 0;
      if (arguments.length === 1) while (++f < c) j((d = a[f])) && (e += (d - e) / ++g);
  ...
  (d3.round = function(a, b) {
    ...
    (d3.xhr = function(a, b, c) {
      ...
      arguments.length < 3 ? (c = b) : b && d.overrideMimeType && d.overrideMimeType(b),
        d.open('GET', a, !0),
  ...
  (d3.interpolators = [
    ...
    (S.prototype.darker = function(a) {
      return (
        (a = Math.pow(0.7, arguments.length ? a : 1)),
        R(Math.floor(a * this.r), Math.floor(a * this.g), Math.floor(a * this.b))
      );
    }),
  ...
  (d3.hsl = function(a, b, c) {
    ...
    ($.prototype.brighter = function(a) {
      return (a = Math.pow(0.7, arguments.length ? a : 1)), Z(this.h, this.s, this.l / a);
    }),
    ($.prototype.darker = function(a) {
      return (a = Math.pow(0.7, arguments.length ? a : 1)), Z(this.h, this.s, a * this.l);
    }),
    ...
    (d3.svg.chord = function() {
      function f(c, d) {
        ...
        return (
          ...
          (h(e, f)
            ? j(e.r, e.p1, e.r, e.p0)
            : j(e.r, e.p1, f.r, f.p0) + i(f.r, f.p1) + j(f.r, f.p1, e.r, e.p0)) +
          'Z'
        );
      }
      function g(a, b, f, g) {
      ...
      function e(a) {
        ...
        a.each(function() {
          ...
          h
            ...
            j.exit().remove(),
            b && ((k = bJ(b.range())), h.attr('x', k[0]).attr('width', k[1] - k[0]), dp(a, d)),
            c && ((k = bJ(c.range())), h.attr('y', k[0]).attr('height', k[1] - k[0]), dq(a, d));
        });
      }
      function f() {
  ...
  d3.behavior.zoom = function() {
    ...
    function i() {
      ...
      var b = dY(),
        c,
        d = Date.now();
      b.length === 1 && d - dN < 300 && eb(1 + Math.floor(a[2]), (c = b[0]), dM[c.identifier]),
        (dN = d);
    }
    var a = [0, 0, 0],
      b = d3.dispatch('zoom'),
