tinymce.PluginManager.add('link', function(a) {
  ...
  function d(b) {
    ...
    (i = v.getNode()),
      ...
      a.settings.rel_list &&
        (p = { name: 'rel', type: 'listbox', label: 'Rel', values: c(a.settings.rel_list) }),
          ...
          function d() {
            ...
            j
              ? (a.focus(),
                m &&
                  u.text != k &&
                  ('innerText' in j ? (j.innerText = u.text) : (j.textContent = u.text)),
                w.setAttribs(j, b),
                v.select(j),
                a.undoManager.add())
              : m
            ...
            (e = u.href)
              ? e.indexOf('@') > 0 && -1 == e.indexOf('//') && -1 == e.indexOf('mailto:')
                ...
                : (a.settings.link_assume_external_targets && !/^\w+:/i.test(e)) ||
                  (!a.settings.link_assume_external_targets && /^\s*www[\.|\d\.]/i.test(e))
                ? void c(
