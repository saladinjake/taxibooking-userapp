...
(function(e) {
    ...
    h = function(a, b) {
      this instanceof h
        ? (b === l && (b = {}),
          ...
          (this.dom = { force: i.createElement('div'), scroller: null, table: null, loader: null }),
  ...
  e.extend(h.prototype, {
    ...
    fnScrollToRow: function(a, b) {
      ...
      0 > j && (j = 0);
      if ((f > this.s.redrawBottom || f < this.s.redrawTop) && this.s.dt._iDisplayStart !== j)
    ...
    _fnDrawCallback: function() {
      ...
      'undefined' != typeof this.s.dt.oLoadedState.iScroller
        ? (((c =
            (this.s.dt.sAjaxSource || a.s.dt.ajax) && !this.s.dt.oFeatures.bServerSide ? !0 : !1) &&
            2 == this.s.dt.iDraw) ||
            (!c && 1 == this.s.dt.iDraw)) &&
          setTimeout(function() {
        ...
        var a = this.s.dt,
          ...
          g =
            0 === a.fnRecordsDisplay() && a.fnRecordsDisplay() == a.fnRecordsTotal()
              ...
              ? b.sInfoEmpty + ' ' + b.sInfoFiltered.replace('_MAX_', k) + b.sInfoPostFix
