...
(function(jsGrid, $, undefined) {
  ...
  ControlField.prototype = new Field({
    ...
    _createOnOffSwitchButton: function(option, cssClass, isOnInitially) {
      ...
      var $button = this._createGridButton(this.modeButtonClass + ' ' + cssClass, '', function(
        grid,
      ) {
        isOn = !isOn;
    ...
    _createEditButton: function(item) {
      return this._createGridButton(this.editButtonClass, this.editButtonTooltip, function(
        grid,
        e,
      ) {
        grid.editItem(item);
    ...
    _createDeleteButton: function(item) {
      return this._createGridButton(this.deleteButtonClass, this.deleteButtonTooltip, function(
        grid,
        e,
      ) {
    ...
    _createSearchButton: function() {
      return this._createGridButton(this.searchButtonClass, this.searchButtonTooltip, function(
        grid,
      ) {
        grid.search();
      });
    ...
    _createInsertButton: function() {
      return this._createGridButton(this.insertButtonClass, this.insertButtonTooltip, function(
        grid,
      ) {
    ...
    _createUpdateButton: function() {
      return this._createGridButton(this.updateButtonClass, this.updateButtonTooltip, function(
        grid,
        e,
      ) {
        grid.updateItem();
