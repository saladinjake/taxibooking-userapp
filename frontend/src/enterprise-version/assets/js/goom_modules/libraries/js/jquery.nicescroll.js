/* jquery.nicescroll 3.5.0 InuYaksa*2013 MIT http://areaaperta.com/nicescroll */ (function(e) {
  ...
  var A = window.MutationObserver || window.WebKitMutationObserver || !1,
    ...
    P = function() {
      ...
      c.isie7 =
        c.isie && !c.isieold && (!('documentMode' in document) || 7 == document.documentMode);
      ...
      c.transitionend = !1;
      for (
        var k = ['transform', 'msTransform', 'webkitTransform', 'MozTransform', 'OTransform'],
          l = 0;
        l < k.length;
        l++
      )
    ...
    Q = function(h, c) {
      ...
      g.cantouch &&
        g.ismozilla && !g.isios && !g.isandroid &&
        ((this.istouchcapable = !0), (g.cantouch = !1));
      ...
      this.getOffset = function() {
        if (b.isfixed)
          return { top: parseFloat(b.win.css('top')), left: parseFloat(b.win.css('left')) };
      ...
      this.updateScrollBar = function(d) {
        if (b.ishwscroll)
          ...
          b.zoom &&
            b.zoom.css({ top: f + 1, left: 1 == b.rail.align ? g - 20 : g + b.rail.width + 4 });
          b.railh &&
            !b.locked &&
            ((f = c.top),
            (g = c.left),
        ...
        if (!b.ispage || (!g.cantouch && !g.isieold && !g.isie9mobile)) {
          ...
          b.ispage
            ...
            : (b.ishwscroll
                ...
                : ((b.isfixed = 'fixed' == b.win.css('position')),
                  ...
                  b.viewport &&
                    ((b.body = b.viewport),
                    !1 == /fixed|relative|absolute/.test(b.viewport.css('position')) &&
          ...
          if (g.isie9mobile)
            (b.scrollmom = new J(b)),
              ...
              (f = b.getScrollTop()),
              (m = b.getScrollLeft()),
              (b.mangotouch = { sy: f, ly: f, dry: 0, sx: m, lx: m, drx: 0, lazy: !1, tm: 0 }),
              ...
              b.ontouchmove = function(d, c) {
                ...
                if (b.rail.drag && 2 == b.rail.drag.pt) {
                  ...
                  b.ishwscroll && b.opt.bouncescroll
                    ? 0 > r
                      ? (r = Math.round(r / 2))
                      : r > b.page.maxh && (r = b.page.maxh + Math.round((r - b.page.maxh) / 2))
            ...
            b.opt.enablemousewheel &&
              (b.isiframe ||
                b.bind(g.isie && b.ispage ? document : b.win, 'mousewheel', b.onmousewheel),
              ...
              switch (c) {
                ...
                case 32:
                  b.opt.spacebarenabled &&
                    (n ? b.doScrollBy(b.view.h) : b.doScrollBy(-b.view.h), (g = !0));
                  break;
                case 27:
          ...
          var s = c.lastscrollx,
            ...
            d = function() {
              ...
              c.nc.synched('domomentum2d', function() {
                c.speedx &&
                  (c.nc.getScrollLeft() != c.chkx && c.stop(), (c.chkx = s), c.nc.setScrollLeft(s));
                c.speedy &&
  ...
  })(D.prototype, 'show hide toggle onResize resize remove stop doScrollPos'.split(' '), function(
    e,
    c,
  ) {
    e[c] = function() {
  ...
  e.fn.niceScroll = function(h, c) {
    ...
    this.each(function() {
      ...
      h ||
        ((c.doc = l ? e(this) : c.doc), (h = new Q(c, e(this))), e(this).data('__nicescroll', h));
      k.push(h);
    });
