        ...
        if (h)
          if (e.isArray(h)) this._buildButtons(h, b, c);
            ...
            if (i) {
              ...
              b.append(i.inserter);
              c === m
                ? (this.s.buttons.push({ node: q, conf: h, inserter: i.inserter }),
                  this.s.subButtons.push([]))
                : this.s.subButtons[c].push({ node: q, conf: h, inserter: i.inserter });
              h.buttons &&
          ...
          if (e.isArray(a) || a instanceof e) {
            ...
            if (-1 !== a.indexOf(',')) {
              ...
              for (g = j.length; f < g; f++)
                j[f].name === k && c.push({ inst: b, idx: b.toIndex(j[f].node) });
            } else
              e(f)
                .filter(a)
                .each(function() {
            ...
            'object' === typeof a &&
              a.nodeName &&
              ((g = e.inArray(a, f)), -1 !== g && c.push({ inst: b, idx: b.toIndex(f[g]) }));
        },
        f = 0,
        g = a.length;
      f < g;
    ...
    collection: {
      ...
      action: function(a, b, c, d) {
        ...
        e('div.dt-button-background').length &&
          ((f = e('div.dt-button-collection').offset()), e(o).trigger('click.dtb-collection'));
        d._collection
