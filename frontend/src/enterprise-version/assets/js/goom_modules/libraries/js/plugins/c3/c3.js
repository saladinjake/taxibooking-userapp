(function(window) {
  ...
  c3_chart_internal_fn.initParams = function() {
    ...
    $$.isLegendLeft =
      config.legend_inset_anchor === 'top-left' || config.legend_inset_anchor === 'bottom-left';
    $$.legendStep = 0;
    $$.legendItemWidth = 0;
    $$.legendItemHeight = 0;
  ...
  c3_chart_internal_fn.updateSizes = function() {
    ...
    $$.margin = config.axis_rotated
      ? {
          ...
          bottom:
            $$.getHorizontalAxisHeight('y') + legendHeightForBottom + $$.getCurrentPaddingBottom(),
      ...
      : {
          ...
          right: hasArc ? 0 : $$.getCurrentPaddingRight(),
          bottom:
            xAxisHeight + subchartHeight + legendHeightForBottom + $$.getCurrentPaddingBottom(),
  ...
  c3_chart_internal_fn.findClosest = function(values, pos) {
    ...
    values
      ...
      .forEach(function(v) {
        var shape = $$.main
          .select(
            '.' + CLASS.bars + $$.getTargetSelectorSuffix(v.id) + ' .' + CLASS.bar + '-' + v.index,
          )
          .node();
  ...
  c3_chart_internal_fn.getSvgLeft = function(withoutRecompute) {
    var $$ = this,
      ...
      hasArc = $$.hasArcType(),
      svgLeft =
        svgRect.right - chartRect.left - (hasArc ? 0 : $$.getCurrentPaddingLeft(withoutRecompute));
  ...
  c3_chart_internal_fn.getHorizontalAxisHeight = function(axisId) {
    ...
    return (
      h + ($$.axis.getLabelPositionById(axisId).isInner ? 0 : 10) + (axisId === 'y2' ? -10 : 0)
    );
  };
  ...
  c3_chart_internal_fn.updateLegend = function(targetIds, options, transitions) {
    ...
    function updatePositions(textElement, id, index) {
      var reset = index === 0,
        ...
        areaLength =
          $$.isLegendRight || $$.isLegendInset ? $$.getLegendHeight() : $$.getLegendWidth(),
        margin,
        maxLength;
  ...
  Axis.prototype.getLabelPosition = function getLabelPosition(axisId, defaultPosition) {
    var option = this.getLabelOptionByAxisId(axisId),
      position =
        option && typeof option === 'object' && option.position ? option.position : defaultPosition;
    return {
  ...
  c3_chart_internal_fn.dataLabelFormat = function(targetId) {
    ...
    if (typeof data_labels.format === 'function') {
      ...
      if (data_labels.format[targetId]) {
        format =
          data_labels.format[targetId] === true ? defaultFormat : data_labels.format[targetId];
      } else {
        format = function() {
          return '';
        };
  ...
  c3_chart_fn.load = function(args) {
    ...
    if ('unload' in args) {
      ...
      $$.unload(
        $$.mapToTargetIds(typeof args.unload === 'boolean' && args.unload ? null : args.unload),
        function() {
          $$.loadFromArgs(args);
        },
      );
