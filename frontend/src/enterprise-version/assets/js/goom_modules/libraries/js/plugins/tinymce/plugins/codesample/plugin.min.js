!(function(a, b) {
  ...
  d('tinymce/codesampleplugin/Prism', [], function() {
    ...
    d(
      ...
      ['tinymce/dom/DOMUtils', 'tinymce/codesampleplugin/Utils', 'tinymce/codesampleplugin/Prism'],
      function(a, b, c) {
        function d(a, b, d) {
          a.undoManager.transact(function() {
            ...
            (d = h.encode(d)),
              f
                ...
                : (a.insertContent('<pre id="__new" class="language-' + b + '">' + d + '</pre>'),
        ...
        b.add('codesample', function(b, h) {
          function i() {
            ...
            (b.inline && f) ||
              (!b.inline && j) ||
              (b.inline ? (f = !0) : (j = !0),
              (a = b.dom.create('link', { rel: 'stylesheet', href: h + '/css/prism.css' })),
              b
                .getDoc()
