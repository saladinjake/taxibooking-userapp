(function(g) {
      ...
      A = function(a, b) {
        var a = y(a),
          ...
          f = function() {
            ...
            g
              ? (g.location.href = h)
              : d.open(h, '_blank') === k && 'undefined' !== typeof safari && (d.location.href = h);
            e.readyState = e.DONE;
            z();
            r(h);
          },
    ...
    action: function(a, b, e, c) {
      ...
      e = function(a) {
        for (var b = [], c = 0, d = a.length; c < d; c++) {
          ...
          b.push(
            'number' === typeof a[c] ||
              (a[c].match && a[c].match(/^-?[0-9\.]+$/) && '0' !== a[c].charAt(0))
              ? '<c t="n"><v>' + a[c] + '</v></c>'
              : '<c t="inlineStr"><is><t>' +
                  (!a[c].replace
                    ? a[c]
                    : a[c].replace(/&(?!amp;)/g, '&amp;').replace(/[\x00-\x1F\x7F-\x9F]/g, '')) +
                  '</t></is></c>',
          );
        }
  ...
  l.ext.buttons.pdfHtml5 = {
    ...
    action: function(a, b, e, c) {
      ...
      c.title && a.content.unshift({ text: F(c, !1), style: 'title', margin: [0, 0, 0, 12] });
