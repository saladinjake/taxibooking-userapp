!(function(a) {
    ...
    function k(m) {
      m.each(function() {
        ...
        function n(a, b) {
          ...
          return (
            0 === b &&
              (c = 'left' === q || 'right' === q ? -((V[a.index] - 1) * (U.h / 2) - 3) : '.71em'),
            c
          );
        }
        function v(a) {
  ...
  (k.generate = function(a) {
    ...
    (i.initParams = function() {
      ...
      (a.clipId = 'c3-' + +new Date() + '-clip'),
        ...
        (a.isLegendLeft =
          'top-left' === c.legend_inset_anchor || 'bottom-left' === c.legend_inset_anchor),
        (a.legendStep = 0),
        (a.legendItemWidth = 0),
    ...
    (i.initWithData = function(b) {
      ...
      (e.axis = new f(e)),
        ...
        (e.selectChart = h.bindto
          ...
          : g.selectAll([])),
        e.selectChart.empty() &&
          ((e.selectChart = g.select(document.createElement('div')).style('opacity', 0)),
          e.observeInserted(e.selectChart),
          (i = !1)),
        e.selectChart.html('').classed('c3', !0),
        (e.data.xs = {}),
        (e.data.targets = e.convertDataToTargets(b)),
        h.data_filter && (e.data.targets = e.data.targets.filter(h.data_filter)),
        h.data_hide &&
          e.addHiddenTargetIds(h.data_hide === !0 ? e.mapToIds(e.data.targets) : h.data_hide),
        h.legend_hide &&
          e.addHiddenLegendIds(h.legend_hide === !0 ? e.mapToIds(e.data.targets) : h.legend_hide),
        ...
        e.updateSvgSize(),
        (d = e.main = e.svg.append('g').attr('transform', e.getTranslate('main'))),
    ...
    (i.updateSizes = function() {
      ...
      (a.currentWidth = a.getCurrentWidth()),
        ...
        (a.margin2 = b.axis_rotated
          ? { top: a.margin.top, right: 0 / 0, bottom: 20 + e, left: a.rotated_padding_left }
          : { top: a.currentHeight - h - e, right: 0 / 0, bottom: g + e, left: a.margin.left }),
    ...
    (i.findClosest = function(a, b) {
      ...
      return (
        a
          ...
          .forEach(function(a) {
            var b = d.main
              .select('.' + l.bars + d.getTargetSelectorSuffix(a.id) + ' .' + l.bar + '-' + a.index)
              .node();
            ...
            values: a
              .map(function(a, g) {
                ...
                return (
                  ...
                  { x: j, value: null === a[b] || isNaN(a[b]) ? null : +a[b], id: f }
                );
              })
              .filter(function(a) {
                return q(a.x);
        ...
        a && 0 !== a.length
          ? (c.svg
            ...
            void a.forEach(function(a) {
              (c.withoutFadeIn[a] = !1),
                c.legend &&
                  c.legend.selectAll('.' + l.legendItem + c.getTargetSelectorSuffix(a)).remove(),
                ...
                .each(function() {
                  c.select(this).classed(l.EXPANDED, !0),
                    d.data_selection_enabled &&
                      g.style('cursor', d.data_selection_grouped ? 'pointer' : null),
                    d.tooltip_grouped ||
                      (b.hideXGridFocus(),
                      b.hideTooltip(),
    ...
    (i.isLineType = function(a) {
      ...
      return (
        !b.data_types[c] ||
        ['line', 'spline', 'area', 'area-spline', 'step', 'area-step'].indexOf(b.data_types[c]) >= 0
      );
    }),
      ...
      for (f = 0; f < a.length; f++)
        a[f] &&
          ...
          void 0 !== h &&
            ...
            (e +=
              "<td class='name'><span style='background-color:" + j + "'></span>" + i + '</td>'),
    ...
    (i.showTooltip = function(a, b) {
      ...
      0 !== j.length &&
        ...
        (f.tooltip
          .html(
            g.tooltip_contents.call(f, a, f.axis.getXAxisTickFormat(), f.getYFormat(h), f.color),
          )
          .style('display', 'block'),
    ...
    (i.updateLegend = function(a, b, c) {
      function d(a, b) {
        return (
          u.legendItemTextBox[b] ||
            (u.legendItemTextBox[b] = u.getTextRect(a.textContent, l.legendItem)),
          u.legendItemTextBox[b]
        );
      }
      function e(b, c, e) {
        function f(a, b) {
          b || ((g = (o - D - n) / 2), B > g && ((g = (o - n) / 2), (D = 0), J++)),
            (I[a] = J),
      ...
      (b = b || {}),
        ...
        u.isLegendInset &&
          ((J = v.legend_inset_step ? v.legend_inset_step : a.length), u.updateLegendStep(J)),
        u.isLegendRight
          ? ((f = function(a) {
              return z * I[a];
            }),
        ...
        (m = u.legend
          ...
          .on('click', function(a) {
            v.legend_item_onclick
              ...
              : (u.api.toggle(a), u.isTargetToShow(a) ? u.api.focus(a) : u.api.revert());
          })
          .on('mouseover', function(a) {
        ...
        t &&
          (n ? t.transition() : t)
            ...
            .attr('width', z * (J + 1) + 10),
        u.legend.selectAll('.' + l.legendItem).classed(l.legendItemHidden, function(a) {
    ...
    (f.prototype.getYAxis = function(a, b, c, d, e, f) {
      ...
      return (
        i.isTimeSeriesY()
          ? l.ticks(j.time[k.axis_y_tick_time_value], k.axis_y_tick_time_interval)
          : l.tickValues(d),
        l
      );
    }),
    ...
    (f.prototype.generateTickValues = function(a, b, c) {
      ...
      if (b)
        if (((d = n(b) ? b() : b), 1 === d)) k = [a[0]];
          ...
          for (
            g = d - 2, e = a[0], f = a[a.length - 1], h = (f - e) / (g + 1), k = [e], i = 0;
            g > i;
            i++
          )
    ...
    (i.transformForArcLabel = function(a) {
      ...
      return (
        h &&
          ...
          (f =
            g.radius && e
              ? ((36 / g.radius > 0.375 ? 1.175 - 36 / g.radius : 0.8) * g.radius) / e
              : 0),
          (i = 'translate(' + c * f + ',' + d * f + ')')),
        i
      );
    ...
    (i.expandArc = function(b) {
      ...
      return d.transiting
        ? void (c = a.setInterval(function() {
            d.transiting ||
              (a.clearInterval(c),
              d.legend.selectAll('.c3-legend-item-focused').size() > 0 && d.expandArc(b));
          }, 10))
    ...
    (i.shouldShowArcLabel = function() {
      var a = this,
        ...
        c = !0;
      return (
        a.hasType('donut') ? (c = b.donut_label_show) : a.hasType('pie') && (c = b.pie_label_show),
        c
      );
    }),
    ...
    (i.redrawArc = function(a, b, c) {
      ...
      (d = h
        ...
        d
          ...
          .style('opacity', 0)
          .each(function(a) {
            e.isGaugeType(a.data) && (a.startAngle = a.endAngle = -1 * (Math.PI / 2)),
              (this._current = a);
          }),
        d
        ...
        (k.data_selection_enabled &&
          ...
          m
            ...
            .each(function(a, b) {
              ...
              s ^ r &&
                (p.classed(l.INCLUDED, !r), p.classed(l.SELECTED, !q), m.call(j, !q, p, a, b));
            })));
    }),
    ...
    (i.toggleShape = function(a, b, c) {
      ...
      f.data_selection_enabled &&
        ...
        (f.data_selection_multiple ||
          d.main
            .selectAll(
              '.' + l.shapes + (f.data_selection_grouped ? d.getTargetSelectorSuffix(b.id) : ''),
            )
            .selectAll('.' + l.shape)
            .each(function(a, b) {
              var c = e.select(this);
  ...
  var m = (i.isValue = function(a) {
    ...
    u = (i.isEmpty = function(a) {
      return (
        !a || (o(a) && 0 === a.length) || ('object' == typeof a && 0 === Object.keys(a).length)
      );
    }),
  ...
  (h.focus = function(a) {
    ...
    (h.load = function(a) {
      ...
      return (
        ...
        'cacheIds' in a && b.hasCaches(a.cacheIds)
          ...
          : void ('unload' in a
              ? b.unload(
                  b.mapToTargetIds('boolean' == typeof a.unload && a.unload ? null : a.unload),
                  function() {
                    b.loadFromArgs(a);
                  },
                )
    ...
    (h.data.names = function(a) {
      return (
        this.internal.clearLegendItemTextBoxCache(), this.internal.updateDataAttributes('names', a)
      );
    }),
    ...
    (h.category = function(a, b) {
      var c = this.internal,
        d = c.config;
      return (
        arguments.length > 1 && ((d.axis_x_categories[a] = b), c.redraw()), d.axis_x_categories[a]
      );
    }),
