      ...
      a('.sp-loading').hide(),
            ...
            a(this).append(
              ...
              a('a', this).each(function(b) {
                ...
                ((0 === b && !e) || a(this).hasClass('sp-default')) &&
                  ((h = ' class="sp-current"'), (c = g), (d = a('img', this)[0].src)),
                  a(this)
                    .parents('.sp-wrap')
                    .find('.sp-thumbs')
                    .append(
                      '<a href="' + g + '" style="background-image:url(' + f + ')"' + h + '></a>',
                    ),
                  a(this).remove();
              }),
              a('.sp-large', this).append(
                '<a href="' + c + '" class="sp-current-big"><img src="' + d + '" alt="" /></a>',
              ),
        ...
        a(document.body).on('click', '.sp-tb-active a', function(b) {
          ...
          a(this)
            .parents('.sp-wrap')
            .find('.sp-large')
            .html('<a href="' + f + '" class="sp-current-big"><img src="' + g + '"/></a>'),
            a(this)
              .parents('.sp-wrap')
              .find('.sp-large')
              .hide()
        ...
        a(document.body).on('click', '.sp-large a', function(b) {
          ...
          a(this)
            ...
            .addClass('sp-selected'),
            a('body').append(
              '<div class="sp-lightbox" data-currenteq="' + e + '"><img src="' + c + '"/></div>',
            ),
            d > 1 &&
              (a('.sp-lightbox').append(
                "<a href='#' id='sp-prev'></a><a href='#' id='sp-next'></a>",
