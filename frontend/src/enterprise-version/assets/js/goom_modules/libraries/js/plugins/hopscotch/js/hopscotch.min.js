  ...
  return (
    ...
    (utils = {
      ...
      invokeCallbackArrayHelper: function(a) {
        var b;
        return Array.isArray(a) && ((b = helpers[a[0]]), 'function' == typeof b)
      ...
      getStepTarget: function(a) {
        ...
        if (Array.isArray(a.target)) {
          ...
          for (c = 0, d = a.target.length; d > c; c++)
            if ('string' == typeof a.target[c] && (b = utils.getStepTargetHelper(a.target[c])))
              return b;
          return null;
        }
        return a.target;
      ...
      flipPlacement: function(a) {
        if (a.isRtl && !a._isFlipped) {
          ...
          for (c in d)
            (b = d[c]),
              a.hasOwnProperty(b) && rtlMatches.hasOwnProperty(a[b]) && (a[b] = rtlMatches[a[b]]);
          a._isFlipped = !0;
        }
      },
    }),
    ...
    (HopscotchBubble.prototype = {
      ...
      setPosition: function(a) {
        ...
        if (
          ...
          (c = j.offsetWidth),
          (b = j.offsetHeight),
          utils.removeClass(j, 'fade-in-down fade-in-up fade-in-left fade-in-right'),
        ...
        (g = 'center' !== a.arrowOffset ? utils.getPixelValue(a.arrowOffset) : a.arrowOffset),
          g
            ? 'top' === a.placement || 'bottom' === a.placement
              ? ((k.style.top = ''),
                'center' === g
                  ? (k.style[l] = Math.floor(c / 2 - k.offsetWidth / 2) + 'px')
                  : (k.style[l] = g + 'px'))
              : ('left' === a.placement || 'right' === a.placement) &&
                ((k.style[l] = ''),
                'center' === g
                  ? (k.style.top = Math.floor(b / 2 - k.offsetHeight / 2) + 'px')
                  : (k.style.top = g + 'px'))
          ...
          a.fixedElement || ((e += utils.getScrollTop()), (f += utils.getScrollLeft())),
      ...
      render: function(a, b, c) {
        ...
        if (
            ...
            ? ((g = winHopscotch.getCurrTour()),
              g &&
                ...
                Array.isArray(g.steps) &&
                  ((h = g.steps.length),
                  (j = this._getStepI18nNum(this._getStepNum(h - 1))),
                  (l = this._getStepNum(b) === this._getStepNum(h - 1)))))
            : ((e = a.customData),
              (d = a.customRenderer),
              (f = a.unsafe),
              (a.isRtl = a.hasOwnProperty('isRtl') ? a.isRtl : this.opt.isRtl)),
          (k = utils.getI18NString(l ? 'doneBtn' : a.showSkip ? 'skipBtn' : 'nextBtn')),
          utils.flipPlacement(a),
          utils.normalizePlacement(a),
          ...
          (m = {
            ...
            buttons: {
              showPrev:
                utils.valOrDefault(a.showPrevButton, this.opt.showPrevButton) &&
          ...
          if (!winHopscotch.templates || 'function' != typeof winHopscotch.templates[d])
          ...
          if (!winHopscotch.templates || 'function' != typeof winHopscotch.templates[templateToUse])
            throw new Error(
              'Bubble rendering failed - template "' + templateToUse + '" is not a function.',
            );
          n.innerHTML = winHopscotch.templates[templateToUse](m);
        }
        for (children = n.children, numChildren = children.length, i = 0; i < numChildren; i++)
          (node = children[i]), utils.hasClass(node, 'hopscotch-arrow') && (this.arrowEl = node);
        return (
          (n.style.zIndex = 'number' == typeof a.zindex ? a.zindex : ''),
      ...
      _setArrow: function(a) {
        utils.removeClass(this.arrowEl, 'down up right left'),
          'top' === a
            ...
            : 'right' === a && utils.addClass(this.arrowEl, 'left');
      },
      ...
      hide: function(a) {
        ...
        return (
          ...
          (b.style.left = ''),
          a
            ? (utils.addClass(b, 'hide'), utils.removeClass(b, 'invisible'))
            : (utils.removeClass(b, 'hide'), utils.addClass(b, 'invisible')),
          utils.removeClass(b, 'animate fade-in-up fade-in-down fade-in-right fade-in-left'),
          (this.isShowing = !1),
          this
        );
      },
      ...
      _handleBubbleClick: function(a) {
        ...
        if (((c = b(d)), 'cta' === c))
          this.opt.isTourBubble || winHopscotch.getCalloutManager().removeCallout(this.currStep.id),
            this.currStep.onCTA && utils.invokeCallback(this.currStep.onCTA);
          ...
          if (this.opt.isTourBubble) {
            ...
            this.opt.onClose && utils.invokeCallback(this.opt.onClose),
      ...
      init: function(a) {
        ...
        (this.element = f),
          ...
          e.isTourBubble
            ? ((d = winHopscotch.getCurrTour()), d && utils.addClass(f, 'tour-' + d.id))
      ...
      (this.createCallout = function(c) {
        ...
        (this.refreshCalloutPositions = function() {
          ...
          for (c in a)
            a.hasOwnProperty(c) &&
              b.hasOwnProperty(c) &&
              ((d = a[c]), (e = b[c]), d && e && d.setPosition(e));
        });
    }),
    (Hopscotch = function(a) {
      var b,
        ...
        m = function(a) {
          return (
            (b && b.element && b.element.parentNode) || (b = new HopscotchBubble(d)),
            a &&
              utils.extend(b.opt, {
          ...
          s >= u && (s <= u + o('scrollTopMargin') || v >= t)
            ...
            ? typeof YAHOO !== undefinedStr &&
              ...
              ? ((b = YAHOO.env.ua.webkit ? document.body : document.documentElement),
                ...
                c.animate())
              : hasJquery
              ? jQuery('body, html').animate({ scrollTop: w }, o('scrollDuration'), a)
              : (0 > w && (w = 0),
                (e = u > s ? -1 : 1),
                (f = Math.abs(u - w) / (o('scrollDuration') / 10)),
                (g = function() {
                  var b = utils.getScrollTop(),
                    c = b + e * f;
                  return (e > 0 && c >= w) || (0 > e && w >= c)
                    ? ((c = w), a && a(), void window.scrollTo(0, c))
                    : (window.scrollTo(0, c),
                      utils.getScrollTop() === b ? void (a && a()) : void setTimeout(g, 10));
                })())
            ...
            ? ((f += a),
              ...
              (g = function() {
                (c = utils.getStepTarget(d)),
                  c
                    ? (k[f] && delete k[f], b(f))
                    : ((k[f] = !0), utils.invokeEventCallbacks('error'), s(a, b));
              }),
        ...
        t = function(a, b) {
          ...
          if (
            ...
            (a = utils.valOrDefault(a, !0)),
            (c = p()),
            c.nextOnTargetClick && utils.removeEvtListener(utils.getStepTarget(c), 'click', q),
            (d = c),
            (g = b > 0 ? d.multipage : f > 0 && e.steps[f - 1].multipage),
            (h = function(c) {
              var e;
              ...
              if (
                (a &&
                  (e =
                    b > 0
                      ? utils.invokeEventCallbacks('next', d.onNext)
                      : utils.invokeEventCallbacks('prev', d.onPrev)),
                c === f)
              ) {
                if (g) return void x();
            ...
            if (((f += b), (c = p()), !utils.getStepTarget(c) && !g))
              return utils.invokeEventCallbacks('error'), this.endTour(!0, !1);
            h.call(this, f);
        ...
        v = function(a, b, c) {
          var d, e;
          if (((f = a || 0), (k = b || {}), (d = p()), (e = utils.getStepTarget(d))))
            return void c(f);
          if (!e) {
            if ((utils.invokeEventCallbacks('error'), (k[f] = !0), o('skipIfNoElement')))
              return void s(1, c);
            (f = -1), c(f);
          }
        },
        w = function(a) {
          ...
          f !== a &&
            p().nextOnTargetClick &&
            utils.removeEvtListener(utils.getStepTarget(p()), 'click', q),
            (f = a),
            d.hide(!1),
      ...
      (this.getCalloutManager = function() {
                ...
                ? (utils.invokeEventCallbacks('start'),
                  ...
                  void (utils.getStepTarget(p())
                    ...
                    : (utils.invokeEventCallbacks('error'),
                      o('skipIfNoElement') && i.nextStep(!1))))
                : void i.endTour(!1, !1);
            }),
            this
          );
        ...
        (this.endTour = function(a, b) {
          ...
          return (
            ...
            e &&
              ...
              c &&
                c.nextOnTargetClick &&
                utils.removeEvtListener(utils.getStepTarget(c), 'click', q)),
            (f = 0),
            (h = void 0),
            d.hide(),
            a && utils.clearState(o('cookieName')),
            this.isActive && ((this.isActive = !1), e && b && utils.invokeEventCallbacks('end')),
        ...
        (this.removeCallbacks = function(a, b) {
          ...
          for (f in callbacks)
            if (!a || a === f)
              if (b)
                for (c = callbacks[f], d = 0, e = c.length; e > d; ++d)
        ...
        (i = function(a, b) {
          var c,
            ...
            f,
            g,
            h = ['next', 'prev', 'start', 'end', 'show', 'error', 'close'];
          for (
            ...
            (e = 'on' + h[f].charAt(0).toUpperCase() + h[f].substring(1)),
            ...
            (__p +=
              ...
              buttons.showClose &&
                (__p +=
                  ...
                  (null == (__t = i18n.closeTooltip) ? '' : __t) +
                  '</button>'),
              (__p +=
