!(function() {
  ...
  function st(n, t, e) {
    return (
      isNaN(n) && (n = 0), isNaN(t) && (t = 0), new ft(e, Math.cos((n *= Fa)) * t, Math.sin(n) * t)
    );
  }
  function ft(n, t, e) {
  ...
  function Nt(n) {
    return function(t, e, r) {
      return (
        2 === arguments.length && 'function' == typeof e && ((r = e), (e = null)), Ct(t, e, n, r)
      );
    };
  }
  function Ct(n, t, e, r) {
    ...
    function e(n, t, e, r) {
      for (var u, i, o, a = 0, c = t.length, l = e.length; c > a; ) {
        ...
        if (((u = t.charCodeAt(a++)), 37 === u)) {
          if (
            ((o = t.charAt(a++)), (i = C[o in pc ? t.charAt(a++) : o]), !i || (r = i(n, e, r)) < 0)
          )
            return -1;
  ...
  function He(n, t) {
    ...
    for (var a = 0, c = t.length; c > a; ++a) {
      ...
      if (s)
        for (
          var f = l[0], h = f[0], g = f[1] / 2 + Da / 4, p = Math.sin(g), v = Math.cos(g), d = 1;
          ;
      ...
      return {
        ...
        point: function(f, h) {
          ...
          if (
            ...
            v !== c &&
              ((g = r(e, p)),
              (_e(e, g) || _e(p, g)) && ((p[0] += Ta), (p[1] += Ta), (v = t(p[0], p[1])))),
            v !== c)
          )
            (s = 0),
              v
    ...
    function u(t, e, r, a, c, l, s, f, h, g, p, v, d, m) {
      ...
      if (x > 4 * i && d--) {
        var b = a + g,
          ...
          q = C - e,
          L = M * z - y * q;
        ((L * L) / x > i || va((y * z + M * q) / x - 0.5) > 0.3 || o > a * g + c * p + l * v) &&
  ...
  function Gu(n, t, e) {
    ...
    if (((n.charge = 0), !n.leaf))
      for (var i, o = n.nodes, a = o.length, c = -1; ++c < a; )
        (i = o[c]),
          null != i &&
            (Gu(i, t, e), (n.charge += i.charge), (r += i.charge * i.cx), (u += i.charge * i.cy));
    if (n.point) {
  ...
  function Lo(n) {
    for (var t = 0, e = n.length - 1, r = [], u = n[0], i = n[1], o = (r[0] = qo(u, i)); ++t < e; )
  ...
  function $o(n, t, e, r, u) {
    ...
    if (!o) {
      var c = u.time;
      (o = i[r] = { tween: new a(), time: c, delay: u.delay, duration: u.duration, ease: u.ease }),
        (u = null),
        ++i.count,
        ta.timer(
          function(u) {
    ...
    (ka.attr = function(n, t) {
      if (arguments.length < 2) {
        if ('string' == typeof n) {
          var e = this.node();
          return (
            (n = ta.ns.qualify(n)), n.local ? e.getAttributeNS(n.space, n.local) : e.getAttribute(n)
          );
        }
  ...
  (ta.touch = function(n, t, e) {
    if ((arguments.length < 3 && ((e = t), (t = _().changedTouches)), t))
      for (var r, u = 0, i = t.length; i > u; ++u) if ((r = t[u]).identifier === e) return B(n, r);
  }),
      ...
      function t(n, t, u, i, o) {
        return function() {
          ...
          var l,
            ...
            y = $(),
            M = t(h, v);
          r ? ((l = r.apply(s, arguments)), (l = [l.x - M[0], l.y - M[1]])) : (l = [0, 0]),
            g({ type: 'dragstart' });
        };
      }
  ...
  (nc.brighter = function(n) {
    ...
    (nc.darker = function(n) {
      return (
        (n = Math.pow(0.7, arguments.length ? n : 1)), new mt(n * this.r, n * this.g, n * this.b)
      );
    }),
    (nc.hsl = function() {
      ...
      b = {
        ...
        polygonEnd: function() {
          wc.polygonEnd(),
            ...
            (b.lineStart = e),
            (b.lineEnd = r),
            0 > _c ? ((s = -(h = 180)), (f = -(g = 90))) : y > Ta ? (g = 90) : -Ta > y && (f = -90),
            (x[0] = s),
            (x[1] = h);
        },
      };
  ...
  (nl.area = function() {
    ...
    (nl.clip = function(n) {
      for (
        var t, e, r, u, i, o, a = Rr(n), c = -1, l = this.length - Rr(this), s = this[l - 1];
        ++c < l;
          ...
          do {
            ...
            if (n === u.L) {
              if (
                ...
                (t.R && t.R.C) || ((t.L.C = !1), (t.C = !0), uu(this, t), (t = u.R)),
                  (t.C = u.C),
                  (u.C = t.R.C = !1),
                  ru(this, u),
                  (n = this._);
              ...
              ou(e(n)).cells.forEach(function(e, r) {
                for (
                  ...
                  (u = s),
                    ...
                    (s = a[c].edge),
                    (f = s.l === o ? s.r : s.l),
                    r < i.i && r < f.i && cu(o, i, f) < 0 && t.push([n[r], n[i.i], n[f.i]]);
              }),
              t
            );
          }),
  ...
  (ta.ease = function(n) {
    ...
    return (
      (e = hl.get(e) || fl), (r = gl.get(r) || At), xu(r(e.apply(null, ea.call(arguments, 1))))
    );
  }),
  ...
  (Fl.call = ka.call),
    ...
    (Fl.transition = function() {
      for (
        var n, t, e, r, u = this.id, i = ++Hl, o = this.namespace, a = [], c = 0, l = this.length;
        l > c;
        c++
      ) {
        a.push((n = []));
