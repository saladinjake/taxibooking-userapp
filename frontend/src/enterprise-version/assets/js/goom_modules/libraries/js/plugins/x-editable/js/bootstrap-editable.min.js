    ...
    e.prototype = {
      ...
      _process_options: function(b) {
        ...
        var c = (this.o = a.extend({}, this._o)),
          d = c.language;
        switch (
          (k[d] || ((d = d.split('-')[0]), k[d] || (d = i.language)), (c.language = d), c.startView)
        ) {
          case 2:
          case 'decade':
            c.startView = 2;
  ...
  (function(a) {
    ...
    a.fn.editableutils.inherit(b, a.fn.editabletypes.abstractinput),
      a.extend(b.prototype, {
        ...
        value2html: function(a, c) {
          var d = a
            ? this.dpg.formatDate(a, this.parsedViewFormat, this.options.datepicker.language)
            : '';
          b.superclass.value2html.call(this, d, c);
        },
        html2value: function(a) {
        ...
        value2str: function(a) {
          return a
            ? this.dpg.formatDate(a, this.parsedFormat, this.options.datepicker.language)
            : '';
        },
        str2value: function(a) {
