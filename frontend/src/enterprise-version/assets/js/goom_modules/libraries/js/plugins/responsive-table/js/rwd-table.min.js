...
!(function(a) {
  ...
  (e.DEFAULTS = {
      ...
      if (h) {
        ...
        (c = e - d - 1),
          ...
          k
            ...
            : b.$stickyTableHeader.animate({ top: '0' }, l, function() {
      ...
      b.$bodyRows.each(function() {
        ...
        a(this)
          ...
          .each(function() {
            ...
            f > 1 && (d.addClass('spn-cell'), g !== f ? d.show() : d.hide()),
    ...
    (e.prototype.updateSpanningCells = function() {
      ...
      b.$table.find('.spn-cell').each(function() {
        for (
          var b = a(this), c = b.attr('data-columns').split(' '), d = c.length, e = 0, f = 0;
          d > f;
          f++
        )
  ...
  (a.fn.responsiveTable = function(b) {
    return this.each(function() {
      ...
      '' !== f.pattern &&
        (d || c.data('responsiveTable', (d = new e(this, f))), 'string' == typeof b && d[b]());
    });
  }),
