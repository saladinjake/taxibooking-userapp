...
!(function(a, b, c) {
  ...
  (d.prototype = {
    ...
    _createPages: function() {
      var a = this._pagesCount(),
        ...
        d = [];
      c > 1 &&
        d.push(this._createPagerPageNavButton(this.pageNavigatorPrevText, this.showPrevPages));
      for (var e = 0, f = c; b > e && a >= f; e++, f++)
        d.push(f === this.pageIndex ? this._createPagerCurrentPage() : this._createPagerPage(f));
      return (
        a > c + b - 1 &&
          d.push(this._createPagerPageNavButton(this.pageNavigatorNextText, this.showNextPages)),
        d
      );
    },
        ...
        (this._eachField(function(g) {
          if (g.validate) {
            ...
            if (h !== c) {
              ...
              this._setCellValidity(d.children().eq(this._visibleFieldIndex(g)), i),
                i.length &&
                  e.push.apply(
                    e,
                    b.map(i, function(a) {
  ...
  a.jsGrid = { Grid: d, fields: w, setDefaults: x, locales: y, locale: z, version: '1.5.1' };
})(window, jQuery),
  (function(a, b) {
    function c(a) {
      this._init(a);
