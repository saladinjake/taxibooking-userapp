                ...
                (o = o || n.offsetHeight),
                  ...
                  a.appendToBody
                    ? ((n.style.top = b.pageY - o + a.tooltipOffset.y + 'px'),
                      (n.style.left = b.pageX - p / 2 + a.tooltipOffset.x + 'px'))
                    : ((n.style.top = (b.layerY || b.offsetY) - o + a.tooltipOffset.y + 'px'),
                      (n.style.left = (b.layerX || b.offsetX) - p / 2 + a.tooltipOffset.x + 'px'));
              }
              var l = 'ct-point';
              i instanceof c.Bar
                ? (l = 'ct-bar')
                : i instanceof c.Pie && (l = i.options.donut ? 'ct-slice-donut' : 'ct-slice-pie');
              var m = i.container,
                n = m.querySelector('.chartist-tooltip');
              n ||
                ((n = b.createElement('div')),
                (n.className = a['class'] ? 'chartist-tooltip ' + a['class'] : 'chartist-tooltip'),
              ...
              e(n),
                j('mouseover', l, function(e) {
                  ...
                  if (a.tooltipFnc) j = a.tooltipFnc(q, s);
                    ...
                    if (((q = '<span class="chartist-tooltip-meta">' + q + '</span>'), r))
                      j += q + '<br>';
                    ...
                    s &&
                      ...
                      a.currency &&
                        (s = a.currency + s.replace(/(\d)(?=(\d{3})+(?:\.\d+)?$)/g, '$1,')),
                      (j += s));
                  }
