  ...
  function b() {
    ...
    a.each(['text', 'html', 'val'], function(b, g) {
      ...
      a.fn[g] = function(b) {
        ...
        if (b !== c)
          return d.call(g.filter(':tinymce'), b), i.apply(g.not(':tinymce'), arguments), g;
        var h = '',
          k = arguments;
        return (
  ...
  (a.fn.tinymce = function(c) {
              ...
              e.on('init', function() {
                ...
                l.css('visibility', ''),
                  h &&
                    ...
                    ('string' == typeof b &&
                      ((a =
                        -1 === b.indexOf('.') ? null : tinymce.resolve(b.replace(/\.\w+$/, ''))),
                      (b = tinymce.resolve(b))),
                    b.apply(a || tinymce, d));
              }));
        }),
    ...
    if ((l.css('visibility', 'hidden'), g.tinymce || d || !(i = c.script_url)))
      ...
      (n.type = 'text/javascript'),
        (n.onload = n.onreadystatechange = function(b) {
          (b = b || window.event),
            2 === d ||
