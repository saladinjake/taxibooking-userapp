      ...
      start: function(t, i, s) {
        var n,
          ...
          o = e.makeArray(e(a.stack)).sort(function(t, i) {
            return (
              (parseInt(e(t).css('zIndex'), 10) || 0) - (parseInt(e(i).css('zIndex'), 10) || 0)
            );
          });
        o.length &&
      ...
      _mouseStop: function(t) {
        ...
        return (
          this._helper &&
            ...
            (r =
              parseInt(u.element.css('left'), 10) + (u.position.left - u.originalPosition.left) ||
              null),
            (h =
              parseInt(u.element.css('top'), 10) + (u.position.top - u.originalPosition.top) ||
              null),
