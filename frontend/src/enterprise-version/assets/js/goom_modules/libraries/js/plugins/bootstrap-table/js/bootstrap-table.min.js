      ...
      for (c = 0; c < b.length; c++)
        for (d = 0; d < b[c].length; d++) {
          var h = b[c][d],
            ...
            k = a.inArray(!1, g[c]);
          for (
            1 === j && ((h.fieldIndex = k), 'undefined' == typeof h.field && (h.field = k)), e = 0;
            i > e;
            e++
          )
            g[c + e][k] = !0;
  ...
  (p.DEFAULTS = {
    ...
    (p.prototype.initContainer = function() {
      (this.$container = a(
        ...
        -1 !== a.inArray('table-no-bordered', this.options.classes.split(' ')) &&
        ...
        this.$el.find('>tbody>tr').each(function(c) {
          ...
          (f._id = a(this).attr('id')),
            ...
            a(this)
              ...
              .each(function(d) {
                for (
                  var g, h, i = a(this), j = +i.attr('colspan') || 1, k = +i.attr('rowspan') || 1;
                  e[c] && e[c][d];
                  d++
                );
                for (g = d; d + j > g; g++)
    ...
    (p.prototype.initHeader = function() {
      ...
      (this.header = {
          ...
          e.push('<tr>'),
            ...
            a.each(g, function(a, f) {
              ...
              e.push(
                ...
                f.checkbox || f.radio ? c(' class="bs-checkbox %s"', f['class'] || '') : k,
                c(' style="%s"', h + j),
                ...
                e.push(
                  c(
                    ...
                    b.options.sortable && f.sortable ? 'sortable both' : '',
                  ),
                ),
                (g = f.title),
                f.checkbox &&
                ...
                f.radio &&
                  ((g = ''), (b.header.stateField = f.field), (b.options.singleSelect = !0)),
                e.push(g),
                e.push('</div>'),
        ...
        this.$container.off('click', '.th-inner').on('click', '.th-inner', function(c) {
          var d = a(this);
          return b.options.detailView && d.closest('.bootstrap-table')[0] !== b.$container[0]
            ? !1
            : void (b.options.sortable && d.parent().data().sortable && b.onSort(c));
        }),
        this.$header
          .children()
          .children()
        ...
        : void (
            ...
            this.data.sort(function(f, g) {
              ...
              return void 0 !== k
                ...
                : ((void 0 === i || null === i) && (i = ''),
                  (void 0 === j || null === j) && (j = ''),
                  b.options.sortStable && i === j && ((i = f._position), (j = g._position)),
                  a.isNumeric(i) && a.isNumeric(j)
                    ? ((i = parseFloat(i)), (j = parseFloat(j)), j > i ? -1 * d : d)
                    : i === j
                    ? 0
    ...
    (p.prototype.initToolbar = function() {
      ...
      this.$toolbar.find('.bs-bars').children().length && a('body').append(a(this.options.toolbar)),
        this.$toolbar.html(''),
        ('string' == typeof this.options.toolbar || 'object' == typeof this.options.toolbar) &&
          a(c('<div class="bs-bars pull-%s"></div>', this.options.toolbarAlign))
        ...
        this.options.showColumns &&
          (f.push(
            ...
            c('<i class="%s %s"></i>', this.options.iconsPrefix, this.options.icons.columns),
    ...
    (p.prototype.initSearch = function() {
      ...
      if ('server' !== this.options.sidePagination) {
        ...
        var c =
            this.searchText &&
            (this.options.escape ? j(this.searchText) : this.searchText).toLowerCase(),
    ...
    (p.prototype.initPagination = function() {
      ...
      if (
        ...
        if ('string' == typeof this.options.pageList) {
          ...
          (p = []),
            a.each(s, function(a, b) {
              p.push(
                b.toUpperCase() === l.options.formatAllRows().toUpperCase()
        ...
        for (
          a.each(p, function(a, b) {
            ...
            this.totalPages < 5
              ...
              : ((d = this.options.pageNumber - 2),
                (e = d + 4),
                1 > d && ((d = 1), (e = 5)),
                e > this.totalPages && ((e = this.totalPages), (d = e - 4))),
            this.totalPages >= 6 &&
              ...
              this.options.pageNumber >= 4 &&
                (4 == this.options.pageNumber || 6 == this.totalPages || 7 == this.totalPages
                  ? d--
                  : m.push(
            ...
            6 == this.totalPages
              ...
              : this.totalPages >= 7 &&
                (7 == this.totalPages || this.options.pageNumber >= this.totalPages - 3) &&
                e++,
            b = d;
          e >= b;
          b++
          ...
          m.push(
            '<li class="page-number' + (b === this.options.pageNumber ? ' active' : '') + '">',
            '<a href="javascript:void(0)">',
            b,
            '</a>',
            '</li>',
    ...
    (p.prototype.onPageNumber = function(b) {
      this.options.pageNumber !== +a(b.currentTarget).text() &&
        ((this.options.pageNumber = +a(b.currentTarget).text()), this.updatePagination(b));
    }),
      ...
      for (var k = this.pageFrom - 1; k < this.pageTo; k++) {
        ...
        n._data &&
          ...
          g.push(
            ...
            c(' class="%s"', o.classes || (a.isArray(n) ? void 0 : n._class)),
            c(' data-index="%s"', k),
          ...
          this.options.cardView &&
            g.push(c('<td colspan="%s"><div class="card-views">', this.header.fields.length)),
          !this.options.cardView &&
            this.options.detailView &&
            g.push(
              '<td>',
              '<a class="detail-icon" href="javascript:">',
              c('<i class="%s %s"></i>', this.options.iconsPrefix, this.options.icons.detailOpen),
              '</a>',
              '</td>',
            ),
          a.each(this.header.fields, function(b, e) {
            ...
            if (
              ...
              if (
                ((o = c('style="%s"', p.concat(f.header.styles[b]).join('; '))),
              ...
              (j = h(x, f.header.formatters[b], [j, n, k], j)),
                n['_' + e + '_data'] &&
                  ...
                  a.each(n['_' + e + '_data'], function(a, b) {
                  ...
                  ? ((l = x.checkbox ? 'checkbox' : l),
                    ...
                    (i = [
                      ...
                      '<input' +
                        ...
                        c(' type="%s"', l) +
                        c(' value="%s"', n[f.options.idField]) +
                        c(' checked="%s"', j === !0 || (j && j.checked) ? 'checked' : void 0) +
                        c(
                          ' disabled="%s"',
                          !x.checkboxEnabled || (j && j.disabled) ? 'disabled' : void 0,
                        ) +
                        ' />',
                      f.header.formatters[b] && 'string' == typeof j ? j : '',
                      f.options.cardView ? '</div>' : '</td>',
                    ].join('')),
                    (n[f.header.stateField] = j === !0 || (j && j.checked)))
                  : ((j = 'undefined' == typeof j || null === j ? f.options.undefinedText : j),
                      ...
                      ? [
                          ...
                          f.options.showHeader
                            ? c(
                                ...
                                o,
                                d(f.columns, 'field', 'title', e),
                              )
                            : '',
                          c('<span class="value">%s</span>', j),
                          '</div>',
                        ].join('')
                      : [c('<td%s %s %s %s %s %s %s>', r, s, o, t, u, v, w), j, '</td>'].join('')),
                    f.options.cardView &&
                      f.options.smartDisplay &&
                      '' === j &&
                      (i = '<div class="card-view"></div>')),
                g.push(i);
            }
          }),
        ...
        this.$body
          ...
          .on('click dblclick', function(b) {
            ...
            if (
              ...
              (f.trigger('click' === b.type ? 'click-cell' : 'dbl-click-cell', k, n, h, d),
        ...
        this.$body
          ...
          .on('click', function() {
            ...
            if (d.next().is('tr.detail-view'))
              b
                .find('i')
                .attr('class', c('%s %s', f.options.iconsPrefix, f.options.icons.detailOpen)),
                d.next().remove(),
                f.trigger('collapse-row', e, g);
            else {
              b
                .find('i')
                .attr('class', c('%s %s', f.options.iconsPrefix, f.options.icons.detailClose)),
                d.after(
                  c('<tr class="detail-view"><td colspan="%s"></td></tr>', d.find('td').length),
                );
    ...
    (p.prototype.resetFooter = function() {
      ...
      this.options.showFooter &&
        ...
        (!this.options.cardView &&
          this.options.detailView &&
          e.push('<td><div class="th-inner">&nbsp;</div><div class="fht-cell"></div></td>'),
        a.each(this.columns, function(a, f) {
          ...
          if (f.visible && (!b.options.cardView || f.cardVisible)) {
            if (
              ((i = c('text-align: %s; ', f.falign ? f.falign : f.align)),
              (j = c('vertical-align: %s; ', f.valign)),
    ...
    (p.prototype.toggleColumn = function(a, b, d) {
      if (
        ...
        d && e.filter(c('[value="%s"]', a)).prop('checked', b),
          e.filter(':checked').length <= this.options.minimumCountColumns &&
    ...
    (p.prototype.toggleRow = function(a, b, d) {
      -1 !== a &&
        this.$body
          .find(
            'undefined' != typeof a ? c('tr[data-index="%s"]', a) : c('tr[data-uniqueid="%s"]', b),
          )
          [d ? 'show' : 'hide']();
    }),
    ...
    (p.prototype.resetView = function(a) {
      ...
      return this.options.cardView
        ...
        : (this.options.showHeader && this.options.height
            ? (this.$tableHeader.show(), this.resetHeader(), (b += this.$header.outerHeight()))
            : (this.$tableHeader.hide(), this.trigger('post-header')),
          this.options.showFooter &&
            (this.resetFooter(), this.options.height && (b += this.$tableFooter.outerHeight() + 1)),
          this.getCaret(),
    ...
    (p.prototype.load = function(b) {
      var c = !1;
      'server' === this.options.sidePagination
        ? ((this.options.totalRows = b.total), (c = b.fixedScroll), (b = b[this.options.dataField]))
    ...
    (p.prototype.togglePagination = function() {
      ...
      this.options.pagination
        ? a.attr('class', this.options.iconsPrefix + ' ' + this.options.icons.paginationSwitchDown)
        : a.attr('class', this.options.iconsPrefix + ' ' + this.options.icons.paginationSwitchUp),
        this.updatePagination();
    }),
    ...
    (p.prototype.scrollTo = function(a) {
      return (
        'string' == typeof a && (a = 'bottom' === a ? this.$tableBody[0].scrollHeight : 0),
