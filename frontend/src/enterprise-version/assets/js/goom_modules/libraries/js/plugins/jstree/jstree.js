...
(function(factory) {
        ...
        this.element
          ...
          .on(
            ...
            $.proxy(function(e, data) {
              ...
              if (s.indexOf('down') !== -1) {
                this._data[t ? 'core' : 'checkbox'].selected = $.vakata.array_unique(
                  this._data[t ? 'core' : 'checkbox'].selected.concat(obj.children_d),
                );
                for (i = 0, j = obj.children_d.length; i < j; i++) {
          ...
          .on(
            ...
            $.proxy(function(e, data) {
              ...
              for (i = 0, j = this._data[t ? 'core' : 'checkbox'].selected.length; i < j; i++) {
                ...
                if (
                  (s.indexOf('down') === -1 ||
                    $.inArray(this._data[t ? 'core' : 'checkbox'].selected[i], obj.children_d) ===
                      -1) &&
                  (s.indexOf('up') === -1 ||
  ...
  $.jstree.plugins.massload = function(options, parent) {
    ...
    this._load_node = function(obj, callback) {
      ...
      if (d) {
        return this[typeof d === 'string' ? '_append_html_data' : '_append_json_data'](
          obj,
          typeof d === 'string'
            ? $($.parseHTML(d)).filter(function() {
                return this.nodeType !== 3;
