  ...
  d.extend(m.prototype, {
      ...
      if (
        ...
        d(this.dom.scroller)
          ...
          .on('scroll.DTFC', function(a) {
            ...
            if (
              'main' === c &&
              (0 < b.s.iLeftColumns && (b.dom.grid.left.liner.scrollTop = b.dom.scroller.scrollTop),
              0 < b.s.iRightColumns)
            )
          ...
          d(b.dom.grid.left.liner)
            ...
            .on('scroll.DTFC', function(a) {
              ...
              'left' === c &&
                ...
                0 < b.s.iRightColumns &&
                  (b.dom.grid.right.liner.scrollTop = b.dom.grid.left.liner.scrollTop));
            })
            .on(f, function(a) {
              b.dom.scroller.scrollLeft -=
                'wheel' === a.type ? -a.originalEvent.deltaX : a.originalEvent.wheelDeltaX;
            });
          ...
          d(b.dom.grid.right.liner)
            ...
            .on('scroll.DTFC', function(a) {
              ...
              'right' === c &&
                ...
                0 < b.s.iLeftColumns &&
                  (b.dom.grid.left.liner.scrollTop = b.dom.grid.right.liner.scrollTop));
            })
            .on(f, function(a) {
              b.dom.scroller.scrollLeft -=
                'wheel' === a.type ? -a.originalEvent.deltaX : a.originalEvent.wheelDeltaX;
    ...
    _fnEqualiseHeights: function(a, b, c) {
      if (!('none' == this.s.sHeightMatch && 'thead' !== a && 'tfoot' !== a)) {
        ...
        a.height();
        for (
          var g = this._fnGetTrNodes(g), b = this._fnGetTrNodes(c), h = [], c = 0, a = b.length;
          c < a;
          c++
        )
          (e = g[c].offsetHeight),
    ...
    _firefoxScrollError: function() {
      if (u === t) {
        var a = d('<div/>')
          .css({ position: 'absolute', top: 0, left: 0, height: 10, width: 50, overflow: 'scroll' })
          .appendTo('body');
