...
!(function($) {
  ...
  (eCommerceDashboard.prototype.createAreaChartDotted = function(
    element,
    pointSize,
    lineWidth,
    data,
    ...
    (eCommerceDashboard.prototype.init = function() {
      ...
      this.createAreaChartDotted(
        ...
        ['#ffffff'],
        ['#999999'],
        ['#7e57c2', '#b39ddb', '#ede7f6'],
      );
    }),
    //init
    ($.eCommerceDashboard = new eCommerceDashboard()),
    ($.eCommerceDashboard.Constructor = eCommerceDashboard);
})(window.jQuery),
  //initializing
  (function($) {
    'use strict';
