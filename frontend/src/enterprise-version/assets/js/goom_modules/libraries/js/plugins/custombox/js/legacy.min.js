    ...
    b &&
      ...
      Object.getOwnPropertyDescriptor ||
        (Object.getOwnPropertyDescriptor = function(a, b) {
          ...
          return f.call(a, b)
            ? g || h
              ? (delete c.writable, (c.get = c.set = void 0), g && (c.get = g), h && (c.set = h), c)
              : ((c.value = a[b]), c)
            : c;
        }),
  ...
  (function(a, b, c) {
    if ((!a.addEventListener || !a.removeEventListener) && a.attachEvent && a.detachEvent) {
      var d = function(a) {
        ...
        e = function(a, b) {
          var d = b[c];
          if (d) for (var e, f = d.length; f--; ) if (((e = d[f]), e[0] === a)) return e[1];
        },
        f = function(a, b, d) {
          var f = b[c] || (b[c] = []);
        ...
        j = function(a) {
          var b = a.length;
          if (b) for (; b--; ) (a[b].addEventListener = h), (a[b].removeEventListener = i);
