  ...
  r(l, [], function() {
    ...
    function t(t, n, r, i) {
      ...
      for (a = 0; a < i.length; a++)
        if (
          ((o = e(t, n, i[a])),
          o.x >= r.x && o.x + o.w <= r.w + r.x && o.y >= r.y && o.y + o.h <= r.h + r.y)
        )
          return i[a];
      return null;
    }
    ...
    r(f, [u, d], function(e, t) {
      ...
      function a(t, i, o) {
        ...
        function s() {
          ('complete' === c.readyState || ('interactive' === c.readyState && c.body)) &&
        ...
        (c = l + (+new Date()).toString(32)),
                    ...
                    : (d ||
                        ...
                        C &&
                          (x = function(t) {
                            ...
                            r ||
                              ((t = o(t || N.event)),
                              (t.type = 'mouseout' === t.type ? 'mouseleave' : 'mouseenter'),
                              (t.target = n),
                              e(t, g));
                          })),
                      u ||
              ...
              if (((f = i[a]), n)) {
                for (n = n.split(' '), l = n.length; l--; )
                  if (((d = n[l]), (s = f[d]))) {
                    ...
                    (o && 0 !== s.length) ||
                      (delete f[d], r(e, s.fakeName || d, s.nativeHandler, s.capture));
                  }
              } else {
          ...
          (t.fire = function(n, r, i) {
            ...
            do
              (a = n[c]),
                a && e(i, a),
                (n = n.parentNode || n.ownerDocument || n.defaultView || n.parentWindow);
        ...
        return t.first
          ...
          : function(t, n, a) {
              ...
              if (a) {
                ...
                for (; (t = t[r]); )
                  if (1 === t.nodeType || i) {
                    if (((l = t[F] || (t[F] = {})), (s = l[r]) && s[0] === U && s[1] === o))
                      return (c[2] = s[2]);
          ...
          return r !== D && 9 === r.nodeType && r.documentElement
            ? ((D = r),
              ...
              (x.getById = i(function(e) {
                return (
                  (L.appendChild(e).id = F), !r.getElementsByName || !r.getElementsByName(F).length
                );
              })),
              x.getById
        ...
        (k = e.select = function(e, t, n, r) {
          ...
          if (((n = n || []), 1 === d.length)) {
            ...
            for (
              ...
              if (
                (l = w.find[s]) &&
                (r = l(a.matches[0].replace(Ce, xe), (ye.test(o[0].type) && u(t.parentNode)) || t))
              ) {
    ...
    r(g, [f, h, m, d], function(e, n, r, i) {
      ...
      function l(e, t) {
        var n, r, i;
        for (
          t = t || w, i = t.createElement('div'), n = t.createDocumentFragment(), i.innerHTML = e;
          (r = i.firstChild);
      ...
      return (
        (f.fn = f.prototype = {
          ...
          init: function(e, t) {
            ...
            if (a(e)) {
              if (
                ...
                return f(t).find(e);
              if (r[1]) for (i = l(e, v(t)).firstChild; i; ) N.call(n, i), (i = i.nextSibling);
              else {
          ...
          add: function(e, t) {
            ...
            if (t !== !1)
              for (
                r = f.unique(n.toArray().concat(f.makeArray(e))), n.length = r.length, i = 0;
                i < r.length;
                i++
              )
                n[i] = r[i];
            ...
            if ('object' == typeof e)
              ...
              (e = n(e)),
                ...
                i.each(function() {
                  ...
                  (null !== t && '' !== t) ||
                    (n.removeProperty ? n.removeProperty(r(e)) : n.removeAttribute(e));
                });
            else {
              ...
              : ((t = this[0]),
                t &&
                  ...
                  t.getBoundingClientRect &&
                    ...
                    (i = a.left + (r.scrollLeft || n.body.scrollLeft) - r.clientLeft),
                    (o = a.top + (r.scrollTop || n.body.scrollTop) - r.clientTop))),
                { left: i, top: o });
          },
          push: N,
          sort: [].sort,
        ...
        m(
          {
            ...
            contents: function(e) {
              return r.toArray(
                ('iframe' === e.nodeName ? e.contentDocument || e.contentWindow.document : e)
                  .childNodes,
              );
            },
          },
          function(e, t) {
            f.fn[e] = function(n) {
              ...
              return (
                ...
                this.length > 1 &&
                  (T[e] || (i = f.unique(i)), 0 === e.indexOf('parents') && (i = i.reverse())),
                (i = f(i)),
                n ? i.filter(n) : i
              );
            };
          ...
          function(e, t) {
            f.fn[e] = function(n, r) {
              ...
              return (
                ...
                this.length > 1 &&
                  ((o = f.unique(o)),
                  (0 !== e.indexOf('parents') && 'prevUntil' !== e) || (o = o.reverse())),
                (o = f(o)),
                r ? o.filter(r) : o
              );
            };
          ...
          parse: function(t) {
            function s(e, t, n) {
              ...
              if (
                ...
                r &&
                  ((i = m[e + '-right' + t]),
                  i && ((o = m[e + '-bottom' + t]), o && (a = m[e + '-left' + t]))))
              ) {
                var s = [r, i, o, a];
            ...
            function d(e, t, n, r) {
              u(t) &&
                u(n) &&
                u(r) &&
                ((m[e] = m[t] + ' ' + m[n] + ' ' + m[r]), delete m[t], delete m[n], delete m[r]);
            }
            function f(e) {
              return (b = !0), c[e];
            }
            ...
            if (t) {
              for (
                ...
                if (
                  ...
                  'font-weight' === v && '700' === y
                    ? (y = 'bold')
                    : ('color' !== v && 'background-color' !== v) || (y = y.toLowerCase()),
                    (y = y.replace(r, n)),
                    (y = y.replace(i, p)),
                    (m[v] = b ? h(y, !0) : y);
                }
    ...
    r(b, [m], function(e) {
      function t(n) {
        ...
        function v(e) {
          ...
          (3 !== t.nodeType && 4 !== t.nodeType) || !t.nodeValue
            ? (t.childNodes.length > 0 && (o = t.childNodes[r]),
              o ? t.insertBefore(e, o) : 3 == t.nodeType ? n.insertAfter(e, t) : t.appendChild(e))
            : r
        ...
        function N(e, t, r) {
          var i, o;
          for (e ? ((M[W] = t), (M[U] = r)) : ((M[V] = t), (M[$] = r)), i = M[V]; i.parentNode; )
            i = i.parentNode;
          for (o = M[W]; o.parentNode; ) o = o.parentNode;
          o == i ? w(M[W], M[U], M[V], M[$]) > 0 && M.collapse(e) : M.collapse(e),
            (M.collapsed = x()),
        ...
        function T(e, t, n) {
          ...
          return (
            (i = R(t, n)), o && o.appendChild(i), n != O && (M.setStartAfter(e), M.collapse(F)), o
          );
        }
        function R(e, t) {
          var n = C(M[V], M[$] - 1),
    ...
    r(C, [m], function(e) {
      function t(e) {
        var t;
        return (
          (t = document.createElement('div')), (t.innerHTML = e), t.textContent || t.innerText || e
        );
      }
      function n(e, t) {
        var n,
      ...
      var f = {
        ...
        decode: function(e) {
          return e.replace(u, function(e, n) {
            return n
              ? ((n =
                  'x' === n.charAt(0).toLowerCase() ? parseInt(n.substr(1), 16) : parseInt(n, 10)),
                n > 65535
                  ? ((n -= 65536), String.fromCharCode(55296 + (n >> 10), 56320 + (1023 & n)))
            ...
            style: {
              set: function(e, t) {
                return null !== t && 'object' == typeof t
                  ? void e.css(t)
                  : (r && e.attr('data-mce-style', t), void e.attr('style', t));
              },
              get: function(t) {
        ...
        (p.prototype = {
          ...
          is: function(n, r) {
            ...
            if (n.length === t) {
              ...
              if (C.test(r)) {
                for (
                  r = r.toLowerCase().split(/,/), n = n.nodeName.toLowerCase(), i = r.length - 1;
                  i >= 0;
                  i--
                )
                  if (r[i] == n) return !0;
          ...
          createFragment: function(e) {
            var t,
              ...
              i;
            for (
              i = r.createElement('div'), t = r.createDocumentFragment(), e && (i.innerHTML = e);
              (n = i.firstChild);
      ...
      function n() {
        ...
        (this.isDone = function(e) {
          ...
          (this.add = this.load = function(e, t, r) {
            var i = l[e];
            i == h && (c.push(e), (l[e] = n)),
              t && (u[e] || (u[e] = []), u[e].push({ func: t, scope: r || this }));
          }),
      ...
      function a(e) {
        (this.walk = function(t, n) {
          ...
          (p = a(c, h) || c),
            (m = a(d, h) || d),
            s(c, p, !0),
            (y = i(p == c ? p : p.nextSibling, 'nextSibling', m == d ? m.nextSibling : m)),
            y.length && n(r(y)),
            s(d, m);
        }),
                ...
                ? r > 0 &&
                  ...
                  o > r
                    ? ((o -= r),
                      ...
                      (r = 0))
                    : (o = 0))
                : (3 == n.nodeType && r > 0 && r < n.nodeValue.length && ((n = t(n, r)), (r = 0)),
                  3 == i.nodeType &&
                    o > 0 &&
                    o < i.nodeValue.length &&
                    ((i = t(i, o).previousSibling), (o = i.nodeValue.length))),
              { startContainer: n, startOffset: r, endContainer: i, endOffset: o }
            );
          }),
            ...
            function r(r) {
              ...
              if (
                ...
                if (
                  ...
                  if (h.hasChildNodes()) {
                    if (
                      ((p = Math.min(!b && p > 0 ? p - 1 : p, h.childNodes.length - 1)),
                      (h = h.childNodes[p]),
                      (p = 0),
                ...
                o &&
                  ...
                  1 === h.nodeType &&
                    ...
                    !v || 'BR' !== v.nodeName || d(v, 'A') || s(v) || s(v, !0) || f(!0, v))),
        ...
        'onselectionchange' in r.getDoc() ||
          ...
          r.on('SelectionChange', function() {
            ...
            (!t.range && r.selection.isCollapsed()) ||
              (!i(e) && r.dom.isChildOf(e, r.getBody()) && r.nodeChanged({ selectionChange: !0 }));
          }),
          ...
          (this.nodeChanged = function(e) {
            ...
            r.initialized &&
              ...
              ((o = r.getBody()),
              (n = t.getStart() || o),
              (n.ownerDocument == r.getDoc() && r.dom.isChildOf(n, o)) || (n = o),
      ...
      return (
        (t.prototype = {
          ...
          clone: function() {
            ...
            if ((o = e.attributes)) {
              for (s = [], s.map = {}, r = 0, i = o.length; i > r; r++)
                (a = o[r]),
                  'id' !== a.name &&
                    ((s[s.length] = { name: a.name, value: a.value }), (s.map[a.name] = a.value));
              n.attributes = s;
            }
          ...
          remove: function() {
            ...
            return (
              t &&
                (t.firstChild === e ? ((t.firstChild = n), n && (n.prev = null)) : (r.next = n),
                t.lastChild === e ? ((t.lastChild = r), r && (r.next = null)) : (n.prev = r),
      ...
      function n(e) {
        function n(e, n, r) {
          ...
          for (e = t(e), s = e.length; s--; )
            (u = [].concat(l, t(n))),
              (a[e[s]] = { attributes: i(u), attributesOrder: u, children: i(r, o) });
        }
        function r(e, n) {
          var r, i, o, s;
        ...
        return i[e]
          ...
          : ((l = t('id accesskey class dir lang style tabindex title')),
            ...
            n('object', 'data type typemustmatch name usemap form width height', d, 'param'),
            n('param', 'name value'),
            n('map', 'name', d, 'area'),
      ...
      return function(e) {
        function o(t, n, r) {
          ...
          return (
            o
              ...
              : ((o = i[t]),
                o || ((o = a(n, ' ', a(n.toUpperCase(), ' '))), (o = l(o, r)), (i[t] = o))),
            o
          );
        }
        function d(e) {
        ...
        function f(e) {
          ...
          if (e)
            for (
              e = t(e, ','),
                y['@'] && ((w = y['@'].attributes), (N = y['@'].attributesOrder)),
                n = 0,
                r = e.length;
              r > n;
              n++
          ...
          e &&
            ...
            s(t(e, ','), function(e) {
              var t = n.exec(e),
                ...
                o = t[2];
              if (
                ((b[o] = b[i]), (M[o] = i), r || ((R[o.toUpperCase()] = {}), (R[o] = {})), !y[o])
              ) {
                var a = y[i];
        ...
        (e = e || {}),
          ...
          e.valid_elements
            ? h(e.valid_elements)
            : (s(N, function(e, t) {
                (y[t] = { attributes: e.attributes, attributesOrder: e.attributesOrder }),
                  (b[t] = e.children);
              }),
              'html5' != e.schema &&
              ...
              s(t('ol ul sub sup blockquote span font a table tbody tr strong em b i'), function(
                e,
              ) {
            ...
            for (
              ...
              if ((u < c.index && l.text(z(e.substr(u, c.index - u))), (d = c[6])))
                ...
                if (
                  ...
                  (w = d in C),
                  U && M[d] && h.length > 0 && h[h.length - 1].name === d && o(d),
                ...
                if ((f = O[d])) {
                  (f.lastIndex = u = c.index + c[0].length),
                    (c = f.exec(e))
                      ? (_ && (g = e.substr(u, c.index - u)), (u = c.index + c[0].length))
              ...
              if (g[r.name] && 'li' == r.parent.name) {
                ...
                if (o && a.length > 1) {
                  ...
                  s.isEmpty(p) ? o.insert(r, a[0], !0) : (o.insert(s, a[0], !0), o.insert(r, s)),
                    (o = a[0]),
                    (o.isEmpty(p) ||
                      (o.firstChild === o.lastChild && 'br' === o.firstChild.name)) &&
                      o.empty().remove();
                } else if (r.parent) {
                  if ('li' === r.name) {
            ...
            function a() {
              ...
              if (l.isValidChild(y.name, I.toLowerCase())) {
                for (; t; )
                  (n = t.next),
                    3 == t.type ||
                    (1 == t.type && 'p' !== t.name && !T[t.name] && !t.attr('data-mce-type'))
                      ? i
                        ? i.append(t)
                        : ((i = u(I, 1)),
              ...
              (v = new n(
                {
                  ...
                  text: function(e, t) {
                    ...
                    B ||
                      ...
                      0 !== e.length &&
                        ((n = u('#text', 3)), (n.raw = !!t), (b.append(n).value = e));
                  },
                  comment: function(e) {
                        ...
                        if (((n = b.firstChild), n && 3 === n.type))
                          if (((i = n.value.replace(R, '')), i.length > 0))
                            ...
                            for (o = n.next, n.remove(), n = o; n && 3 === n.type; )
                              (i = n.value),
                                (o = n.next),
                                (0 === i.length || M.test(i)) && (n.remove(), (n = o)),
                                (n = o);
                  ...
                  i &&
                    ...
                    c.isEmpty(a) &&
                      ...
                      h &&
                        (h.removeEmpty
                          ? c.remove()
                          : h.paddEmpty && (c.empty().append(new e('#text', 3)).value = '\xa0'))));
                } else {
                  for (
                    u = i;
                    c && c.firstChild === u && c.lastChild === u && ((u = c), !o[c.name]);
                ...
                if (
                  ...
                  for (h = 0, p = m.attributesOrder.length; p > h; h++)
                    (u = m.attributesOrder[h]),
                      u in c.map && ((d = c.map[u]), (f.map[u] = d), f.push({ name: u, value: d }));
                  for (h = 0, p = c.length; p > h; h++)
                    (u = c[h].name),
                      u in f.map || ((d = c.map[u]), (f.map[u] = d), f.push({ name: u, value: d }));
                  c = f;
                }
            ...
            for (var n = e.length, r; n--; )
              (r = e[n]),
                7 === r.type
                  ? r.remove()
                  : 1 === r.type &&
                    ('input' !== t || 'type' in r.attributes.map || r.attr('type', 'text'));
          }),
          e.fix_list_elements &&
            ...
            serialize: function(t, n) {
              ...
              return (
                s.ie && y.select('script,style,select,map').length > 0
                  ? ((p = t.innerHTML), (t = t.cloneNode(!1)), y.setHTML(t, p))
                  : (t = t.cloneNode(!0)),
                ...
                n.cleanup ||
                  ((n.content = c.trim(n.content)), (n.content = n.content.replace(/\uFEFF/g, ''))),
      ...
      function e(e) {
        function t(t, n) {
          ...
          if (
            ...
            if (0 > d)
              for (
                l ? r.collapse(!1) : (r.moveToElementText(f), r.collapse(!0), (l = f), (a = !0)),
                  c = 0;
        ...
        (this.getBookmark = function(n) {
          ...
          function o(e) {
            ...
            return (
              (n = t(a, e)),
              n
                ? { position: n.position, offset: n.offset, indexes: r(n.node), inside: n.inside }
                : void 0
            );
          }
          var a = e.getRng(),
          ...
          (this.moveToBookmark = function(e) {
            ...
            e.start &&
              (e.start.ctrl
                ? ((r = o.createControlRange()), r.addElement(t(e.start.indexes)), r.select())
    ...
    r(F, [I, m, u, d, _], function(e, t, n, r, i) {
      ...
      return function(i, s) {
          ...
          (n = t.screenX - L),
            ...
            (i =
              'IMG' == k.nodeName && s.settings.resize_img_proportional !== !1
                ? !e.modifierPressed(t)
                : e.modifierPressed(t) || ('IMG' == k.nodeName && B[2] * B[3] !== 0)),
            i &&
              (j(n) > j(r) ? ((W = Y(U * F)), (U = Y(W / F))) : ((U = Y(W / F)), (W = Y(U * F)))),
            ...
            B[2] < 0 && T.clientWidth <= U && _.setStyle(T, 'left', P + (O - U)),
            B[3] < 0 && T.clientHeight <= W && _.setStyle(T, 'top', H + (I - W)),
            (n = X.scrollWidth - K),
            (r = X.scrollHeight - G),
              ...
              ? S(A, function(e, i) {
                  function s(t) {
                    (L = t.screenX),
                      ...
                      _.bind(V, 'mouseup', u),
                      $ != V && (_.bind($, 'mousemove', c), _.bind($, 'mouseup', u)),
                      (R = _.add(
                        X,
                        'div',
        ...
        function h(e) {
          ...
          if (!z && !s.removed)
            return (
              S(_.select('img[data-mce-selected],hr[data-mce-selected]'), function(e) {
              ...
              (w(),
              (n = i.getStart(!0)),
              t(n, r) && t(i.getEnd(!0), r) && (!q || (r != n && 'IMG' !== n.nodeName)))
                ? void d(r)
                : void f()
            );
        }
        ...
        function b(e) {
          ...
          if (t != k) {
            if (
              (s.fire('ObjectSelected', { target: t }), C(), 0 === t.id.indexOf('mceResizeHandle'))
            )
      ...
      function u(e) {
        ...
        function l(e, t) {
          ...
          if (t < e.data.length) {
            ...
            if (a.isExtendingChar(e.data[t - 1]) && (o.setStart(e, t), o.setEnd(e, t + 1), !c(o)))
              return i(r(n(o), !1)), u;
          }
          t > 0 && (o.setStart(e, t - 1), o.setEnd(e, t), c(o) || i(r(n(o), !1))),
            t < e.data.length && (o.setStart(e, t), o.setEnd(e, t + 1), c(o) || i(r(n(o), !0)));
        }
        var u = [],
          d,
          h;
        ...
        if (f(e.container()))
          if (e.isAtEnd())
            ...
            if (((h = x(e.container(), e.offset())), y(h) && l(h, 0), g(h) && e.isAtEnd()))
              return i(r(n(h), !1)), u;
      ...
      function f(t, i) {
        ...
        return (
          ...
          g(o)
            ? (c = s(o, a))
            : ((f = o.childNodes),
              a >= f.length ? ((c = 'after'), (a = f.length - 1)) : (c = 'before'),
              (o = f[a])),
          l.push(u(o)),
          (h = d(t, o)),
        ...
        return t
          ? ((n = t.split(',')),
            ...
            (o = r.reduce(
              ...
              function(e, t) {
                return (t = /([\w\-\(\)]+)\[([0-9]+)\]/.exec(t))
                  ? ('text()' === t[1] && (t[1] = '#text'), h(e, t[1], parseInt(t[2], 10)))
                  : null;
              },
              e,
            )),
            o
              ? g(o)
                ? p(o, parseInt(a, 10))
                : ((a = 'after' === a ? y(o) + 1 : y(o)), new i(o.parentNode, a))
              : null)
          : null;
      }
      var g = e.isText,
            ...
            function t(t) {
              ...
              (n = e[o + 'Container']),
                ...
                1 == n.nodeType &&
                  ...
                  n && ((r = t ? 0 : n.childNodes.length), e['set' + (t ? 'Start' : 'End')](n, r)));
            }
            return t(!0), t(), e;
          }
          function f(e) {
          ...
          function h(e) {
            function t(e) {
              ...
              if (n.isCaretContainer(e)) {
                if (
                  (o.isText(e) && n.isCaretContainerBlock(e) && (e = e.parentNode),
                  (t = e.previousSibling),
                  s(t))
                )
                  return t;
          ...
          if (2 == e)
            return (
              ...
              s(b) || 'IMG' == y
                ...
                : ((b = h(p)), b ? ((y = b.tagName), { name: y, index: u(y, b) }) : f(p))
            );
          if (3 == e)
            return (
              (p = a.getRng()),
          ...
          if (
            ...
            try {
              p.collapse(),
                ...
                v ||
                  ...
                  0 === p.compareEndPoints('StartToEnd', m) && m.move('character', -1),
                  m.pasteHTML(
                    '<span data-mce-type="bookmark" id="' +
                      g +
                      '_end" style="' +
            ...
            (m = d(p.cloneRange())),
              v ||
                (m.collapse(!1),
                m.insertNode(
                  l.create('span', { 'data-mce-type': 'bookmark', id: g + '_end', style: x }, C),
                )),
              (p = d(p)),
              p.collapse(!0),
              p.insertNode(
                l.create('span', { 'data-mce-type': 'bookmark', id: g + '_start', style: x }, C),
              );
          }
              ...
              if (
                ...
                'start' == r
                  ? (u ? ((o = i.firstChild), (a = 1)) : (a = l.nodeIndex(i)),
                    (f = h = o),
                    (p = m = a))
                  : (u ? ((o = i.firstChild), (a = 1)) : (a = l.nodeIndex(i)), (h = o), (m = a)),
                !u)
              ) {
                for (
                  c = i.previousSibling,
                ...
                c &&
                  ...
                  l.remove(s),
                  'start' == r ? ((f = h = c), (p = m = a)) : ((h = c), (m = a)));
              }
            }
            function s(t) {
              return (
                !l.isBlock(t) || t.innerHTML || e.ie || (t.innerHTML = '<br data-mce-bogus="1" />'),
                t
              );
            }
            function c() {
            ...
            if (n)
              if (t.isArray(n.start)) {
                ...
                'string' == typeof n.start
                  ...
                  ? (o('start'),
                    o('end'),
                    f && ((u = l.createRng()), u.setStart(s(f), p), u.setEnd(s(h), m), a.setRng(u)))
                  : n.name
      ...
      return (
        (u.prototype = {
          ...
          getStart: function(e) {
            ...
            return (
              ...
              1 == r.nodeType &&
                r.hasChildNodes() &&
                ((e && n.collapsed) ||
                  (r = r.childNodes[Math.min(r.childNodes.length - 1, n.startOffset)])),
          ...
          getRng: function(e) {
            ...
            if (((l = n.editor.fire('GetSelectionRange', { range: i })), l.range !== i))
              return l.range;
            if (h && i && i.setStart && a.selection) {
              ...
              s &&
                s.item &&
                ((o = s.item(0)), (i = a.createRange()), i.setStartBefore(o), i.setEndAfter(o));
            }
            return (
              i || (i = a.createRange ? a.createRange() : a.body.createTextRange()),
              i.setStart &&
              ...
              if (e.select) {
                ...
                e.collapsed ||
                  ...
                  (e.endOffset - e.startOffset < 2 &&
                    ...
                    i && 'IMG' == i.tagName && n.getSel().setBaseAndExtent(i, 0, i, 1)));
              }
          },
          setNode: function(e) {
            var t = this;
              ...
              ? ((i = n.startContainer),
                ...
                n.setStart
                  ? ((r = n.commonAncestorContainer),
                    !n.collapsed &&
                    (i == o && 2 > s - a && i.hasChildNodes() && (r = i.childNodes[a]),
                    3 === i.nodeType &&
                      3 === o.nodeType &&
      ...
      function n(t) {
        this.compare = function(n, i) {
          ...
          return n.nodeName != i.nodeName
            ? !1
            : a(o(n), o(i)) &&
              a(t.parseStyle(t.getAttrib(n, 'style')), t.parseStyle(t.getAttrib(i, 'style')))
      ...
      return function(s) {
                  ...
                  return (
                    ...
                    B(m, 'br')
                      ...
                      : void (!h ||
                        ...
                        f(e) ||
                        (d.inline && J(e))
                          ? ((p = 0), ue(de(e.childNodes), r), b && (h = C), (p = 0))
                          : (p ||
                              ((p = Y.clone(c, ne)), e.parentNode.insertBefore(p, e), a.push(p)),
                            p.appendChild(e)))
                  );
                }
                var p;
                ...
                function o(e) {
                  ...
                  return (
                    ...
                    t &&
                      !ce(t) &&
                      A(t, d) &&
                      ((n = Y.clone(t, ne)), i(n), Y.replace(n, e, re), Y.remove(t, 1)),
                    n || e
                  );
                }
                var s;
        ...
        function w(e, t, n, r) {
          function i(e) {
            var n, r, o, a, s;
            if (
              (1 === e.nodeType && ae(e) && ((a = y), (y = 'true' === ae(e)), (s = !0)),
              (n = de(e.childNodes)),
              y && !s)
            )
            ...
            if (((e = O(e, h, re)), p.split)) {
              if (((t = V(e, re)), (n = V(e)), t != n)) {
                if (
                  ...
                  return (
                    (t = H(t, 'span', { id: '_start', 'data-mce-type': 'bookmark' })),
                    l(t),
                    void (t = u(re))
                  );
                (t = H(t, 'span', { id: '_start', 'data-mce-type': 'bookmark' })),
                  (n = H(n, 'span', { id: '_end', 'data-mce-type': 'bookmark' })),
                  l(t),
                  l(n),
                  (t = u(re)),
                  (n = u());
          ...
          if (n)
            return void (n.nodeType
              ? ((v = Y.createRng()), v.setStartBefore(n), v.setEndAfter(n), f(v))
              : f(n));
          if ('false' !== ae(X.getNode()))
            X.isCollapsed() &&
            p.inline &&
              ...
              if (s.length === oe) {
                for (o in s)
                  if (s.hasOwnProperty(o)) {
                    if (
                      ((a = 'attributes' === i ? Y.getAttrib(e, o) : D(e, o)), r && !a && !t.exact)
                    )
                      return;
          ...
          if (o && e)
            for (s = 0; s < o.length; s++)
              if (((a = o[s]), A(e, a) && i(e, a, 'attributes') && i(e, a, 'styles'))) {
                if ((l = a.classes))
                  for (s = 0; s < l.length; s++) if (!Y.hasClass(e, l[s])) return;
                return a;
              }
        }
        function _(e, t, n) {
          ...
          return n
            ? r(n)
            : ((n = X.getNode()), r(n) ? re : ((i = X.getStart()), i != n && r(i) ? re : ne));
        }
        function S(e, t) {
          var n,
            r = [],
        ...
        function O(t, n, r) {
          ...
          function o(e, t) {
            for (
              t === oe && (t = 3 === e.nodeType ? e.length : e.childNodes.length);
              e && e.hasChildNodes();
          ...
          function u(e, r) {
            var i, o, a, s;
            for (
              3 == e.nodeType && 0 === e.nodeValue.length && e[r] && (e = e[r]), i = d(e), o = 0;
              o < i.length;
              o++
            )
              for (a = 0; a < n.length; a++)
                if (
                  ((s = n[a]),
                  !('collapsed' in s && s.collapsed !== t.collapsed) && Y.is(i[o], s.selector))
                )
                  return i[o];
            return e;
          }
          function f(e, t) {
            ...
            if (
              ...
              r ||
                (r = Y.getParent(3 == e.nodeType ? e.parentNode : e, function(e) {
                  return e != i && l(e);
                })),
          ...
          if ('all' != e.remove)
            for (
              ue(e.styles, function(i, o) {
                ...
                a &&
                  '' === Y.getAttrib(n, 'style') &&
                  (n.removeAttribute('style'), n.removeAttribute('data-mce-style')),
                ...
                ((t.list_block && B(e, t.list_block)) ||
                  ue(de(e.childNodes), function(e) {
                    G(Q, e.nodeName.toLowerCase())
                      ? i
                        ? i.appendChild(e)
                        : ((i = H(e, Q)), Y.setAttribs(i, s.settings.forced_root_block_attrs))
                      : (i = 0);
                  }))
              : J(e) &&
                !J(r) &&
                (n(e, ne) || n(e.firstChild, re, 1) || e.insertBefore(Y.create('br'), e.firstChild),
                n(e, re) || n(e.lastChild, ne, 1) || e.appendChild(Y.create('br')))),
        ...
        function W(e, t) {
          ...
          if (
            e &&
            t &&
            ((e = n(e, 'previousSibling')), (t = n(t, 'nextSibling')), a.compare(e, t))
          ) {
        ...
        function V(t, n) {
          ...
          return (
            ...
            1 == r.nodeType &&
              ((o = r.childNodes.length - 1), !n && i && i--, (r = r.childNodes[i > o ? o : i])),
            3 === r.nodeType &&
              n &&
        ...
        function $(t, n, r, i) {
          ...
          function d(e, t) {
            ...
            if (e)
              (r = X.getRng(!0)),
                a(e)
                  ? (t !== !1 && (r.setStartBefore(e), r.setEndBefore(e)), Y.remove(e))
                  : ((n = u(e)),
                    ...
                    Y.remove(e, 1)),
                X.setRng(r);
            else if (((e = c(X.getStart())), !e)) for (; (e = Y.get(g)); ) d(e, !1);
          }
          function f() {
            var e, t, i, a, s, l, d;
            (e = X.getRng(!0)),
              ...
              (t = c(X.getStart())),
              t && (i = u(t)),
              d && a > 0 && a < d.length && /\w/.test(d.charAt(a)) && /\w/.test(d.charAt(a - 1))
                ? ((s = X.getBookmark()),
                  e.collapse(!0),
                  (e = O(e, m(n))),
                  (e = K.split(e)),
                ...
                : (t && i.nodeValue === ee
                    ? x(n, r, t)
                    : ((t = o(!0)), (i = t.firstChild), e.insertNode(t), (a = 1), x(n, r, t)),
          ...
          function h() {
            ...
            for (
              t = e.startContainer,
                a = e.startOffset,
                u = t,
                3 == t.nodeType && (a != t.nodeValue.length && (c = !0), (u = u.parentNode));
              u;
        ...
        return (
          ...
          e.on('KeyUp', function(a) {
            ...
            a.isDefaultPrevented() ||
              (((l >= 33 && 36 >= l) || (l >= 37 && 40 >= l) || 45 == l || 13 == l || a.ctrlKey) &&
                (i(), e.nodeChanged()),
              (46 == l || 8 == l || (t.mac && (91 == l || 93 == l))) && e.nodeChanged(),
              c &&
                o.typing &&
                (e.isDirty() ||
                  (r(s[0] && n() != s[0].content),
                  e.isDirty() && e.fire('change', { level: s[0], lastLevel: null })),
                e.fire('TypingUndo'),
                (c = !1),
                e.nodeChanged()));
          }),
          ...
          (o = {
            ...
            add: function(t, i) {
              ...
              if (
                ((d = s[a]),
                e
                  .fire('BeforeAddUndo', { level: t, lastLevel: d, originalEvent: i })
                  .isDefaultPrevented())
              )
                return null;
              ...
              if (
                ...
                c.custom_undo_redo_levels && s.length > c.custom_undo_redo_levels)
              ) {
      ...
      return function(i) {
        function o(o) {
              ...
              if (((l = a.createRng()), n.ie || t.normalize(), t.hasChildNodes())) {
                ...
                'BR' == t.nodeName
                  ? t.nextSibling && a.isBlock(t.nextSibling)
                    ? ((!P || 9 > P) && ((u = a.create('br')), t.parentNode.insertBefore(u, t)),
                      l.setStartBefore(t),
                      l.setEndBefore(t))
          ...
          function C(e) {
            ...
            if (
              (e || 'TABLE' == z ? ((n = a.create(e || W)), y(n)) : (n = M.cloneNode(!1)),
              (o = n),
              l.keep_styles !== !1)
            )
              do
          ...
          function x(t) {
            ...
            for (
              n = new e(D, M),
                3 == D.nodeType &&
                  (t && 0 === L ? n.prev() : t || L != D.nodeValue.length || n.next());
              (r = n.current());
          ...
          function w(e, t) {
            ...
            if (((r = a.getParent(e, a.isBlock)), !r || !h(r))) {
              if (
                ...
                return (
                  (n = a.create(d)), y(n), r.appendChild(n), R.setStart(n, 0), R.setEnd(n, 0), n
                );
        ...
        function t() {
          ...
          if (((C = n.forced_root_block), t && 1 === t.nodeType && C)) {
            ...
            if (((l = i.getRng()), l.setStart)) {
              ...
              l.item &&
                ((t = l.item(0)), (l = e.getDoc().body.createTextRange()), l.moveToElementText(t)),
    ...
    r(te, [z, y, _, $, k, U], function(e, t, n, r, i, o) {
      ...
      function h(e, t) {
        var n, r;
        return t
          ? ((n = t.container()), (r = t.offset()), E(n) ? n.childNodes[r + e] : null)
          : null;
      }
      function p(e, t) {
    ...
    r(ne, [_, U, $, te, p, z], function(e, t, n, r, i, o) {
      ...
      function c(t, i) {
        var o;
        return e.isBr(t)
          ? ((o = u(1, n.after(t), i)), o ? !r.isInSameBlock(n.before(t), n.before(o), i) : !1)
          : !1;
      }
      function u(e, t, p) {
        var C, x, w, N, E, _, S;
      ...
      var l = a.matchNodeNames('td th'),
        c = function(a, c, u) {
            ...
            if (A) {
              ...
              t.each(L.select('*[data-mce-fragment]'), function(t) {
                for (var r = t.parentNode; r && r != e; r = r.parentNode)
                  B[t.nodeName.toLowerCase()] && n.compare(r, t) && L.remove(t, !0);
              });
            }
          }
          function p(e) {
              ...
              (S = L.createRng()),
                ...
                k && 3 == k.nodeType
                  ? (S.setStart(k, k.nodeValue.length),
                    e.ie ||
                      ((T = t.nextSibling),
                      T && 3 == T.nodeType && (k.appendData(T.data), T.parentNode.removeChild(T))))
          ...
          /^ | $/.test(c) && (c = d(c)),
            ...
            (R = '<span id="mce_marker" data-mce-type="bookmark">&#xFEFF;&#x200B;</span>'),
          ...
          if (
            ((N = b.parse(c, H)), u.paste === !0 && s.isListFragment(N) && s.isParentBlockLi(L, x))
          )
            return (
          ...
          if ((a._selectionOverrides.showBlockCaretContainer(x), H.invalid)) {
            ...
            (c = x == w ? w.innerHTML : L.getOuterHTML(x)),
              (c = C.serialize(
                b.parse(
                  c.replace(/<span (id="mce_marker"|id=mce_marker).+?<\/span>/i, function() {
            ...
            (c = C.serialize(N)),
              (k = x.firstChild),
              (T = x.lastChild),
              !k || (k === T && 'BR' === k.nodeName) ? L.setHTML(x, c) : D.setContent(c);
      ...
      return function(n) {
        function p(e, t, r, i) {
          var o,
            ...
            l = 0;
          if (
            (/^(mceAddUndoLevel|mceEndUndoLevel|mceBeginUndoLevel|mceRepaint)$/.test(e) ||
              (i && i.skip_focus) ||
              n.focus(),
          ...
          if (((s = e.toLowerCase()), (o = B.exec[s])))
            return o(s, t, r), n.fire('ExecCommand', { command: e, ui: t, value: r }), !0;
          if (
            (a(n.plugins, function(i) {
              return i.execCommand && i.execCommand(e, t, r)
                ? (n.fire('ExecCommand', { command: e, ui: t, value: r }), (l = !0), !1)
                : void 0;
            }),
            l)
          )
          ...
          v({
            ...
            'InsertUnorderedList,InsertOrderedList': function(e) {
              ...
              N(e),
                ...
                t &&
                  ((n = t.parentNode),
                  /^(H[1-6]|P|ADDRESS|PRE)$/.test(n.nodeName) && (S(), T.split(n, t), k()));
            },
            ...
            'Indent,Outdent': function(e) {
              ...
              (t = D.indentation),
                ...
                m('InsertUnorderedList') || m('InsertOrderedList')
                  ? N(e)
                  : (D.forced_root_block || T.getParent(R.getNode(), T.isBlock) || A.apply('div'),
                    a(R.getSelectedBlocks(), function(o) {
                      if ('false' !== T.getContentEditable(o) && 'LI' != o.nodeName) {
                        ...
                        (a += 'rtl' == T.getStyle(o, 'direction', !0) ? 'Right' : 'Left'),
                          'outdent' == e
                            ? ((i = Math.max(0, parseInt(o.style[a] || 0, 10) - t)),
                              T.setStyle(o, a, i ? i + r : ''))
                            : ((i = parseInt(o.style[a] || 0, 10) + t + r), T.setStyle(o, a, i));
                      }
                    }));
            },
            mceRepaint: function() {},
            ...
            selectAll: function() {
              ...
              R.getRng().setStart
                ? ((t = T.createRng()),
                  ...
                  R.setRng(t))
                : ((t = R.getRng()), t.item || (t.moveToElementText(e), t.select()));
            },
            delete: function() {
              N('Delete');
              var e = n.getBody();
    ...
    r(ae, [m], function(e) {
      function t(e, o) {
        ...
        0 !== e.indexOf('/') || c || (e = (s ? s.protocol || 'http' : 'http') + '://mce_host' + e),
          /^[\w\-]*:?\/\//.test(e) ||
            ((l = o.base_uri ? o.base_uri.path : new t(location.href).directory),
            '' === o.base_uri.protocol
      ...
      return (
        (t.prototype = {
          ...
          toRelative: function(e) {
            ...
            var i = n.getURI(),
              o = e.getURI();
            return i == o || ('/' == i.charAt(i.length - 1) && i.substr(0, i.length - 1) == o)
              ? i
    ...
    r(le, [m], function(e) {
      function t(t) {
        ...
        function o(t, r, i, o) {
          ...
          if ((r === !1 && (r = n), r))
            for (
              r = { func: r }, o && e.extend(r, o), s = t.toLowerCase().split(' '), l = s.length;
              l--;
      ...
      return (
        (i = {
          ...
          add: function(t) {
            var n = this;
            return (
              e.isArray(t) ? o.apply(n, t) : t instanceof r ? n.add(t.toArray()) : o.call(n, t), n
            );
          },
          set: function(e) {
            var t = this,
    ...
    r(ge, [m], function(e) {
      ...
      return (
        e.extend(n.prototype, {
          add: function(e) {
            return (
              e && !this.contains(e) && ((this.cls._map[e] = !0), this.cls.push(e), this._change()),
              this
            );
          },
          remove: function(e) {
    ...
    r(ye, [se, m, le, de, he, pe, g, me, ge, ve], function(e, t, n, r, i, o, a, s, l, c) {
        ...
        v = {
          ...
          init: function(e) {
            ...
            (i.settings = e = t.extend({}, i.Defaults, e)),
              ...
              (i._elmCache = {}),
              (i.$ = a),
              (i.state = new r({ visible: !0, active: !1, disabled: !1, value: '' })),
              (i.data = new r(e.data)),
              ...
              e
                ? ((o = n.deltaW),
                  ...
                  (r.x === n.x && r.y === n.y && r.w === n.w && r.h === n.h) ||
                    ((l = m.repaintControls),
                    l && l.map && !l.map[t._id] && (l.push(t), (l.map[t._id] = !0)),
                    (r.x = n.x),
                    (r.y = n.y),
                    (r.w = n.w),
                    (r.h = n.h)),
          ...
          repaint: function() {
            ...
            (c = document.createRange
              ...
              e._hasBody &&
                ...
                ((u = c(i.innerH)),
                (r = r || e.getEl('body')),
                r && ((n = n || r.style), (n.height = (u >= 0 ? u : 0) + 'px')),
                (l.innerH = i.innerH)),
          ...
          renderTo: function(e) {
            return (
              a(e || this.getContainerElm()).append(this.renderHtml()), this.postRender(), this
            );
          },
          preRender: function() {},
          render: function() {},
          ...
          postRender: function() {
            ...
            d(e),
              t.style &&
                ((n = e.getEl()),
                n && (n.setAttribute('style', t.style), (n.style.cssText = t.style))),
              e.settings.border &&
                ((r = e.borderBox),
                e.$el.css({
      ...
      return (
        t.each('text title visible disabled active value'.split(' '), function(e) {
          v[e] = function(t) {
    ...
    r(be, [], function() {
      ...
      return {
        ...
        create: function(n, r) {
          ...
          if (
            ('string' == typeof n ? ((r = r || {}), (r.type = n)) : ((r = n), (n = r.type)),
            (n = n.toLowerCase()),
            (i = e[n]),
            !i)
          )
      ...
      return e.extend({
        ...
        insert: function(e, t, n) {
          ...
          return (
            ...
            t >= 0 &&
              t < i.length &&
              ((o = i.slice(0, t).toArray()), (a = i.slice(t).toArray()), i.set(o.concat(e, a))),
            r.renderNew()
          );
        },
        fromJSON: function(e) {
        ...
        h = e.extend({
          ...
          recalc: function() {
            var e = this,
              ...
              a;
            e._fullscreen &&
              (e.layoutRect(n.getWindowSize()), (e.layoutRect().contentH = e.layoutRect().innerH)),
              e._super(),
              (r = e.layoutRect()),
              e.settings.title &&
                !e._fullscreen &&
                ((i = r.headerW),
                i > r.w &&
                  ((o = r.x - Math.max(0, i / 2)), e.layoutRect({ w: i, x: o }), (a = !0))),
              t &&
                (t.layoutRect({ w: e.layoutRect().innerW }).recalc(),
                (i = t.layoutRect().minW + r.deltaW),
                i > r.w &&
                  ((o = r.x - Math.max(0, i - r.w)), e.layoutRect({ w: i, x: o }), (a = !0))),
              a && e.recalc();
          },
          initLayoutRect: function() {
            var e = this,
      ...
      return e.extend({
        ...
        renderHtml: function() {
          var e = this,
            ...
            o = '';
          return (
            e.icon && (n = '<i class="' + t + 'ico ' + t + 'i-' + e.icon + '"></i>'),
            e.color && (o = ' style="background-color: ' + e.color + '"'),
            e.closeButton &&
              (r = '<button type="button" class="' + t + 'close" aria-hidden="true">\xd7</button>'),
    ...
    r(Oe, [I, T, y, He, A, C, d, m, u, k, $, ne], function(e, t, n, r, i, o, a, s, l, c, u, d) {
      return function(f) {
        ...
        function g(e) {
          var t, n;
          e.dataTransfer &&
            (f.selection.isCollapsed() && 'IMG' == e.target.tagName && re.select(e.target),
            (t = f.selection.getContent()),
            t.length > 0 &&
              ((n = ue + escape(f.id) + ',' + escape(t)), e.dataTransfer.setData(de, n)));
        }
        function v(e) {
          var t;
          return e.dataTransfer && ((t = e.dataTransfer.getData(de)), t && t.indexOf(ue) >= 0)
            ? ((t = t.substr(ue.length).split(',')), { id: unescape(t[0]), html: unescape(t[1]) })
            : null;
        }
        function y(e) {
        ...
        function b() {
          ...
          function c(e) {
            ...
            if (
              ...
              (r = C.getParent(t.getNode(e.endContainer, e.endOffset), C.isBlock)),
          ...
          function h(e, t) {
            ...
            if (
              t.collapsed &&
              ((d = t.startContainer), (h = t.startOffset), (a = C.getParent(d, C.isBlock)), i(a))
            )
              if (1 == d.nodeType) {
                  ...
                  s.each(e.addedNodes, function(e) {
                    if ('SPAN' == e.nodeName && !e.getAttribute('mce-data-marked')) {
                      ...
                      e == r && ((t = n.startOffset), (i = e.firstChild)),
                        C.remove(e, !0),
                        i && (n.setStart(i, t), n.setEnd(i, t), f.selection.setRng(n));
                    }
                  });
                }
              }),
            ...
            N ||
              ...
              f.on('cut', function(e) {
                m(e) ||
                  ...
                  e.clipboardData.setData('text/plain', f.selection.getContent({ format: 'text' })),
                  l.setEditorTimeout(f, function() {
                    p(!0);
                  }));
              }));
        ...
        function _() {
          f.on('click', function(e) {
            ...
            /^(IMG|HR)$/.test(t.nodeName) &&
              ...
              (e.preventDefault(), re.getSel().setBaseAndExtent(t, 0, t, 1), f.nodeChanged()),
              'A' == t.nodeName &&
        ...
        function S() {
          ...
          function t() {
            return (
              !re.isCollapsed() &&
              ne.getParent(re.getStart(), ne.isBlock) != ne.getParent(re.getEnd(), ne.isBlock)
            );
          }
          ...
          ne.bind(f.getBody(), 'mouseup', function() {
            ...
            'IMG' == t.nodeName &&
              ((e = ne.getStyle(t, 'width')) &&
                (ne.setAttrib(t, 'width', e.replace(/[^0-9%]+/g, '')), ne.setStyle(t, 'width', '')),
        ...
        function K() {
          var e, t;
          G() &&
            ((e = f.getBody()), (t = e.parentNode), t.removeChild(e), t.appendChild(e), e.focus());
        }
        function G() {
          var e;
        ...
        function J() {
          ...
          f.on('keypress', function(n) {
            ...
            f.on('keydown', function(e) {
              ...
              m(e) ||
                (n != te && n != ee) ||
                (t(f) && (e.preventDefault(), f.setContent(''), f.nodeChanged()));
            });
        }
        var Q = s.each,
          Z = f.$,
        ...
        return (
          ...
          C(),
          a.windowsPhone || F(),
          ce && (J(), b(), w(), _(), M(), j(), T(), Y(), a.iOS ? (U(), W(), q()) : x()),
      ...
      var o = t.DOM,
        ...
        s = {
          ...
          toggleNativeEvent: function(e, t) {
            ...
            'focus' != e &&
              ...
              (t
                ...
                : n.initialized &&
                  (n.dom.unbind(r(n, e), e, n.delegates[e]), delete n.delegates[e]));
          },
          unbindAllNativeEvents: function() {
            ...
            e.inline ||
              ((e.getBody().onload = null), e.dom.unbind(e.getWin()), e.dom.unbind(e.getDoc())),
    ...
    r(ze, [m, d], function(e, t) {
      ...
      return function(a) {
        ...
        function l(t, n, i, o) {
          ...
          return (
            (l = e.map(r(t, '>'), s)),
            (l[l.length - 1] = e.extend(l[l.length - 1], { func: i, scope: o || a })),
        ...
        a.on('keyup keypress keydown', function(e) {
          (!c(e) && !u(e)) ||
            ...
            (n(p, function(t) {
              return d(e, t)
                ? ((m = t.subpatterns.slice(0)), 'keydown' == e.type && f(t), !0)
                : void 0;
            }),
        ...
        function l(l, u) {
          function d(e, t) {
            ...
            return 0 === e.src.indexOf('blob:')
              ? ((i = s.getByUri(e.src)), void (i && t({ image: e, blobInfo: i })))
                    ...
                    a(function(r) {
                      return (
                        (r = e.map(r, function(e, n) {
                          var r = t[n].image;
                          return (
                            e.status && o.settings.images_replace_blob_uris !== !1 && d(r, e.url),
          ...
          for (n = i('*[contentEditable=false]', t), a = 0; a < n.length; a++)
            (r = n[a]),
              ...
              e.endsWithCaretContainer(o) &&
                ((s = o.data),
                1 == s.length ? o.parentNode.removeChild(o) : o.deleteData(s.length - 1, 1)),
              (o = r.nextSibling),
              e.startsWithCaretContainer(o) &&
                ((s = o.data), 1 == s.length ? o.parentNode.removeChild(o) : o.deleteData(0, 1));
          return null;
        }
        function c(o, a) {
          var l, c, f;
          return (
            ...
            n(a)
              ? ((g = e.insertBlock('p', a, o)),
                (l = r(a, o)),
                i(g).css('top', l.top),
                (m = i('<div class="mce-visual-caret" data-mce-bogus="all"></div>')
                  .css(l)
                  .appendTo(t)),
    ...
    r(Je, [_, p, z], function(e, t, n) {
      function r(e) {
          ...
          0 === t.button &&
            ...
            !g.dragging &&
              ...
              (g.ghost = f('<div>')
                ...
                .attr({ 'data-mce-bogus': 'all', unselectable: 'on', contenteditable: 'false' })
        ...
        function c(t) {
          ...
          if (
            g.dragging &&
            (e.selection.setRng(e.selection.getSel().getRangeAt(0)), s(e.selection.getNode()))
          ) {
            var r = g.element;
            if (
              ((n = e.fire('drop', { targetClone: r, clientX: t.clientX, clientY: t.clientY })),
        ...
        function u(a) {
          var s, u;
          if (
            (d(), 0 === a.button && ((s = t.find(e.dom.getParents(a.target), n.or(i, o))), r(s)))
          ) {
    ...
    r(Qe, [d, ne, $, k, te, Ye, Ke, Ge, _, T, W, I, z, p, u, Je, S], function(
      e,
      t,
      n,
      r,
      ...
      function y(c) {
        ...
        function L(e, t) {
          return (
            (t = i.normalizeRange(e, ee, t)), -1 == e ? n.fromRangeStart(t) : n.fromRangeEnd(t)
          );
        }
        function M(e) {
            ...
            : ((s = M(r)),
              ...
              n(o)
                ...
                ? n(o)
                  ...
                  : ((a = t(o)),
                    n(a) && D(o, a) ? R(e, a.getNode(-1 == e), 1 == e) : s ? V(o.toRange()) : null)
                : s
                ? r
                : null);
        }
          ...
          return !i.collapsed && ((o = _(i)), x(o))
            ...
            : ((a = L(e, i)),
              n(a) && r.isCaretContainerBlock(i.startContainer)
                ? ((l = -1 == e ? te.prev(a) : te.next(a)), l ? V(l.toRange()) : i)
                : t(a)
                ? V($(a.getNode(-1 == e)))
          ...
          o(c),
            c.on('mousedown', function(e) {
              ...
              if ((t = r(e.target)))
                ...
                n &&
                  (P(e.target, n.node) ||
                    (e.preventDefault(), c.getBody().focus(), S(R(1, n.node, n.before))));
              }
            }),
          ...
          return (
            ...
            1 != s.nodeType
              ...
              : (u == l + 1 && (n = s.childNodes[l]),
                x(n)
                  ? ((h = p = n.cloneNode(!0)),
                    (d = c.fire('ObjectSelected', { target: n, targetClone: h })),
        ...
        var ee = c.getBody(),
          ...
          se = c.$;
        return (
          e.ceFalse && (Y(), X()), { showBlockCaretContainer: U, hideFakeCaret: Z, destroy: Q }
        );
      }
      var b = f.curry,
        ...
        function B(e, t, i) {
          ...
          (a = o.documentBaseUrl = i.documentBaseURL),
            ...
            l &&
              l.external_plugins &&
              t.external_plugins &&
              (t.external_plugins = P({}, l.external_plugins, t.external_plugins)),
            (o.settings = t),
            ...
            o.setDirty(!1),
            (o.plugins = {}),
            (o.documentBaseURI = new p(t.document_base_url || a, { base_uri: s })),
            (o.baseURI = s),
            (o.contentCSS = []),
            (o.contentStyles = []),
            (o.shortcuts = new k(o)),
          ...
          (B.prototype = {
              ...
              function t() {
                ...
                if (
                  (r.language &&
                    'en' != r.language &&
                    !r.language_url &&
                    (r.language_url = n.editorManager.baseURL + '/langs/' + r.language + '.js'),
              ...
              if (n.getElement() && w.contentEditable) {
                ...
                a &&
                  ...
                  r.hidden_input &&
                    ...
                    (D.insertAfter(D.create('input', { type: 'hidden', name: i }), i),
                    (n.hasHiddenInput = !0)),
            ...
            init: function() {
              ...
              if (
                ...
                (n.aria_label =
                  n.aria_label || D.getAttrib(r, 'aria-label', t.getLang('aria.rich_text_area'))),
                n.theme &&
                  ('function' != typeof n.theme
                    ? ((n.theme = n.theme.replace(/-/, '')),
                      ...
                      t.theme.init &&
                        t.theme.init(
                          t,
                          L.urls[n.theme] || t.documentBaseUrl.replace(/\/$/, ''),
                          t.$,
                        ))
                    : (t.theme = n.theme)),
                ...
                n.render_ui &&
                  ...
                  'function' != typeof n.theme
                    ? ((i = n.width || r.style.width || r.offsetWidth),
                      ...
                      n.content_editable ||
                        ((o =
                          (l.iframeHeight || o) + ('number' == typeof o ? l.deltaHeight || 0 : '')),
                        a > o && (o = a)))
                    : ((l = n.theme(t, r)),
              ...
              (d = n.body_id || 'tinymce'),
                ...
                (f = n.body_class || ''),
                -1 != f.indexOf('=') &&
                  ((f = t.getParam('body_class', '', 'hash')), (f = f[t.id] || '')),
            ...
            initContentBody: function(t) {
              ...
              r.inline || (n.getElement().style.visibility = n.orgVisibility),
                ...
                n.readonly ||
                  ...
                  (p.contentEditable = n.getParam('content_editable_state', !0))),
                (p.disabled = !1),
                ...
                n.parser.addAttributeFilter('src,href,style,tabindex', function(e, t) {
                  for (var r = e.length, i, o = n.dom, a, s; r--; )
                    if (
                      ((i = e[r]), (a = i.attr(t)), (s = 'data-mce-' + t), !i.attributes.map[s])
                    ) {
                ...
                r.browser_spellcheck ||
                  r.gecko_spellcheck ||
                  ((h.body.spellcheck = !1), D.setAttrib(p, 'spellcheck', 'false')),
                (n.quirks = new x(n)),
                n.fire('PostRender'),
            ...
            focus: function(e) {
              ...
              if (!e) {
                ...
                a &&
                  a.ownerDocument == s &&
                  ((o = s.body.createControlRange()), o.addElement(a), o.select());
              }
              n.editorManager.setActive(n);
            },
            execCallback: function(e) {
              ...
              if (n)
                return (
                  t.callbackLookup && (r = t.callbackLookup[e]) && ((n = r.func), (r = r.scope)),
                  'string' == typeof n &&
                    ((r = n.replace(/\.\w+$/, '')),
                    (r = r ? z(r) : 0),
                    (n = z(n)),
            ...
            getParam: function(e, t, n) {
              ...
              return 'hash' === n
                ? ((i = {}),
                  'string' == typeof r
                    ? H(
                        r.indexOf('=') > 0 ? r.split(/[;,](?![^=;,]*(?:[;,]|$))/) : r.split(','),
                        function(e) {
                          (e = e.split('=')),
                            e.length > 1 ? (i[F(e[0])] = F(e[1])) : (i[F(e[0])] = F(e));
                        },
                      )
                    : (i = r),
                  i)
            ...
            hide: function() {
              ...
              e.hidden ||
                ...
                e.inline
                  ...
                  : (D.hide(e.getContainer()), D.setStyle(e.id, 'display', e.orgDisplay)),
                (e.hidden = !0),
                e.fire('hide'));
            },
            isHidden: function() {
              ...
              return (
                ...
                0 === e.length || /^\s+$/.test(e)
                  ? ((o = V && 11 > V ? '' : '<br data-mce-bogus="1">'),
                    'TABLE' == r.nodeName
                      ? (e = '<tr><td>' + o + '</td></tr>')
                      : /^(UL|OL)$/.test(r.nodeName) && (e = '<li>' + o + '</li>'),
                    (i = n.settings.forced_root_block),
                    i && n.schema.isValidChild(r.nodeName.toLowerCase(), i.toLowerCase())
                      ? ((e = o), (e = n.dom.createHTML(i, n.settings.forced_root_block_attrs, e)))
            ...
            getContainer: function() {
              var e = this;
              return (
                e.container || (e.container = D.get(e.editorContainer || e.id + '_parent')),
                e.container
              );
            },
            ...
            getDoc: function() {
              var e = this,
                t;
              return (
                e.contentDocument || ((t = e.getWin()), t && (e.contentDocument = t.document)),
                e.contentDocument
              );
            },
            getBody: function() {
            ...
            destroy: function(e) {
              ...
              if (!t.destroyed) {
                ...
                e ||
                  ...
                  (n = t.formElement),
                  n &&
                    (n._mceOldSubmit && ((n.submit = n._mceOldSubmit), (n._mceOldSubmit = null)),
              ...
              ('onbeforedeactivate' in document && n.ie < 9
                ...
                : f.on('nodechange mouseup keyup', function(e) {
                    ...
                    ('nodechange' == e.type && e.selectionChange) ||
                      ...
                      f.dom.isChildOf(t, f.getBody()) && (f.lastRng = f.selection.getRng()));
                  }),
              n.webkit &&
                !i &&
                ((i = function() {
    ...
    r(rt, [et, g, w, ae, d, m, c, ue, tt, nt], function(e, t, n, r, i, o, a, s, l, c) {
      ...
      function d(e, n) {
        n !== x &&
          (n ? t(window).on('resize scroll', u) : t(window).off('resize scroll', u), (x = n));
      }
      function f(e) {
        var t = C.editors,
          n;
      ...
      function h(e) {
        return (
          e &&
            ...
            (f(e), e.unbindAllNativeEvents(), e.destroy(!0), (e.removed = !0), (e = null)),
          e
        );
      }
      var p = n.DOM,
      ...
      return (
        (C = {
          ...
          overrideDefaults: function(e) {
            ...
            (t = e.base_url),
              t &&
                ((this.baseURL = new r(this.documentBaseURL).toAbsolute(t.replace(/\/+$/, ''))),
                        ...
                        (t = p.get(e))
                          ...
                          : g(document.forms, function(t) {
                              g(t.elements, function(t) {
                                t.name === e &&
                                  ((e = 'mce_editor_' + y++), p.setAttrib(t, 'id', e), n.push(t));
                              });
                            });
                      });
                  break;
          ...
          function r() {
            !e.async || 4 == i.readyState || o++ > 1e4
              ? (e.success && 1e4 > o && 200 == i.status
                  ...
                  : e.error && e.error.call(e.error_scope, o > 1e4 ? 'TIMED_OUT' : 'GENERAL', i, e),
                (i = null))
              : setTimeout(r, 10);
          }
          var i,
          ...
          send: function(n) {
            ...
            (n = i(this.settings, n)),
              (n.success = function(t, i) {
                (t = e.parse(t)),
                  'undefined' == typeof t && (t = { error: 'JSON Parse error.' }),
                  t.error
      ...
      return {
        ...
        send: function(n) {
          ...
          (r.callbacks[o] = function(e) {
            ...
            i.add(i.doc.body, 'script', { id: a, src: n.url, type: 'text/javascript' }),
            r.count++;
        },
      };
    }),
      ...
      return e.extend({
        ...
        bindStates: function() {
          function e(e) {
            ...
            e
              ? (i[0] ||
                  (n('button:first', t.getEl()).append('<span class="' + r + '"></span>'),
                  (i = n('span.' + r, t.getEl()))),
                i.html(t.encode(e)))
              : i.remove(),
          ...
          return (
            ...
            t.state.on('change:icon', function(n) {
              ...
              r
                ? ((a && a == o.firstChild) ||
                    ((a = document.createElement('i')), o.insertBefore(a, o.firstChild)),
                  (a.className = r))
                : a && o.removeChild(a),
                e(t.state.get('text'));
            }),
        ...
        bindStates: function() {
          ...
          return (
            ...
            t.state.on('change:icon', function(e) {
              ...
              n
                ? ((o && o == i.firstChild) ||
                    ((o = document.createElement('i')), i.insertBefore(o, i.firstChild)),
                  (o.className = n))
                : o && i.removeChild(o);
            }),
    ...
    r(gt, [De, be, pe, g], function(e, t, n, r) {
      return e.extend({
              ...
              if (r.contains(o, i) || i == o)
                for (; i && i != o; )
                  i.id &&
                    -1 != i.id.indexOf('-open') &&
                    (t.fire('action'),
                    e.menu && (t.showMenu(), n.aria && t.menu.items()[0].focus())),
                    (i = i.parentNode);
            }),
        ...
        repaint: function() {
          ...
          var l = document;
          return (
            l.all && (!l.documentMode || l.documentMode <= 8) && (s = e.layoutRect().h - 2 + 'px'),
          ...
          return (
            ...
            (o || a) &&
              ((s =
                ...
                ('caret' != o ? '<i class="' + o + '"></i>' : '<i class="' + r + 'caret"></i>') +
                (a ? (o ? ' ' : '') + a : '') +
                '</button></div>'),
    ...
    r(yt, [ht, ke], function(e, t) {
      return e.extend({
        showPanel: function() {
          ...
          e.panel.moveRel(
            e.getEl(),
            n.popoverAlign || (e.isRtl() ? ['bc-tr', 'bc-tc'] : ['bc-tl', 'bc-tc']),
          );
        },
        hidePanel: function() {
          var e = this;
        ...
        function c(e) {
          ...
          return (
            'object' == typeof e
              ...
              ? ((d = parseInt(t[1], 10)), (f = parseInt(t[2], 10)), (h = parseInt(t[3], 10)))
              : (t = /#([0-F]{2})([0-F]{2})([0-F]{2})/gi.exec(e))
              ? ((d = parseInt(t[1], 16)), (f = parseInt(t[2], 16)), (h = parseInt(t[3], 16)))
              ...
              n.on('nodeChange', function(r) {
                for (var i = [], o = r.parents, a = o.length; a--; )
                  if (1 == o[a].nodeType && !e(o[a])) {
                    ...
                    if (
                      (s.isDefaultPrevented() || i.push({ name: s.name, element: o[a] }),
        ...
        bindStates: function() {
          function e() {
            ...
            if (t.settings.labelGapCalc !== !1)
              for (
                o = 'children' == t.settings.labelGapCalc ? t.find('formitem') : t.items(),
          ...
          if (
            ...
            for (C = d / u, t = 0, n = v.length; n > t; t++)
              (h = v[t]),
                ...
                (y = p[_] + p.flex * C),
                y > b
                  ? ((d -= p[k] - p[_]), (u -= p.flex), (p.flex = 0), (p.maxFlexSize = b))
                  : (p.maxFlexSize = 0);
            for (
              C = d / u,
                w = o[T],
                ...
                0 === u &&
                  ('end' == l
                    ? (w = d + o[T])
                    : 'center' == l
                    ? ((w = Math.round(i[R] / 2 - (i[R] - d) / 2) + o[T]), 0 > w && (w = o[T]))
                    : 'justify' == l && ((w = o[T]), (c = Math.floor(d / (r.length - 1))))),
                x[D] = o[H],
                t = 0,
                n = r.length;
              n > t;
            ...
            ((x.w = x.minW), (x.h = x.minH), e.layoutRect(x), this.recalc(e), null === e._lastRect)
          ) {
            var W = e.parent();
    ...
    r(Bt, [ye, De, ke, m, rt, d], function(e, t, n, r, i, o) {
      function a(e) {
        ...
        (u = i()),
          ...
          e.addButton('undo', { tooltip: 'Undo', onPostRender: a('undo'), cmd: 'undo' }),
          e.addButton('redo', { tooltip: 'Redo', onPostRender: a('redo'), cmd: 'redo' }),
          ...
          e.addButton('remove', { tooltip: 'Remove', icon: 'remove', cmd: 'Delete' }),
          s(
            {
              cut: ['Cut', 'Cut', 'Meta+X'],
          ...
          e.addButton('styleselect', { type: 'menubutton', text: 'Formats', menu: u }),
          ...
          if (
            ...
            for (p = g.top, f = 0; n > f; f++) {
              for (
                ...
                r > d && ((B = A ? f * r + r - 1 - d : f * r + d), (u = i[B]), u);
                d++
              )
                (m = u.settings),
                  (c = u.layoutRect()),
      ...
      var i = e.extend({
        ...
        showMenu: function() {
          ...
          return e.menu && e.menu.visible()
            ...
            : (e.menu ||
                ((n = e.state.get('menu') || []),
                n.length ? (n = { type: 'menu', items: n }) : (n.type = n.type || 'menu'),
                n.renderTo
                  ? (e.menu = n
                      .parent(e)
                      .show()
        ...
        renderHtml: function() {
          ...
          return (
            ...
            '<div id="' +
              ...
              ('-' !== a ? '<i class="' + s + '"' + l + '></i>\xa0' : '') +
              ('-' !== a
                ? '<span id="' + r + '-text" class="' + o + 'text">' + a + '</span>'
                : '') +
              (c
                ? '<div id="' + r + '-shortcut" class="' + o + 'menu-shortcut">' + c + '</div>'
                : '') +
        ...
        init: function(e) {
          ...
          n._super(e),
            ...
            r &&
              ...
              !i && r.length > 0 && ((o = r[0].text), n.state.set('value', r[0].value)),
              n.state.set('menu', r)),
              ...
              if (e.control == this)
                for (; n; ) {
                  if (
                    ...
                    ('BUTTON' == n.nodeName && -1 == n.className.indexOf('open'))
                  )
    ...
    r(Qt, [], function() {
      ...
      return (
        'function' == typeof e.define && (e.define.amd || e.define('ephox/tinymce', [], t)), {}
      );
    }),
    a([
      l,
