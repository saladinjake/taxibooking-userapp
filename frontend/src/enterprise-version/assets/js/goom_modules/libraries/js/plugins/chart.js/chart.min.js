      ...
      function(t, e, i) {
        ...
        function H(t) {
          var e,
            ...
            r = t[2];
          return (
            (a = (r / 360) * 2 * Math.PI), (e = n * Math.cos(a)), (i = n * Math.sin(a)), [o, e, i]
          );
        }
        function N(t) {
          return L(H(t));
                ...
                e.extend(t, {
                  ...
                  _model: {
                    ...
                    borderColor: h.borderColor
                      ? h.borderColor
                      : e.getValueAtIndexOrDefault(d.borderColor, i, l.borderColor),
                    borderWidth: h.borderWidth
                      ? h.borderWidth
                      : e.getValueAtIndexOrDefault(d.borderWidth, i, l.borderWidth),
                  },
                }),
                  t.pivot();
              },
              ...
              removeHoverStyle: function(t) {
                ...
                (n.backgroundColor = o.backgroundColor
                  ...
                  (n.borderColor = o.borderColor
                    ? o.borderColor
                    : e.getValueAtIndexOrDefault(i.borderColor, a, r.borderColor)),
                  (n.borderWidth = o.borderWidth
                    ? o.borderWidth
                    : e.getValueAtIndexOrDefault(i.borderWidth, a, r.borderWidth));
              },
            })),
              ...
              updateElement: function(t, i, a, o) {
                ...
                e.extend(t, {
                  ...
                  _model: {
                    ...
                    borderColor: h.borderColor
                      ? h.borderColor
                      : e.getValueAtIndexOrDefault(d.borderColor, i, c.borderColor),
                    borderWidth: h.borderWidth
                      ? h.borderWidth
                      : e.getValueAtIndexOrDefault(d.borderWidth, i, c.borderWidth),
                  },
                  draw: function() {
                    function t(t) {
                      return l[(d + t) % 4];
                ...
                e.extend(t, {
                  ...
                  _model: {
                    x: a
                      ...
                      : n.getPixelForValue(h, i, this.index, this.chart.isCombo),
                    ...
                    borderColor: s.borderColor
                      ? s.borderColor
                      : e.getValueAtIndexOrDefault(l.borderColor, i, d.borderColor),
                    borderWidth: s.borderWidth
                      ? s.borderWidth
                      : e.getValueAtIndexOrDefault(l.borderWidth, i, d.borderWidth),
                    hitRadius: s.hitRadius
                      ? s.hitRadius
                      : e.getValueAtIndexOrDefault(l.hitRadius, i, d.hitRadius),
                  },
                });
                var c = t._model;
            ...
            legendCallback: function(t) {
              ...
              if (a.length)
                for (var n = 0; n < a[0].data.length; ++n)
                  e.push(
                    '<li><span style="background-color:' + a[0].backgroundColor[n] + '"></span>',
                  ),
                    o[n] && e.push(o[n]),
                    e.push('</li>');
                ...
                var o = this,
                  ...
                  p =
                    a && l.animateRotate
                      ...
                      : t.hidden
                      ? 0
                      : o.calculateCircumference(g.data[i]) * (s.circumference / (2 * Math.PI)),
                ...
                (y.backgroundColor = v.backgroundColor
                  ...
                  (a && l.animateRotate) ||
                    (0 === i
                      ...
                      : (y.startAngle = o.getMeta().data[i - 1]._model.endAngle),
            ...
            (t.controllers.line = t.DatasetController.extend({
              ...
              updateElement: function(t, i, a) {
                ...
                void 0 !== h.radius && void 0 === h.pointRadius && (h.pointRadius = h.radius),
                  ...
                  (t._model = {
                    ...
                    pointStyle:
                      l.pointStyle || e.getValueAtIndexOrDefault(h.pointStyle, i, g.pointStyle),
                    ...
                    hitRadius:
                      l.hitRadius || e.getValueAtIndexOrDefault(h.pointHitRadius, i, g.hitRadius),
                  });
              },
                  ...
                  for (o = 0; i > o; o++)
                    (n = l.data.datasets[o]),
                      ...
                      'line' === r.type &&
                        ...
                        (n.data[e] < 0 ? (u += n.data[e] || 0) : (c += n.data[e] || 0));
              ...
              setHoverStyle: function(t) {
                ...
                (n.radius =
                  ...
                  (n.borderWidth =
                    o.hoverBorderWidth ||
                    e.getValueAtIndexOrDefault(i.pointHoverBorderWidth, a, n.borderWidth));
              },
              removeHoverStyle: function(t) {
                var i = this,
              ...
              update: function(t) {
                ...
                (a.outerRadius = Math.max((l - s.borderWidth / 2) / 2, 0)),
                  (a.innerRadius = Math.max(
                    r.cutoutPercentage ? (a.outerRadius / 100) * r.cutoutPercentage : 1,
                    0,
                  )),
                  (a.radiusLength = (a.outerRadius - a.innerRadius) / a.getVisibleDatasetCount()),
              ...
              updateElement: function(t, i, a) {
                ...
                e.extend(t, {
                  ...
                  _model: {
                    ...
                    tension: o.tension
                      ? o.tension
                      : e.getValueOrDefault(n.tension, this.chart.options.elements.line.tension),
                    radius: o.radius
                      ? o.radius
                      : e.getValueAtIndexOrDefault(n.pointRadius, i, s.radius),
                    backgroundColor: o.backgroundColor
                      ? o.backgroundColor
                      : e.getValueAtIndexOrDefault(n.pointBackgroundColor, i, s.backgroundColor),
                    borderColor: o.borderColor
                      ? o.borderColor
                      : e.getValueAtIndexOrDefault(n.pointBorderColor, i, s.borderColor),
                    borderWidth: o.borderWidth
                      ? o.borderWidth
                      : e.getValueAtIndexOrDefault(n.pointBorderWidth, i, s.borderWidth),
                    pointStyle: o.pointStyle
                      ? o.pointStyle
                      : e.getValueAtIndexOrDefault(n.pointStyle, i, s.pointStyle),
                    hitRadius: o.hitRadius
                      ? o.hitRadius
                      : e.getValueAtIndexOrDefault(n.hitRadius, i, s.hitRadius),
                  },
                }),
              ...
              removeHoverStyle: function(t) {
                ...
                (n.radius = a.radius
                  ...
                  (n.borderColor = a.borderColor
                    ? a.borderColor
                    : e.getValueAtIndexOrDefault(i.pointBorderColor, o, r.borderColor)),
                  (n.borderWidth = a.borderWidth
                    ? a.borderWidth
                    : e.getValueAtIndexOrDefault(i.pointBorderWidth, o, r.borderWidth));
              },
            }));
        };
      },
            ...
            (t.animationService = {
              ...
              startDigest: function() {
                var t = Date.now(),
                  e = 0;
                this.dropFrames > 1 &&
                  ((e = Math.floor(this.dropFrames)), (this.dropFrames = this.dropFrames % 1));
            ...
            e.extend(t.Controller.prototype, {
                    ...
                    function(e, o) {
                      ...
                      n.type || (n.type = e.type || this.config.type),
                        ...
                        n.controller
                          ...
                          : ((n.controller = new t.controllers[n.type](this, o)),
                            a.push(n.controller));
                    },
                    this,
                  ),
              ...
              render: function(i, a) {
                ...
                if (
                  ...
                  this.draw(), o && o.onComplete && o.onComplete.call && o.onComplete.call(this);
                return this;
              },
              draw: function(i) {
                var a = i || 1;
            ...
            e.extend(t.DatasetController.prototype, {
              ...
              linkScales: function() {
                var t = this.getMeta(),
                  e = this.getDataset();
                null === t.xAxisID &&
                  (t.xAxisID = e.xAxisID || this.chart.options.scales.xAxes[0].id),
                  null === t.yAxisID &&
                        ...
                        function(i, a) {
                          if ('_' === a[0]);
                            ...
                            if (i === this._view[a]);
                              ...
                              var r =
                                void 0 !== this._start[a] && isNaN(this._start[a]) === !1
                                  ? this._start[a]
                                  : 0;
      ...
      function(t, e, i) {
        ...
        e.exports = function(t) {
          function e(t, e, i) {
            ...
            return (
              'string' == typeof t
                ? ((a = parseInt(t, 10)), -1 != t.indexOf('%') && (a = (a / 100) * e.parentNode[i]))
                : (a = t),
              a
            );
          }
          ...
          (n.requestAnimFrame = (function() {
            ...
            (n.longestText = function(t, e, i, a) {
              ...
              a.font !== e && ((o = a.data = {}), (r = a.garbageCollect = []), (a.font = e)),
                (t.font = e);
              var s = 0;
              n.each(i, function(e) {
                if (void 0 !== e && null !== e) {
            ...
            (n.color = function(e) {
              return a
                ? a(e instanceof CanvasGradient ? t.defaults.global.defaultColor : e)
                    ...
                    e.each(
                      ...
                      function(t, e) {
                        ...
                        p[p.length - 1] + i + a.padding >= this.width &&
                          ((m += l + a.padding), (p[p.length] = this.left)),
              ...
              fit: function() {
                ...
                if (
                  ...
                  if (l) {
                    ...
                    var v =
                      Math.sin(e.toRadians(this.labelRotation)) * this.longestLabelWidth + 1.5 * h;
                ...
                if (this.isHorizontal()) {
                  var i = this.width - (this.paddingLeft + this.paddingRight),
                    a =
                      i /
                      Math.max(
                        this.ticks.length - (this.options.gridLines.offsetGridLines ? 0 : 1),
                        1,
                      ),
                ...
                if (a.display) {
                  ...
                  if (((h.fillStyle = m), this.isHorizontal())) {
                      ...
                      e.each(
                        ...
                        function(t, r) {
                          ...
                          if ((!l || s) && void 0 !== t && null !== t) {
                            ...
                            u.display &&
                              (r ===
                              ('undefined' != typeof this.zeroLineIndex ? this.zeroLineIndex : 0)
                    ...
                    if (
                      ...
                      (r = 'left' === a.position ? this.left + C / 2 : this.right - C / 2),
                  ...
                  if (u.drawBorder) {
                    ...
                    this.isHorizontal()
                      ? ((L = B = 'top' === a.position ? this.bottom : this.top),
                        (L += z),
                        (B += z))
                      : ((O = W = 'left' === a.position ? this.right : this.left),
                        (O += z),
                        (W += z)),
                      h.beginPath(),
                      h.moveTo(O, L),
            ...
            (t.Tooltip = t.Element.extend({
              ...
              getBody: function(t, e) {
                ...
                return (
                  i.each(
                    ...
                    function(t) {
                      i.pushAllIfDefined(
                        this._options.tooltips.callbacks.beforeLabel.call(this, t, e),
                        a,
                      ),
                        i.pushAllIfDefined(
                          this._options.tooltips.callbacks.label.call(this, t, e),
                          a,
                        ),
                        i.pushAllIfDefined(
                          this._options.tooltips.callbacks.afterLabel.call(this, t, e),
                          a,
                        );
                    },
                    this,
                      ...
                      function(t, e) {
                        if (this._chartInstance.isDatasetVisible(e)) {
                          ...
                          if (o) {
                            ...
                            n.push({
                              xLabel: o._xScale
                                ? o._xScale.getLabelForIndex(o._index, o._datasetIndex)
                                : '',
                    ...
                    function(i) {
                      a.width = Math.max(
                        ...
                        e.measureText(i).width +
                          ('single' !== this._options.tooltips.mode ? t.bodyFontSize + 2 : 0),
                      );
                    },
                    this,
                  ),
              ...
              determineAlignment: function(t) {
                ...
                var e,
                  ...
                  r = this,
                  s =
                    (this._chartInstance.chartArea.left + this._chartInstance.chartArea.right) / 2,
                  l =
                    (this._chartInstance.chartArea.top + this._chartInstance.chartArea.bottom) / 2;
                'center' === this._model.yAlign
                  ...
                  e(this._model.x)
                    ? ((this._model.xAlign = 'left'),
                      a(this._model.x) &&
                        ((this._model.xAlign = 'center'), (this._model.yAlign = n(this._model.y))))
                    : i(this._model.x) &&
                  ...
                  i.each(
                    ...
                    function(n, r) {
                      'single' !== this._options.tooltips.mode &&
                        ...
                        a.fillText(
                          n,
                          t.x + ('single' !== this._options.tooltips.mode ? e.bodyFontSize + 2 : 0),
                          t.y,
                        ),
                      ...
                      function(t, i) {
                        ...
                        0 === i
                          ? (this._loop
                            ...
                            t._view.skip
                              ? this._loop || n.moveTo(r._view.x, this._view.scaleZero)
                          ...
                          : this.lineToNextPoint(
                              ...
                              function(t, e, i) {
                                this._loop
                                  ...
                                  : (n.lineTo(t._view.x, this._view.scaleZero),
                                    n.moveTo(i._view.x, this._view.scaleZero));
                              },
                              function(t, e) {
                                n.lineTo(e._view.x, e._view.y);
                              },
            ...
            a = t.Scale.extend({
              determineDataLimits: function() {
                ...
                void 0 !== this.options.ticks.min &&
                  ((t = e.indexOf(this.chart.data.labels, this.options.ticks.min)),
                  (this.minIndex = -1 !== t ? t : this.minIndex)),
                  void 0 !== this.options.ticks.max &&
                    ((t = e.indexOf(this.chart.data.labels, this.options.ticks.max)),
            ...
            a = t.Scale.extend({
              determineDataLimits: function() {
                ...
                if (((i.min = null), (i.max = null), a.stacked)) {
                  ...
                  e.each(s, function(o, r) {
                    ...
                    void 0 === h[s.type] &&
                      (h[s.type] = { positiveValues: [], negativeValues: [] });
                ...
                void 0 !== o.min
                  ? (i.min = o.min)
                  : void 0 !== o.suggestedMin && (i.min = Math.min(i.min, o.suggestedMin)),
                  void 0 !== o.max
                    ? (i.max = o.max)
                    : void 0 !== o.suggestedMax && (i.max = Math.max(i.max, o.suggestedMax)),
              ...
              buildTicks: function() {
                ...
                var f = Math.floor(a.min / d) * d,
                  ...
                  p = (g - f) / d;
                (p = e.almostEquals(p, Math.round(p), d / 1e3) ? Math.round(p) : Math.ceil(p)),
            ...
            i = {
              ...
              ticks: {
                callback: function(t, i, a) {
                  ...
                  return 1 === o || 2 === o || 5 === o || 0 === i || i === a.length - 1
                    ? t.toExponential()
                    : '';
                },
              },
            ...
            a = t.Scale.extend({
              determineDataLimits: function() {
                  ...
                  e.each(s, function(o, r) {
                    ...
                    n.isDatasetVisible(r) &&
                      ...
                      e.each(o.data, function(t, e) {
                        ...
                        isNaN(n) ||
                          s.data[e].hidden ||
                          ((o[e] = o[e] || 0), a.relativePoints ? (o[e] = 100) : (o[e] += n));
                      }));
                  }),
                    e.each(d, function(t) {
                      var a = e.min(t),
                ...
                (i.min = l(o.min, i.min)),
                  ...
                  i.min === i.max &&
                    (0 !== i.min && null !== i.min
                      ? ((i.min = Math.pow(10, Math.floor(e.log10(i.min)) - 1)),
                        (i.max = Math.pow(10, Math.floor(e.log10(i.max)) + 1)))
                      : ((i.min = 1), (i.max = 10)));
              },
              buildTicks: function() {
                for (
              ...
              getPixelForValue: function(t, i, a, o) {
                ...
                return (
                  s.isHorizontal()
                    ...
                    ? (r = s.top + c)
                    : ((n = s.height - (c + u)),
                      (r = s.bottom - u - (n / d) * (e.log10(h) - e.log10(l)))),
                  r
                );
              },
              getValueForPixel: function(t) {
              ...
              fit: function() {
                ...
                for (this.ctx.font = v, a = 0; a < this.getValueCount(); a++)
                  (t = this.getPointPosition(a, x)),
                    (o =
                      this.ctx.measureText(this.pointLabels[a] ? this.pointLabels[a] : '').width +
                      5),
                            ...
                            if (
                              ...
                              for (var s = 0; s < this.getValueCount(); s++) {
                                var l = this.getPointPosition(
                                  s,
                                  this.getDistanceFromCenterForValue(this.ticks[o]),
                                );
                  ...
                  this.chart.data.labels && this.chart.data.labels.length > 0
                    ? (e.each(
                        ...
                        function(e, i) {
                          ...
                          a.isValid() &&
                            (this.options.time.round && a.startOf(this.options.time.round),
                            t.push(a));
                        },
                        this,
                      ),
                          ...
                          ? e.each(
                              ...
                              function(t, e) {
                                ...
                                i.isValid() &&
                                  ...
                                  r &&
                                    ((this.firstTick =
                                      null !== this.firstTick ? a.min(this.firstTick, i) : i),
                                    (this.lastTick =
                                      null !== this.lastTick ? a.max(this.lastTick, i) : i)));
                              },
                              this,
                            )
                          : (n = t),
                ...
                buildTicks: function(a) {
                  ...
                  if (
                    ...
                    for (var g = 0, p = i.units[g]; g < i.units.length; ) {
                      if (
                        ((this.unitScale = 1),
                        e.isArray(p.steps) && Math.ceil(this.scaleSizeInUnits / f) < e.max(p.steps))
                      ) {
                      ...
                      var b = this.firstTick.diff(
                        ...
                        v = this.getMomentStartOf(this.lastTick.clone().add(1, this.tickUnit)).diff(
                          this.lastTick,
                          this.tickUnit,
                          !0,
                        );
                      (this.scaleSizeInUnits =
                        this.lastTick.diff(this.firstTick, this.tickUnit, !0) + b + v),
                  ...
                  for (var k = 1; k <= this.scaleSizeInUnits; ++k) {
                    ...
                    if (this.options.time.max && S.diff(this.lastTick, this.tickUnit, !0) >= 0)
                      break;
                ...
                getLabelForIndex: function(t, e) {
                  ...
                  return (
                    'object' == typeof this.chart.data.datasets[e].data[0] &&
                      (i = this.getRightValue(this.chart.data.datasets[e].data[t])),
                    this.options.time.tooltipFormat &&
                      (i = this.parseTime(i).format(this.options.time.tooltipFormat)),
                    i
                  );
                },
