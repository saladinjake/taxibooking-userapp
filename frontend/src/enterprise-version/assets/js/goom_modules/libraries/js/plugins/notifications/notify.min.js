...
(function(t, i, n, e) {
  ...
  (S = 'notify'),
    (C = S + 'js'),
    (s = S + '!blank'),
    (M = { t: 'top', m: 'middle', b: 'bottom', l: 'left', c: 'center', r: 'right' }),
    (m = ['l', 'c', 'r']),
    (F = ['t', 'm', 'b']),
    (b = ['t', 'b', 'l', 'r']),
    ...
    (r = function(i, e) {
      ...
      return (
        (null != (a = D[i]) ? a.cssElem : void 0) &&
          (t.console && console.warn('' + S + ": overwriting style '" + i + "'"),
          D[i].cssElem.remove()),
        (e.name = i),
        (D[i] = e),
        (o = ''),
    ...
    (o = (function() {
      ...
      return (
        (t.prototype.loadHTML = function() {
          var t;
          return (
            (t = this.getStyle()), (this.userContainer = n(t.html)), (this.userFields = t.fields)
          );
        }),
        ...
        (t.prototype.setGlobalPosition = function() {
          ...
          return (
            ...
            i ||
              ...
              (e = {}),
              (e[r] = 0),
              'middle' === t ? (e.top = '45%') : 'center' === t ? (e.left = '45%') : (e[t] = 0),
        ...
        (t.prototype.setElementPosition = function() {
          ...
          if (
            ((f = Math.max(0, this.options.gap - (this.options.arrowShow ? o : 0))),
            w(l, x, f),
          ...
          return (
            T.call(F, E) >= 0
              ...
              : T.call(m, E) >= 0 && (w(l, 'top', k(C, s, h)), i && w(i, 'top', k(C, o, c))),
        ...
        (t.prototype.getPosition = function() {
          ...
          return (
            (1 === t.length ||
              ((e = t[0]), T.call(F, e) >= 0 && ((o = t[1]), 0 > T.call(m, o))) ||
              ((r = t[0]), T.call(m, r) >= 0 && ((s = t[1]), 0 > T.call(F, s)))) &&
          ...
          if (this.container || t) {
            ...
            for (a in r)
              (o = r[a]),
                ...
                l &&
                  ('text' === l &&
                    ((o = c(o)), this.options.breakNewLines && (o = o.replace(/\n/g, '<br/>'))),
                  (h = a === s ? '' : '=' + a),
    ...
    (n[S] = function(t, i, e) {
      return (
        (t && t.nodeName) || t.jquery ? n(t)[S](i, e) : ((e = i), (i = t), new o(null, i, e)), t
      );
    }),
    (n.fn[S] = function(t, i) {
      return (
    ...
    n.extend(n[S], { defaults: h, addStyle: r, pluginOptions: E, getStyle: f, insertCSS: y }),
    n(function() {
      return (
        ...
        n(i).on('click notify-hide', '.' + C + '-wrapper', function(t) {
          ...
          return (
            (i = n(this).data(C)),
            i && (i.options.clickToHide || 'notify-hide' === t.type) ? i.show(!1) : e
          );
        })
      );
    });
