      ...
      (a.jstree.core.prototype = {
          ...
          this.element
            ...
            .on(
              ...
              a.proxy(function(b) {
                ...
                switch (
                  (this._data.core.rtl &&
                    (37 === b.which ? (b.which = 39) : 39 === b.which && (b.which = 37)),
                  b.which)
                ) {
                  case 32:
        ...
        load_node: function(b, c) {
          ...
          if (b.state.loaded) {
            ...
            h &&
              (this._data.core.selected = a.vakata.array_filter(this._data.core.selected, function(
                c,
              ) {
                return -1 === a.inArray(c, b.children_d);
              })),
        ...
        _load_node: function(b, c) {
          ...
          return d
            ? a.isFunction(d)
              ...
              : c.call(this, !1)
            : b.id === a.jstree.root
            ? this._append_html_data(b, this._data.core.original_container_html.clone(!0), function(
                a,
              ) {
                c.call(this, a);
              })
        ...
        redraw_node: function(b, c, d, e) {
          ...
          if (
            ...
            for (l++, m = q[f.parent].children.length; m > l; l++)
              if (
                (q[q[f.parent].children[l]].state.hidden || (x = q[f.parent].children[l]),
                x !== f.id)
              )
                break;
          f.state.hidden && (o += ' jstree-hidden'),
            f.state.loaded && !w
              ? (o += ' jstree-leaf')
              : ((o += f.state.opened && f.state.loaded ? ' jstree-open' : ' jstree-closed'),
              ...
              this.element
                ...
                .on(
                  ...
                  a.proxy(function(b, c) {
                    ...
                    for (
                      h = [], f = 0, g = this._data[j ? 'core' : 'checkbox'].selected.length;
                      g > f;
                      f++
                    )
                      (-1 !== i.indexOf('down') &&
                ...
                if (h[j[c]] && h[j[c]].parents)
                  for (e = 0, f = h[j[c]].parents.length; f > e; e++)
                    g[h[j[c]].parents[e]] === b &&
                      ...
                      ((g[h[j[c]].parents[e]] = !0), k.push(h[j[c]].parents[e]));
              for (
                this.element
                  .find('.jstree-closed')
              ...
              if (i && i._data && i._data.dnd)
                if (
                  (f.attr(
                    ...
                    'jstree-' +
                      i.get_theme() +
                      (i.settings.core.themes.responsive ? ' jstree-dnd-responsive' : ''),
                  ),
                  h.helper
                    .children()
                    .attr(
                  ...
                  (h.event.target !== i.element[0] && h.event.target !== i.get_container_ul()[0]) ||
                  ...
                  if (
                    ...
                    j &&
                      j.length &&
                      j.parent().is('.jstree-closed, .jstree-open, .jstree-leaf') &&
                      ((k = j.offset()),
              ...
              if (b) {
                ...
                (i = a(h.event.target).closest('.jstree')),
                  i.length &&
                    ...
                    c.error &&
                    'check' === c.error &&
                    ((i = i.jstree(!0)), i && i.settings.core.error.call(this, c));
              (d = !1), (b = !1);
            }
          })
              ...
              return (
                  ...
                  .each(function() {
                    ...
                    return (
                      this.scrollHeight > this.offsetHeight &&
                        (e.top + d.height() - c.pageY < a.vakata.dnd.settings.scroll_proximity &&
                          (b.scroll_t = 1),
                        c.pageY - e.top < a.vakata.dnd.settings.scroll_proximity &&
                          (b.scroll_t = -1)),
                      this.scrollWidth > this.offsetWidth &&
                        (e.left + d.width() - c.pageX < a.vakata.dnd.settings.scroll_proximity &&
                          (b.scroll_l = 1),
                        c.pageX - e.left < a.vakata.dnd.settings.scroll_proximity &&
                          (b.scroll_l = -1)),
                ...
                b.scroll_e ||
                  ...
                  f > g &&
                    ...
                    (b.scroll_t = -1),
                  f > g &&
                    g - (c.pageY - k) < a.vakata.dnd.settings.scroll_proximity &&
                    (b.scroll_t = 1),
                  h > j &&
                    c.pageX - l < a.vakata.dnd.settings.scroll_proximity &&
                    (b.scroll_l = -1),
                  h > j &&
                    j - (c.pageX - l) < a.vakata.dnd.settings.scroll_proximity &&
                    (b.scroll_l = 1),
                  (b.scroll_t || b.scroll_l) && (b.scroll_e = d)),
                b.scroll_e && a.vakata.dnd._scroll(!0),
                b.helper &&
                  ((m = parseInt(c.pageY + a.vakata.dnd.settings.helper_top, 10)),
      ...
      (a.jstree.plugins.massload = function(b, c) {
        (this.init = function(a, b) {
          ...
          (this._load_node = function(b, d) {
            ...
            return e
              ? this['string' == typeof e ? '_append_html_data' : '_append_json_data'](
                  b,
                  'string' == typeof e
        ...
        (this.init = function(c, e) {
          ...
          (this.set_type = function(c, d) {
            ...
            if (
              ...
              f[i].li_attr !== b && 'object' == typeof f[i].li_attr)
            )
