          ...
          i.find('> td:hidden').each(function() {
            ...
            return (
              a.isEditable !== !1 &&
                ...
                (null == o &&
                  ((o = 'bind-' + e.now() + '-' + t), e(this).attr('data-bind-name', o)),
                (s = e(this)
                  .contents()
                  .detach())),
              s ||
    ...
    options: {
      ...
      createGroupedDetail: function(e) {
        for (var t = { _none: { name: null, data: [] } }, a = 0; e.length > a; a++) {
          var i = e[a].group;
          null !== i
            ? (i in t || (t[i] = { name: e[a].groupName || e[a].group, data: [] }),
              t[i].data.push(e[a]))
      ...
      createDetail: function(t, a, i, o, n) {
        ...
        for (var l in r)
          if (0 !== r[l].data.length) {
            '_none' !== l &&
              t.append('<div class="' + n.detailInnerGroup + '">' + r[l].name + '</div>');
...
(function(e, t, undefined) {
  ...
  function l(e, t, a) {
    0 === e.find('tr.emptyInfo').size() &&
      e
        .find('tbody')
        .append('<tr class="emptyInfo"><td colspan="' + t.length + '">' + a + '</td></tr>');
  }
  function d(t, a, o, i) {
    ...
    (e.name = 'Footable Sortable'),
      ...
      (e.doSort = function(a, i) {
        ...
        if (t(o.table).data('sort') !== !1) {
          ...
          if (
            ((i =
              i === undefined ? s.hasClass(d.sorted) : 'toggle' === i ? !s.hasClass(d.sorted) : i),
            l.sort.ignore === !0)
          )
            return !0;
        ...
        return (
          a
            ...
            .each(function() {
              ...
              return (
                i !== undefined && (r.value = e.parse(this.cells[i.sort.match], i)), o.push(r), !0
              );
            })
            .detach(),
          o
