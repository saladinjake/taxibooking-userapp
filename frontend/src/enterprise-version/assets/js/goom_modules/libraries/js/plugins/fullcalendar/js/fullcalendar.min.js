...
!(function(a) {
  ...
  function G(b) {
    ...
    for (
      ...
      (d = f[c]),
        'string' == typeof d
          ? e.push(
              '-' == d.charAt(0) ? { field: d.substring(1), order: -1 } : { field: d, order: 1 },
            )
  ...
  function Qa(c, e) {
    ...
    function S(a, b) {
      ...
      return (
        (b = b || ea), this.triggerWith(a, b, c), T.options[a] ? T.options[a].apply(b, c) : void 0
      );
    }
    var T = this;
    (T.render = g),
    ...
    T.bindOptions(
      ...
      (T.getDefaultEventEnd = function(a, b) {
        var c = b.clone();
        return (
          a ? c.stripTime().add(T.defaultAllDayEventDuration) : c.add(T.defaultTimedEventDuration),
  ...
  function Ua() {
    ...
    function t(a) {
      return (
        ('object' == typeof a ? a.origArray || a.googleCalendarId || a.url || a.events : null) || a
      );
    }
    function u(b, c) {
  ...
  (Wa.moment = function() {
    ...
    (cb = ab
      ? function(a, c) {
          a._d.setTime(
            +new Date(c[0] || 0, c[1] || 0, c[2] || 0, c[3] || 0, c[4] || 0, c[5] || 0, c[6] || 0),
          ),
            b.updateOffset(a, !1);
        }
      : oa);
      ...
      var b = 0,
        c = {
          ...
          getListenerNamespace: function() {
            return (
              null == this.listenerId && (this.listenerId = b++), '_listener' + this.listenerId
            );
          },
        };
      return c;
    ...
    tb = (Wa.Grid = ya.extend(mb, nb, {
      ...
      processRangeOptions: function() {
        ...
        (this.eventTimeFormat =
          c.opt('eventTimeFormat') || c.opt('timeFormat') || this.computeEventTimeFormat()),
  ...
  tb.mixin({
    ...
    startSegResize: function(b, c, d) {
      return a(c.target).is('.fc-resizer')
        ? (this.buildSegResizeListener(b, a(c.target).is('.fc-start-resizer')).startInteraction(
            c,
            d,
          ),
          !0)
    ...
    getSegSkinCss: function(a) {
      ...
      return {
        'background-color':
          b.backgroundColor || e || d.backgroundColor || f || c.opt('eventBackgroundColor') || g,
  ...
  vb.mixin({
    ...
    fgSegHtml: function(a, b) {
      ...
      return (
        ...
        a.isStart &&
          ((c = this.getEventTimeText(f)), c && (l = '<span class="fc-time">' + ca(c) + '</span>')),
      ...
      buildViewSpec: function(a) {
        for (var d, e, f, g, h = this.overrides.views || {}, i = [], j = [], k = [], l = a; l; )
          (d = Xa[l]),
            ...
            d &&
              (i.unshift(d), j.unshift(d.defaults || {}), (f = f || d.duration), (l = l || d.type)),
  ...
  var Gb = (Wa.BasicView = xb.extend({
      ...
      computeRange: function(a) {
        ...
        return (
          /year|month/.test(b.intervalUnit) &&
            ...
            b.end.weekday() &&
              (b.end.add(1, 'week').startOf('week'), (b.end = this.skipHiddenDays(b.end, -1, !0)))),
          b
        );
      },
      renderDates: function() {
    ...
    Ib = (Wa.MonthView = Gb.extend({
      computeRange: function(a) {
        ...
        return (
          this.isFixedWeeks() &&
            ((b = Math.ceil(c.end.diff(c.start, 'weeks', !0))), c.end.add(6 - b, 'weeks')),
          c
        );
      },
      setGridHeight: function(a, b) {
