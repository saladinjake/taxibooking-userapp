/*! Select2 4.0.3 | https://github.com/select2/select2/blob/master/LICENSE.md */ !(function(a) {
  ...
  var b = (function() {
      ...
      return (
          ...
          return (
            ...
            (d.prototype.bind = function(a, b, d) {
              ...
              this.$selection.on('input.searchcheck', '.select2-search--inline', function(a) {
                ...
                this.$selection.on('keyup.search input.search', '.select2-search--inline', function(
                  a,
                ) {
                  if (g && 'input' === a.type)
        ...
        b.define('select2/options', ['require', 'jquery', './defaults', './utils'], function(
          a,
          b,
          c,
          d,
        ...
        b.define('select2/core', ['jquery', './options', './utils', './keys'], function(
          a,
          b,
          c,
          d,
