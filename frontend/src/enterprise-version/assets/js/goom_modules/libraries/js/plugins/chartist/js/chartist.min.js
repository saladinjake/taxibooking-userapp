  ...
  return (
    (function(a, b, c) {
      ...
      (c.namespaces = {
        ...
        (c.createLabel = function(a, b, d, e, f, g, h, i, j, k, l) {
          ...
          l.emit(
            'draw',
            c.extend({ type: 'label', axis: f, index: d, group: i, element: m, text: e[d] }, n),
          );
        }),
    ...
    (function(a, b, c) {
      ...
      function d(a, b, d) {
        return (
          a &&
            ((this.data = a), this.eventEmitter.emit('data', { type: 'update', data: this.data })),
          b &&
        ...
        var b,
          d = {
            ...
            normalized: a.distributeSeries
              ? c
                  .getDataArray(this.data, a.reverseData, a.horizontalBars ? 'x' : 'y')
                  .map(function(a) {
                    return [a];
                  })
            ...
            function(b, e) {
              ...
              (f =
                ...
                h.addClass(
                  [
                    a.classNames.series,
                    b.className || a.classNames.series + '-' + c.alphaNumerate(e),
                  ].join(' '),
                ),
            ...
            if (
              ...
              if (y || 0 === y) {
                var z = b
                  .elem(
                    'text',
                    { dx: x.x, dy: x.y, 'text-anchor': d(n, x, a.labelDirection) },
                    a.classNames.label,
                  )
                  .text('' + y);
                this.eventEmitter.emit('draw', {
