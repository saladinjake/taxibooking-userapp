...
!(function(a, b) {
  ...
  var a = {
    ...
    c = {
      set: function(c) {
        if (
          ((this.cb && this.cb.length) || ((this.cb = []), (this.item = -1)),
          this.item++,
          c && 'auto' === c.zIndex)
        ) {
          for (
            var d = 0, e = 0, f = document.getElementsByTagName('*'), g = f.length;
            g > e;
            e += 1
          ) {
      ...
      init: function() {
        document.documentElement.classList.add('custombox-open'),
          ...
          b.overlay.perspective.indexOf(this.cb[this.item].settings.overlayEffect) > -1 &&
      ...
      zIndex: function() {
        for (
          var a = 0, b = 0, c = document.getElementsByTagName('*'), d = c.length;
          d > b;
          b += 1
        ) {
        ...
        switch (('undefined' != typeof this.item && (c = this.cb[this.item]), a)) {
          ...
          case 'overlay':
            c.overlay || (c.overlay = {}),
              ...
              b.overlay.perspective.indexOf(c.settings.overlayEffect) > -1 ||
              b.overlay.together.indexOf(c.settings.overlayEffect) > -1
                ? (c.overlay.style.opacity = c.settings.overlayOpacity)
                : c.overlay.classList.add('custombox-overlay-default'),
          ...
          case 'modal':
            'push' === c.settings.overlayEffect &&
              (this.main.style.transitionDuration = c.settings.speed + 'ms'),
          ...
          case 'loading':
            ...
            for (
              var d = document.createElement('div'),
                e = 0,
                f = this.cb[this.item].settings.loading.parent.length;
              f > e;
              e++
            )
            ...
            if (
              ...
              for (
                var g = 0, h = this.cb[this.item].settings.loading.childrens.length;
                h > g;
                g++
              ) {
                for (
                  var i = document.createElement('div'),
                    j = 0,
                    k = this.cb[this.item].settings.loading.childrens[g].length;
                  k > j;
                  j++
                )
      ...
      load: function() {
        ...
        if (
          ('function' == typeof a.settings.open && a.settings.open.call(), document.createEvent)
        ) {
          var b = document.createEvent('Event');
          b.initEvent('custombox.open', !0, !0), document.dispatchEvent(b);
        }
        return (
          null !== a.settings.target && Array.isArray(a.settings.position)
            ? '#' === a.settings.target.charAt(0) ||
              ('.' === a.settings.target.charAt(0) && '/' !== a.settings.target.charAt(1))
      ...
      size: function() {
        ...
        if (
          ...
          a.inline ||
            (b.oldIE ? (a.content.style.styleFloat = 'none') : (a.content.style.cssFloat = 'none')),
          null !== a.settings.width &&
            (isNaN(a.settings.width)
              ? ((c = window.innerWidth), (a.content.style.height = window.innerHeight + 'px'))
        ...
        if (
          ...
          (a.container.style.marginTop = '5%'), (a.container.style.marginBottom = '5%');
        else {
          var g;
        ...
        this.loading && (document.body.removeChild(this.loading), delete this.loading),
        ...
        (d.onreadystatechange = function() {
          ...
          d.open(
            ...
            c.settings.target +
              (c.settings.cache
                ? ''
                : (/[?].+=/.test(c.settings.target) ? '&_=' : '?_=') + Date.now()),
            !0,
          ),
      ...
      open: function() {
        ...
        if (
          ...
          if (
            ...
            a.load(), c.inline && c.wrapper.classList.add('custombox-modal-open');
          else {
            var e = function() {
        ...
        else a.load(), c.inline && c.wrapper.classList.add('custombox-modal-open');
        return a;
      },
      clean: function(a) {
        var c = this,
          d = this.cb[a];
        if (
          (document.documentElement.classList.remove('custombox-open-' + d.settings.overlayEffect),
          d.settings.overlay &&
            (d.overlay.style.opacity && (d.overlay.style.opacity = 0),
      ...
      remove: function(a) {
        ...
        if (1 === c.cb.length) {
          for (
            var f = document.querySelectorAll('.custombox-container > *'), g = 0, h = f.length;
            h > g;
            g++
          )
        ...
        if (
          (b.modal.position.indexOf(g.settings.effect) > -1 &&
            ...
            (g.modal.classList.remove(
              'custombox-modal-' + g.settings.effect + '-' + g.settings.animation[0],
            ),
            g.modal.classList.add(
              'custombox-modal-' + g.settings.effect + '-' + g.settings.animation[1].trim(),
            )),
          ...
          var h = function() {
            g.wrapper.removeEventListener('transitionend', h), d.clean(c);
          };
      ...
      binds: function() {
        ...
        1 === a.cb.length &&
          ((a.esc = function(b) {
            1 === a.cb.length && document.removeEventListener('keydown', a.esc),
              (b = b || window.event),
              !d && 27 === b.keyCode && a.get() && a.get().settings.escKey && ((d = !0), a.close());
          }),
        ...
        var e = function() {
            ...
            if (
              (c.settings && 'function' == typeof c.settings.complete && c.settings.complete.call(),
              document.createEvent)
            ) {
              var e = document.createEvent('Event');
