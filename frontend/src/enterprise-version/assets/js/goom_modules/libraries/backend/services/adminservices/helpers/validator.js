...
class Validator {
  ...
  static validatePlanPost({
    ...
    if ( !plan_name.length) {
      ...
      console.log('fn err')
      var notification = alertify.notify('Invalid plan name', 'error', 5, function(){  console.log('dismissed'); });
    ...
    if (!plan_categories.length) {
      ...
      hasBeenValidated = false;
      console.log('ln err')
      var notification = alertify.notify('Invalid plan category', 'error', 5, function(){  console.log('dismissed'); });
    ...
    if (isNaN(price) ) {
      ...
      hasBeenValidated = false;
      console.log('ot err')
      var notification = alertify.notify('Invalid price', 'error', 5, function(){  console.log('dismissed'); });
    ...
    if (!description.length ) {
      ...
      hasBeenValidated = false;
      console.log('ot err')
      var notification = alertify.notify('Invalid Plan description', 'error', 5, function(){  console.log('dismissed'); });
    ...
    if (!isNaN(max_car) ) {
      ...
      hasBeenValidated = false;
      console.log('ot err')
      var notification = alertify.notify('Invalid car value', 'error', 5, function(){  console.log('dismissed'); });
    ...
    if ( !status.length) {
      ...
      hasBeenValidated = false;
      console.log('em err')
      var notification = alertify.notify('Invalid status', 'error', 5, function(){  console.log('dismissed'); });
