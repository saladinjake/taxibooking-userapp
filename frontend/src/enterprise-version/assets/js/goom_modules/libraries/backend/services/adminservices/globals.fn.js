...
window.setEarningsDetail = (el)=>{
  ...
  if(partnersCars==0){
    ...
    var notification = alertify.notify('Error!!! Cant add earnings for this partner. please add a car for this partner.', 'error', 5, function(){  console.log('dismissed'); });
...
window.updateInspectionAction = (o) =>{
      ...
      if(!confirmedInspectionTime.length){
        var notification = alertify.notify('Specify the time for inspection', 'error', 5, function(){  console.log('dismissed'); });
      ...
      if(!confirmedInspectionDate.length){
        var notification = alertify.notify('Specify inspection date ', 'error', 5, function(){  console.log('dismissed'); });
          ...
          fetch(linkOfApi, {
              ...
              .then(data => {
                ...
                if (data.status == 200) {
                   ...
                   AuditTrail.sendLogInfo(user, prePostData.partnerEmail, 'Inspection Module', 'Success', '201', 'PUT','Inspection status updated to active for the partner  '+ prePostData.partnerEmail)
                  ...
                  setTimeout(()=>{
                    window.location.reload();
                      ...
                      AuditTrail.sendLogInfo(user, prePostData.partnerEmail, 'Inspection Module', 'Failed', '200', 'PUT',"failed to update inspection status for partner "+  prePostData.partnerEmail)
    ...
    if(el.dataset.minspection=="yes"){
     ...
     save.addEventListener('click', function(e){
      e.preventDefault()
        ...
        const user =JSON.parse(localStorage.getItem("userToken"));
        let linkOfApi = 'https://goomtaxibackendapi.herokuapp.com/api/v1/admin-previledges-update/'+ el.dataset.id  ;
              ...
              .then(data => {
                ...
                if (data.status === 201) {
                  ...
                  var notification = alertify.notify('Successfully created user role.', 'success', 5, function(){  console.log('dismissed'); });
                   ...
                   AuditTrail.sendLogInfo(user, prePostData.previledges_info, 'UserGroup > Roles And Previledges/Create Mode', 'Success', '201', 'PUT', 'Updated usergroups preveledges for '+ prePostData.previledges_info)
                  ...
                  setTimeout(()=>{
                    window.location.href="./admin-previledges"
                      ...
                      AuditTrail.sendLogInfo(user, '', 'UserGroup > Roles And Previledges/Create Mode', 'Failed', '200', 'PUT', "failed to update previledges")
...
window.RolesUpdateAction =(t) =>{
 ...
 let linkOfApi ='https://goomtaxibackendapi.herokuapp.com/api/v1/' + t.dataset.url + '/' + t.dataset.id
          ...
          fetch(linkOfApi, {
              ...
              .then(data => {
                ...
                if (data.success === 'ok') {
                 ...
                 AuditTrail.sendLogInfo(user,'', 'UserGroup > Roles And Previledges/EDIT successful', 'Success', '201', 'PUT')
                  ...
                  setTimeout(()=>{
                      ...
                      AuditTrail.sendLogInfo(user, '', 'UserGroup > Roles And Previledges failed', 'Failed', '400', 'PUT')
      ...
      let prePostData2 = {
              ...
              .then(data => {
                ...
                if (data.status === 200) {
                  ...
                  var notification = alertify.notify('Car status has been updated to Active .', 'success', 5, function(){  console.log('dismissed'); });
