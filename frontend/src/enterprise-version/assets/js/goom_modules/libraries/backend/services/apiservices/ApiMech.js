...
class ApiMech {
  ...
  static saveRepairs() {
    ...
    if (!(location && location.length)) {
      var notification = alertify.notify('Please enter your location.', 'error', 5, function() {
    ...
    if (!(comment && comment.length)) {
      var notification = alertify.notify('Please enter a comment', 'error', 5, function() {
        console.log('dismissed');
      });
      return false;
      // return MessageBoard.displayMsg('Please enter a comment');
    ...
    if (carbrand == '--Select Car--') {
      var notification = alertify.notify('Please select a brand', 'error', 5, function() {
        console.log('dismissed');
      });
      return false;
    }
    ...
    if (!firstname) {
      ...
      var notification = alertify.notify('Please enter your firstname', 'error', 5, function() {
        console.log('dismissed');
      });
      return false;
    }
    ...
    if (!lastname) {
      ...
      var notification = alertify.notify('Please enter a username', 'error', 5, function() {
        console.log('dismissed');
      });
      return false;
    }
    ...
    if (!imageInput) {
      //return MessageBoard.displayMsg('Please enter a lastname');
      var notification = alertify.notify('Please upload an image.', 'error', 5, function() {
        console.log('dismissed');
      });
      return false;
    }
    ...
    if (!prePostData.description) {
      ...
      var notification = alertify.notify('Error in posting record', 'error', 5, function() {
        console.log('dismissed');
      });
      return false;
    }
