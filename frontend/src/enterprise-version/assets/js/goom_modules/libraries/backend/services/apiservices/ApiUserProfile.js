...
class ApiUpdateProfile {
  ...
  static updateProfile() {
    ...
    if (!(avatar && avatar.trim().length)) {
      ...
      var notification = alertify.notify('Please enter an avatar', 'error', 5, function() {
        console.log('dismissed');
      });
      setTimeout(() => {
    ...
    if (!(email && email.trim().length)) {
      ...
      //  }, 4000);
      var notification = alertify.notify('Please enter a email', 'error', 5, function() {
        console.log('dismissed');
      });
      setTimeout(() => {
        domel.innerHTML = 'Update';
    ...
    if (!(phoneNumber && phoneNumber.trim().length)) {
      var notification = alertify.notify('Please enter a phone number', 'error', 5, function() {
        console.log('dismissed');
      });
      setTimeout(() => {
        domel.innerHTML = 'Update';
    ...
    if (!(firstname && firstname.trim().length)) {
      var notification = alertify.notify('Please enter a firstname', 'error', 5, function() {
        console.log('dismissed');
      });
      setTimeout(() => {
        domel.innerHTML = 'Update';
    ...
    if (!(lastname && lastname.trim().length)) {
      var notification = alertify.notify('Please enter a lastname', 'error', 5, function() {
        console.log('dismissed');
      });
      setTimeout(() => {
        domel.innerHTML = 'Update';
    ...
    if (password != passwordConfirm) {
      var notification = alertify.notify(
        'Please ensure that your password matches the confirm password field.',
        'error',
        5,
        function() {
          console.log('dismissed');
