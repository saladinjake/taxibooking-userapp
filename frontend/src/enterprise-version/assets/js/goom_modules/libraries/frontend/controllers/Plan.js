...
let price,plan,cart,carPrice,carImage, car_type, car_year, assigned_driver_name,
    assigned_driver_email, assigned_driver_location, assigned_driver_phone,
                       ...
                       //alert(rootParentSection.id)
                        ...
                        closer.addEventListener('click',()=>{
                           ...
                           closer.style.display="none";
                            ...
                            $('#add-cars-template button').not('.good').prop('disabled', false);
...
// Thumbnail image controls
  ...
  showSlides(n) {
      ...
      if(slideIndex==1){
         ...
         if(window.planClicked ){ //global var
    ...
    if(localStorage.getItem('userToken')){
      ...
      if(carList.length >= 3){
          ...
          // console.log(ItineraryList,mainUrl)
            ...
            var notification = alertify.notify('Itinerary added succesfully.', 'success', 5, function(){  console.log('dismissed'); });
       
                }).catch(e => { console.log(e)
                  
                   var notification = alertify.notify('Could not add itinerary to cart.', 'error', 5, function(){  console.log('dismissed'); });
